...
- 🖼️ **Zbirka** — 92 zapisov z dokazilnimi statusi (preverjeno / avtentično gradivo /
...
bun run db:seed        # napolni zbirko (idempotentno: 92 zapisov, 409 virov, 6 zgodb, 9 dogodkov, 6 vpisov, 10 spominov)
