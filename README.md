...
- 🖼️ **Zbirka** — 88 zapisov z dokazilnimi statusi (preverjeno / avtentično gradivo /
...
bun run db:seed        # napolni zbirko (idempotentno: 88 zapisov, 392 virov, 6 zgodb, 9 dogodkov, 6 vpisov, 10 spominov)
