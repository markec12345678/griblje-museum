...
- 🖼️ **Zbirka** — 90 zapisov z dokazilnimi statusi (preverjeno / avtentično gradivo /
...
bun run db:seed        # napolni zbirko (idempotentno: 90 zapisov, 400 virov, 6 zgodb, 9 dogodkov, 6 vpisov, 10 spominov)
