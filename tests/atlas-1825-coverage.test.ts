...
describe("quality_gate — §23 struktura", () => {
  ...
  test("provenanca kaže na KG v1.8 (val 77 — PZ Summa kontrola + §8 revizija) in runtime kopijo", () => {
    expect(rep.provenance.kg_sha256.startsWith("a22ba7ede421bbfc")).toBe(true);
...
describe("quality_gate — številčne resnice iz registrov", () => {
  ...
  test("viri: 13 SOURCE nodes (10 VERIFIED, 3 PARTIAL — PR/PG brez prepisa; PZ delni prepis val 75+77; PV prepisan val 74)", () => {
