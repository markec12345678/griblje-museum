...
export const metadata: Metadata = {
  ...
  description:
    "Muzej vasi Griblje je trojezični digitalni muzej resnične vasi v Beli krajini: 60 zapisov, dokazljivi viri, lestvica zanesljivosti, odprti podatki in zemljevid. / A multilingual digital museum of a real village in Bela krajina, Slovenia.",
  keywords: [
    "Griblje",
    "Bela krajina",
    "Kolpa",
