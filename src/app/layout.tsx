...
export const metadata: Metadata = {
  ...
  description:
    "Muzej vasi Griblje je dvojezični digitalni muzej resnične vasi v Beli krajini: 30 zapisov, dokazljivi viri, lestvica zanesljivosti, odprti podatki in zemljevid. / A bilingual digital museum of a real village in Bela krajina, Slovenia.",
  keywords: [
    "Griblje",
    "Bela krajina",
    "Kolpa",
