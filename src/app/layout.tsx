...
export const metadata: Metadata = {
  ...
  description:
    "Muzej vasi Griblje je večjezični digitalni muzej resnične vasi v Beli krajini: 90 zapisov, dokazljivi viri, lestvica zanesljivosti, odprti podatki in zemljevid. / A multilingual digital museum of a real village in Bela krajina, Slovenia.",
  keywords: [
    "Griblje",
    "Bela krajina",
    "Kolpa",
