...
export const ENTITY_QUEUE: EntityQueueItem[] = [
  ...
  },
  {
    ...
    priority: "P2",
    questionSi:
      "Zemljevid vasi 1825 — revizija 11 vezav lastnikov (54. val): 5 statusov popravljeno (bp 98 Zollamt NEPODPRTO — verjetna zmeda 90↔98: no. 7 h.70 opomba »B.P. 90.«, Zollamt no. 95 brez opombe; bp 86 šibko — opomba »b. P. 56. 38.« ne vsebuje 86; bp 76 konflikt s PT 76→h.51; bp 92 opomba nečitljiva; bp 94 nadgrajen na VERIFIED-2x = 3 viri). Ostaja: kontrola v polni ločljivosti PUA p6/p18/p30/p39/p47 + PT p4/p5/p7-rep; če se pokaže, da Zollamt res nima B.P. — piko bp 98 preimenovati (brez lastniške vezave).",
    questionEn:
      "Village map 1825 — audit of 11 owner links (val 54): 5 statuses corrected (bp 98 Zollamt UNSUPPORTED — likely 90↔98 confusion: no. 7 h.70 note 'B.P. 90.', Zollamt no. 95 without note; bp 86 weak — note 'b. P. 56. 38.' does not contain 86; bp 76 conflicts with PT 76→h.51; bp 92 note illegible; bp 94 upgraded to VERIFIED-2x = 3 sources). Remaining: full-resolution control of PUA p6/p18/p30/p39/p47 + PT p4/p5/p7-tail; if the Zollamt truly has no B.P., rename the bp 98 pin (without an owner link).",
    slugs: ["griblje-vas"],
  },
];
