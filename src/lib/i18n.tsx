...
export const ui = {
  sl: {
    ...
    guide: {
      ...
      subtitle: "Vprašajte muzejskega vodnika — odgovori so uzidani v 28 kuriranih zapisov.",
      aiBadge: "AI vodnik",
      ...
      starters: [
        ...
        "Zakaj je Bela krajina znana po lončarstvu in vinu?",
      ],
  ...
  en: {
    ...
    guide: {
      ...
      subtitle: "Ask the museum guide — answers are grounded in 28 curated records.",
      aiBadge: "AI guide",
      ...
      starters: [
        ...
        "Why is Bela krajina known for pottery and wine?",
      ],
