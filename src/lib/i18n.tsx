...
export const ui = {
  sl: {
    ...
    hero: {
      ...
      titleAccent: "muzej.",
      subtitle:
        "Zbirka 44 zapisov, ena reka, ena meja in sto spominov. Raziščite Griblje — vas ob Kolpi, katere vsak prostor je vstopna točka v zgodbo.",
    ...
    guide: {
      ...
      subtitle: "Vprašajte muzejskega vodnika — odgovori slonijo na 44 kuriranih zapisih.",
      aiBadge: "AI vodnik",
    ...
    walks: {
      ...
      start: "Začni sprehod",
      coverNote: "Sprehodi skupaj pokrivajo vseh 44 zapisov zbirke.",
      completed: "Zaključen",
    ...
    advent: {
      ...
      note: "Vrata se odklenejo ob lokalni polnoči; prihodnja ostanejo zaprta. Zapisi se v koledarju lahko ponovijo — v zbirki jih je 44.",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        "Forty-four records, one river, one border and a hundred memories. Explore Griblje — a village on the Kolpa where every place is an entrance into a story.",
    ...
    guide: {
      ...
      subtitle: "Ask the museum guide — answers are grounded in 44 curated records.",
      aiBadge: "AI guide",
    ...
    walks: {
      ...
      coverNote: "Together the walks cover all 44 records of the collection.",
      completed: "Completed",
      completedProgress: (done: number, total: number) =>
    ...
    advent: {
      ...
      note: "Doors unlock at your local midnight; future ones stay closed. Records may repeat across the calendar — the collection has 44 pieces.",
      openDoor: "Open door",
  ...
  hr: {
    ...
    hero: {
      ...
      titleAccent: "muzej.",
      subtitle:
        "Četrdeset i četiri zapisa, jedna rijeka, jedna granica i sto sjećanja. Istražite Griblje — selo uz Kolpu čiji je svaki kut ulazna točka u priču.",
    ...
    guide: {
      ...
      subtitle: "Pitajte muzejskog vodiča — odgovori se temelje na 44 kurirana zapisa.",
      aiBadge: "AI vodič",
    ...
    walks: {
      ...
      coverNote: "Šetnje zajedno pokrivaju svih 44 zapisa zbirke.",
      completed: "Završeno",
      completedProgress: (done: number, total: number) =>
    ...
    advent: {
      ...
      note: "Vrata se otključavaju u lokalnu ponoć; buduća ostaju zatvorena. Zapisi se u kalendaru mogu ponoviti — u zbirci ih je 44.",
