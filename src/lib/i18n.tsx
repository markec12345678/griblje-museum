...
export const ui = {
  sl: {
    ...
    hero: {
      ...
      titleAccent: "muzej.",
      subtitle:
        "Zbirka 82 zapisov, ena reka, ena meja in sto spominov. Raziščite Griblje — vas ob Kolpi, katere vsak prostor je vstopna točka v zgodbo.",
    ...
    guide: {
      ...
      subtitle: "Vprašajte muzejskega vodnika — odgovori slonijo na 82 kuriranih zapisih.",
      aiBadge: "AI vodnik",
    ...
    walks: {
      ...
      start: "Začni sprehod",
      coverNote: "Sprehodi skupaj pokrivajo vseh 82 zapisov zbirke.",
      completed: "Zaključen",
    ...
    visual: {
      title: "Podobne slike",
      subtitle:
        "Po zgradbi in barvah slike — majhna različica vzorca »Search visually« Rijksmuseuma, ki pri 82 zapisih ne potrebuje umetne inteligence.",
    ...
    advent: {
      ...
      note: "Vrata se odklenejo ob lokalni polnoči; prihodnja ostanejo zaprta. Zapisi se v koledarju lahko ponovijo — v zbirki jih je 82.",
  ...
  en: {
    ...
    guide: {
      ...
      subtitle: "Ask the museum guide — answers are grounded in 82 curated records.",
      aiBadge: "AI guide",
    ...
    walks: {
      ...
      coverNote: "Together the walks cover all 82 records of the collection.",
      completed: "Completed",
      completedProgress: (done: number, total: number) =>
    ...
    advent: {
      ...
      note: "Doors unlock at your local midnight; future ones stay closed. Records may repeat across the calendar — the collection has 82 pieces.",
      openDoor: "Open door",
  ...
  hr: {
    ...
    guide: {
      ...
      subtitle: "Pitajte muzejskog vodiča — odgovori se temelje na 82 kuriranih zapisa.",
      aiBadge: "AI vodič",
    ...
    walks: {
      ...
      coverNote: "Šetnje zajedno pokrivaju svih 82 zapisa zbirke.",
      completed: "Završeno",
      completedProgress: (done: number, total: number) =>
    ...
    visual: {
      title: "Slične slike",
      subtitle:
        "Po strukturi i bojama — mala muzejska inačica uzorka »Search visually« Rijksmuseuma, koja pri 82 zapisa ne treba umjetnu inteligenciju.",
    ...
    advent: {
      ...
      note: "Vrata se otključavaju u lokalnu ponoć; buduća ostaju zatvorena. Zapisi se u kalendaru mogu ponoviti — u zbirci ih je 82.",
