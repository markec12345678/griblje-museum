...
export const ui = {
  sl: {
    ...
    hero: {
      ...
      titleAccent: "muzej.",
      subtitle:
        "Sedemintrideset zapisov, ena reka, ena meja in sto spominov. Raziščite Griblje — vas ob Kolpi, katere vsak prostor je vstopna točka v zgodbo.",
    ...
    guide: {
      ...
      subtitle: "Vprašajte muzejskega vodnika — odgovori so uzidani v 37 kuriranih zapisov.",
      aiBadge: "AI vodnik",
    ...
    walks: {
      ...
      start: "Začni sprehod",
      coverNote: "Sprehodi skupaj pokrivajo vseh 37 zapisov zbirke.",
      completed: "Zaključen",
    ...
    advent: {
      ...
      note: "Vrata se odklenejo ob lokalni polnoči; prihodnja ostanejo zaprta. Zapisi se v koledarju lahko ponovijo — zbirka ima 37 del.",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        "Thirty-seven records, one river, one border and a hundred memories. Explore Griblje — a village on the Kolpa where every place is an entrance into a story.",
    ...
    guide: {
      ...
      subtitle: "Ask the museum guide — answers are grounded in 37 curated records.",
      aiBadge: "AI guide",
    ...
    walks: {
      ...
      coverNote: "Together the walks cover all 37 records of the collection.",
      completed: "Completed",
      completedProgress: (done: number, total: number) =>
    ...
    advent: {
      ...
      note: "Doors unlock at your local midnight; future ones stay closed. Records may repeat across the calendar — the collection has 37 pieces.",
      openDoor: "Open door",
  ...
  hr: {
    ...
    hero: {
      ...
      titleAccent: "muzej.",
      subtitle:
        "Trideset sedam zapisa, jedna rijeka, jedna granica i sto sjećanja. Istražite Griblje — selo uz Kolpu čiji je svaki kut ulazna točka u priču.",
    ...
    guide: {
      ...
      subtitle: "Pitajte muzejskog vodiča — odgovori su ugrađeni u 37 kuriranih zapisa.",
      aiBadge: "AI vodič",
    ...
    walks: {
      ...
      coverNote: "Šetnje zajedno pokrivaju svih 37 zapisa zbirke.",
      completed: "Završeno",
      completedProgress: (done: number, total: number) =>
    ...
    advent: {
      ...
      note: "Vrata se otključavaju u lokalnu ponoć; buduća ostaju zatvorena. Zapisi se u kalendaru mogu ponoviti — zbirka ima 37 dijelova.",
