...
export const ui = {
  sl: {
    ...
    hero: {
      ...
      titleAccent: "muzej.",
      subtitle:
        "Trideset zapisa, ena reka, ena meja in sto spominov. Raziščite Griblje — vas ob Kolpi, katere vsak prostor je vstopna točka v zgodbo.",
    ...
    advent: {
      ...
      note: "Vrata se odklenejo ob lokalni polnoči; prihodnja ostanejo zaprta. Zapisi se v koledarju lahko ponovijo — zbirka ima 30 del.",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle:
        "Thirty records, one river, one border and a hundred memories. Explore Griblje — a village on the Kolpa where every place is an entrance into a story.",
    ...
    advent: {
      ...
      note: "Doors unlock at your local midnight; future ones stay closed. Records may repeat across the calendar — the collection has 30 pieces.",
      openDoor: "Open door",
  ...
  hr: {
    ...
    hero: {
      ...
      titleAccent: "muzej.",
      subtitle:
        "Trideset zapisa, jedna rijeka, jedna granica i sto sjećanja. Istražite Griblje — selo uz Kolpu čiji je svaki kut ulazna točka u priču.",
    ...
    guide: {
      ...
      subtitle: "Pitajte muzejskog vodiča — odgovori su ugrađeni u 30 kuriranih zapisa.",
      aiBadge: "AI vodič",
    ...
    walks: {
      ...
      coverNote: "Šetnje zajedno pokrivaju svih 30 zapisa zbirke.",
      completed: "Završeno",
      completedProgress: (done: number, total: number) =>
    ...
    advent: {
      ...
      note: "Vrata se otključavaju u lokalnu ponoć; buduća ostaju zatvorena. Zapisi se u kalendaru mogu ponoviti — zbirka ima 20 dijelova.",
