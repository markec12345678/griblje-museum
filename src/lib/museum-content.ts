  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        nameSi: "Wikimedia Commons: Special-Karte des Herzogthums Krain 1843 (Henrik Freyer) — cela karta",
        nameEn: "Wikimedia Commons: Special-Karte des Herzogthums Krain 1843 (Henrik Freyer) — the complete map",
        sourceType: "fotografija",
        license: "javna last / public domain",
        url: WM("Special-Karte_des_Herzogthums_Krain_1843.jpg"),
        noteSi:
          "Prva karta, na kateri je vsaka vas dežele dobila svoje ime; med njimi Griblje. Glavna slika zapisa je izrez jugovzhodnega dela s čitljivim imenom Grüble in s Kolpo; cela karta (3840 px, posnetek GA&C) je shranjena tu.",
        noteEn:
          "The first map on which every village of the land received its name; Griblje among them. The record's main image is an excerpt of the southeast sheet with the legible name Grüble and the Kolpa; the complete map (3840 px, GA&C scan) is kept here.",
      },
      {
