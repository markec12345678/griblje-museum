...
export const seedExhibits: SeedExhibit[] = [
  ...
  },
  {
    ...
    storySi:
      "27. avgusta 1907 so na gribeljski domačiji Hajdeč grunt — ime je dobila po ajdi, ki so jo tu pridelovali v velikih količinah — priredili devetega od dvanajstih otrok. Botrovala sta Matija Štrucelj in Ana Požek, oče Ivan pa je bil župan in cerkveni ključar: družina z globoko ukoreninjenostjo v vas. Nikogar ni moglo biti milosti, da bo ravno ta fant dočakal temno starost, ki jo Slovenija še ni videla.\n\nŽivljenje ga je vrglo po svetu, kakor je takrat metalo podeželske fante. Dali so ga v uk k ključavničarju — a pobegnil je v Ljubljano, kjer je v tamburaški skupini društva Danica igral bugarijo. Vojska ga je poslala k gorskemu topništvu v Mostar; nato je postal profesionalni graničar na srbsko-bolgarski meji. Tam je naredil nekaj, kar je utegnilo biti edinstveno: kot prvi graničar se je naučil smučati. Smuči je naročil iz Logatca, učitelj smučanja je postal sam — in tej veščini je ostal zvest vse življenje. Druga svetovna vojna ga je kot vojnega ujetnika poslala na kmetijska dela v Sudete in Zgornjo Avstrijo; po vojni je služil v Ljudski milici.\n\nKo se je življenje umirilo, se je iztekalo počasi in razgledno: ob 108. in ob 110. rojstnem dnevu ga je obiskal predsednik republike Borut Pahor. Ob stotem je naredil nekaj, kar stoletniki redko naredijo — napisal knjigo z naslovom Mojih sto let. Igral je kitaro in bisernico; med njegovimi šolskimi spomini je tista iz podružnične šole v Gribljah, kjer je sedel med klopmi, iz katerih so odraščali tudi Županič in kasnejši rodniki. Umrl je 31. marca 2018 v Ljubljani, star 110 let in 216 dni — v naslovih medijev je njegova starost zaokroženo navedena kot 111 let — najdalj živeči moški, ki ga je Slovenija kdaj zapisala.\n\nNjegova zgodba ni le številka, ampak stoletje v malem: od vprežne živine na Hajdeč gruntovi njivi do digitalnega vpisnika muzeja, ki jo hrani. Vsaka vas ima svojega dolgoživeča; Griblje imajo takšnega, ki ga ima cela država.",
    storyEn:
  ...
  },
  {
    ...
    periodEn: "the 1920s",
    summarySi:
      "V dvajsetih letih so gribeljski fantje igrali v tamburaški skupini ljubljanskega društva Danica; med njimi mladi Niko Dragoš na bugariji — glasba, ki je vas odpirala svetu.",
    summaryEn:
      "In the 1920s Griblje's young men played in the tambura group of the Ljubljana society Danica; among them young Niko Dragoš on the bugarija — music that opened the village to the world.",
    storySi:
      "Ko je sedemnajstletni Nikolaj Dragoš pobegnil iz uka pri ključavničarju, ga je v Ljubljani čakalo nekaj, česar v Gribljah ni bilo: društvo. V tamburaški skupini društva Danica je igral bugarijo — strunski bas tamburaške družine, inštrament, ki v orkestru drži tla, kakor jih v hiši drži kamra. Fant z obkolpske ravnine je v mestu našel glasbo, ki je znala isto, kar bo znal on sam: držati ritem dolgega življenja.\n\nTambura v slovenskem prostoru ni bila le glasba, ampak društvena disciplina: mladinska in delavska društva so ob njej učila branje, gledališče in jamstvo — Danica je bila ena od luči, ki so jih prižigale delavske in izobraževalne družine v mestih. Da je gribeljski fant stal v njeni tamburaški vrsti, pomeni, da je vas že v dvajsetih letih slala v mesto ne samo delavce, ampak tudi glasbenike.\n\nZa muzej je ta zapis dvojni: pripoved o glasbeni kulturi, ki jo je nosila vnaprejšnja generacija, in prvo poglavje življenjepisa Nikolaja Dragoša — stoletnika, ki bo dočakal 110 let. Bugarija je bila njegova prva javna vloga; zadnja bo najstarejši Slovenec. Med njima: Mostar, meja, ujetništvo, milica, upokojitev in sto zim.\n\nVrzeli, ki jih muzej odkrito nosi: ni ohranjene fotografije tamburašev Danice z gribeljskimi obrazi, ni seznama skladb, ni datuma prvega nastopa. Vsak list, ki se najde, bo dobrodošel — tambura ima v tej vasi še svoj dolg.",
    storyEn:
      "When seventeen-year-old Nikolaj Dragoš ran away from his apprenticeship with a locksmith, something awaited him in Ljubljana that Griblje did not have: a society. In the tambura group of the Danica society he played the bugarija — the stringed bass of the tambura family, the instrument that holds the floor in an orchestra as the kamra holds it in a house. The boy from the Kolpa plain found in the city a music that could do what he himself would do: keep the rhythm of a long life.\n\nIn the Slovene world the tambura was not only music but society discipline: youth and workers' societies taught reading, theatre and solidarity around it — Danica was one of the lamps lit by working and educating families in the cities. That a Griblje boy stood in its tambura line means the village was already sending to the city not only labourers but musicians.\n\nFor the museum this record is double: a story of the musical culture carried by the pre-war generation, and the first chapter of the biography of Nikolaj Dragoš — the centenarian who would live to 110. The bugarija was his first public role; the last will be the oldest Slovene. Between them: Mostar, the border, captivity, the militia, retirement and a hundred winters.\n\nThe gaps the museum openly carries: no photograph of the Danica tambura players with Griblje faces survives, no list of songs, no date of a first performance. Every page that turns up will be welcome — the tambura still has a debt to pay in this village.",
    evidenceStatus: "DOCUMENTED",
    ...
    sources: [
      {
        ...
        nameSi: "Radio Odeon — Ljudje ob Kolpi: Nikolaj Dragoš (tamburaška skupina društva Danica, bugarija)",
