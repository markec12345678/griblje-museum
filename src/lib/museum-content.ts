  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        nameSi: "Wikimedia Commons: Special-Karte des Herzogthums Krain 1843 (Henrik Freyer) — glavna slika zapisa",
        nameEn: "Wikimedia Commons: Special-Karte des Herzogthums Krain 1843 (Henrik Freyer) — the record's main image",
        sourceType: "fotografija",
        license: "javna last / public domain",
        url: WM("Special-Karte_des_Herzogthums_Krain_1843.jpg"),
        noteSi:
          "Prva karta, na kateri je vsaka vas dežele dobila svoje ime; med njimi Griblje — podoba sredine poti med listino 1468 in današnjim popisom.",
        noteEn:
          "The first map on which every village of the land received its name; Griblje among them — the face of the road's middle between the 1468 charter and today's census.",
      },
      {
