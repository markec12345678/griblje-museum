...
export const seedExhibits: SeedExhibit[] = [
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "volcjak-2019-ahas",
        nameSi: "Volčjak, J. (2019): Cerkve goriške nadškofije na Kranjskem v času nadškofa Karla Mihaela grofa Attemsa. 1. del: Bistrski, gorenjski in metliški arhidiakonat — Acta historiae artis Slovenica 24(1) (DOI 10.3986/ahas.v24i1.7586)",
        nameEn: "Volčjak, J. (2019): The Churches of the Archdiocese of Gorizia in Carniola in the Time of Archbishop Karl Michael von Attems. Part 1: the Archdeaconry of Bistra, Gorenjska and Metlika — Acta historiae artis Slovenica 24(1) (DOI 10.3986/ahas.v24i1.7586)",
        sourceType: "objava",
        license: "znanstvena objava (open access)",
        url: "https://ojs.zrc-sazu.si/ahas/article/view/7586",
        noteSi: "Med podružnicami župnije Podzemelj: »Griblje (Grible, 1771), p. c. sv. Vida, om. 1753, 1771« (str. 148 in katalog cerkva); viri v opombi 265: IT ASDG, ACAG, Visite pastorali, Attems — prvi dokumentirani vizitacijski zapisi o cerkvi sv. Vida v Gribljih.",
        noteEn: "Among the filial churches of the Parish of Podzemelj: \"Griblje (Grible, 1771), p. c. sv. Vida, om. 1753, 1771\" (p. 148 and the church catalogue); sources in note 265: IT ASDG, ACAG, Visite pastorali, Attems — the first documented visitation records of St Vitus's church at Griblje.",
      },
      {
        key: "zvon-2008",
      ...
      {
        key: "yt-mrliska-veznica-2013",
        nameSi: "Vaš Kanal (YouTube) — Nova mrliška vežica v Gribljah (video, 18. 2. 2013)",
        nameEn: "Vaš Kanal (YouTube) — The new funeral parlour in Griblje (video, 18 Feb 2013)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.youtube.com/watch?v=AcXevMiKHZ0",
        noteSi:
          "Predaja novo zgrajene mrliške vežice — »V Gribljah so po več letih prizadevanj končali pomembno naložbo«; kanal Vaš Kanal (@vaskanal); datum objave 18. 2. 2013; ožji kontekst posnetka (lokacija vežice, govorniki) z video strani ni razčlenjen (nadzor dostopa) — datum po naslovu in iskalnem opisu.",
        noteEn:
          "The handover of the newly built funeral parlour — \"after years of effort, the village has completed an important investment\"; the Vaš Kanal channel (@vaskanal); posted 18 Feb 2013; the recording's finer context (the parlour's location, the speakers) is not detailed from the video page (access control) — the date comes from the title and search description.",
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        key: "dl-pet-stoletij-vere",
        nameSi: "Dolenjski list — Pet stoletij vere: v Gribljah in Butoraju obnovili cerkvi (avgust 2026)",
        nameEn: "Dolenjski list — Five centuries of faith: the churches of Griblje and Butoraj renewed (August 2026)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/pet-stoletij-vere-griblje-in-butoraj-obnovljeni-cerkvi-500-let-1917550",
        noteSi: "Tiskani regionalni potrditveni vir: 500-letnica in obnova obeh cerkva (prva omemba obeh 1526); podnaslov »skupnost je stopila skupaj za obnovo dveh cerkva«; imena s pročelne fotografije (med njimi Janez Butala, Peter Kokotec).",
        noteEn: "The printed regional corroborating source: the 500th anniversary and the renewal of both churches (first mention of both 1526); the lead 'the community stepped together for the renewal of two churches'; names from the facade photograph (among them Janez Butala, Peter Kokotec).",
      },
      {
        key: "mojadolenjska-500-letnica",
        nameSi: "Moja Dolenjska (26. 6. 2026): Griblje — slovesno obeležili 500-letnico prve pisne omembe cerkve sv. Vida",
        nameEn: "Moja Dolenjska (26 Jun 2026): Griblje solemnly marked the 500th anniversary of the first written mention of the church of St. Vitus",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://moja-dolenjska.si/griblje-slovesno-obelezili-500-letnico-prve-pisne-omembe-cerkve-sv-vida/",
        noteSi: "Neodvisni medijski vir: maša msgr. Glavana, somaševal Miroslavič, knjižica Memento (pobuda Husičeva, zgodovinsko delo dr. Weissa, oblikovanje Črničeva ml.), novo parkirišče + poslovilna vežica z donacijo dr. Franca Brinca, zahvale (Križanova, Štrucl, Piškurič, Kavšek) — vse se ujema z zgodbo zapisa.",
        noteEn: "An independent media source: the mass of msgr. Glavan, co-celebrant Miroslavič, the Memento booklet (initiative by Husič, historical work by dr. Weiss, design by the younger Črnič), the new parking place and funeral vestibule with the donation of dr. Franc Brinc, the thanks (Križan, Štrucl, Piškurič, Kavšek) — all consistent with the record's story.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    imageCredit: "Foto: Sl-Ziga · Wikimedia Commons · javna last — Šokčev dvor v Žunićih ob Kolpi",
    lat: 45.482,
    lng: 15.3607,
    coordsApprox: true,
    featured: false,
  ...
  },
  {
    ...
    imageCredit: "Foto: Savinjc · Wikimedia Commons · CC BY-SA 3.0 — Kolpa pri Gribljah",
    lat: 45.5688,
    lng: 15.2988,
    featured: true,
    sources: [
  ...
  },
  {
    ...
    imageCredit: "Foto: švabo · Wikimedia Commons · CC BY 3.0 — slap v Malenci na Kolpi pri Gribljah",
    featured: false,
    sources: [
      {
        key: "commons-malenca",
  ...
  },
  {
    ...
    summarySi:
      "Kolpa nikoli ni bila krotka: na postaji Metlika so v istem koritu zabeležili 4,6 in 1.116 kubičnih metrov vode na sekundo. Leto 2022 je zapisalo oba ekstrema v enem koledarju.",
    summaryEn:
  ...
  },
  {
    ...
    imageCredit: "Foto: švabo · Wikimedia Commons · CC BY-SA 3.0 — mlin v Pobrežju ob Kolpi",
    lat: 45.5315,
    lng: 15.3119,
    featured: false,
    sources: [
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "dl-zupanic-svarski",
        nameSi: "Dolenjski list (2. 12. 2016): Dr. Niko Zupanič, po domače Švarski (1876–1961) — svetovljan iz Gribelj!",
        nameEn: "Dolenjski list (2 Dec 2016): Dr. Niko Zupanič, known at home as Švarski (1876–1961) — a citizen of the world from Griblje!",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/iskanje?q=Gribelj",
        noteSi: "Domače ime hiše (Švarski) v naslovu življenjepisa ob 140. rojstnem dnevu; iskalni arhiv Dolenjskega lista (polni tekst čaka na pridobitev).",
        noteEn: "The house name (Švarski) in the title of the birthday biography on the 140th anniversary; the DL search archive (full text awaits retrieval).",
      },
      {
        key: "sem-f0000212",
        nameSi: "Slovenski etnografski muzej — Zbirka starih fotografij: F0000212, enonadstropna hiša na pero — rojstna hiša dr. Nika Županiča",
        nameEn: "Slovene Ethnographic Museum — Collection of old photographs: F0000212, a single-storey house 'na pero' — the birth house of Dr. Niko Županič",
        sourceType: "fotografija",
        license: "avtorske pravice SEM (ZASP) — uporaba dokumentarnega gradiva po dogovoru",
        url: "https://www.etno-muzej.si/sl/digitalne-zbirke/zbirka-starih-fotografij/f0000212",
        noteSi:
          "Opis SEM: »Enonadstropna hiša na pero, rojstna hiša dr. Nika Županiča.«; klasifikacija: Hiša / Praznična noša in noša ob posebnih priložnostih / Etnologi; prva poznana fotografija rojstne hiše; hišna številka in položaj v vasi neznana (TO_COLLECT); pravice SEM (kontakt miha.spicek@etno-muzej.si).",
        noteEn:
          "The SEM caption: \"A single-storey house 'na pero', the birth house of Dr. Niko Županič.\"; classification: House / Festive costume and costume for special occasions / Ethnologists; the first known photograph of the birth house; the house number and position in the village unknown (TO_COLLECT); rights SEM (contact miha.spicek@etno-muzej.si).",
      },
      {
        key: "odeon-lok-derganc",
        nameSi:
          "Radio Odeon — Ljudje ob Kolpi: Franc Derganc (26. 2. 2026); ob Dergancu tudi Niko Županič in revija Jug 1901",
        nameEn:
          "Radio Odeon — People by the Kolpa: Franc Derganc (26 Feb 2026); alongside Derganc also Niko Županič and the journal Jug 1901",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/ljudje-ob-kolpi-franc-derganc-2/",
        noteSi:
          "Epizoda o kirurgu in literatu iz Semiča; za gribeljski zapis ključna stranko ugotovitev: »leta 1901 sta skupaj z Nikom Zupaničem iz belokranjskih Gribelj izdajala kulturno-politično revijo Jug«.",
        noteEn:
          "An episode on the surgeon and man of letters from Semič; for the Griblje record the side remark is key: 'in 1901, together with Niko Zupanič from the Bela krajina Griblje, he published the cultural-political journal Jug'.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    imageCredit:
      "Foto: Bb63lj · Wikimedia Commons · CC BY 4.0 — Kulturni dom Črnomelj: stavba, v kateri je zasedal SNOS",
    yearFrom: 1944,
    yearTo: 1944,
    lat: 45.5738,
    lng: 15.1942,
  ...
  },
  {
    ...
    imageCredit:
      "Foto: neznani avtor, 1944 · Wikimedia Commons · javna last — zavezniško letalo na letališču Otok",
    yearFrom: 1944,
    yearTo: 1945,
    lat: 45.665,
    lng: 15.323,
  ...
  },
  {
    ...
    imageCredit:
      "Foto: Franjo Veselko, marec 1945 · Wikimedia Commons · javna last — ranjeni partizani opazujejo pristanek zavezniških letal pri Gribljah",
    yearFrom: 1945,
    yearTo: 1945,
    featured: true,
    sources: [
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "wiki-paka-hr",
        nameSi: "Wikipedija (HR): Velika Paka (naselje občine Žakanje, Karlovška županija — sosednji zaselek Ertić)",
        nameEn: "Wikipedia (HR): Velika Paka (a settlement of the Municipality of Žakanje, Karlovac County — neighbouring Ertić)",
        sourceType: "spletni-vir",
        license: "CC BY-SA 4.0",
        url: "https://hr.wikipedia.org/wiki/Velika_Paka",
        noteSi: "Hrvaški sosedji nasproti vasi: Velika Paka in Ertić pripadata občini Žakanje na Karlovškem.",
        noteEn: "The Croatian neighbours opposite the village: Velika Paka and Ertić belong to the Municipality of Žakanje in Karlovac County.",
      },
      {
        key: "wiki-meja-sl-hr",
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "sem-f0000182",
        nameSi: "Slovenski etnografski muzej — Zbirka starih fotografij: F0000182, Belokranjska hiša z gospodarskim poslopjem, Griblje",
        nameEn: "Slovene Ethnographic Museum — Collection of old photographs: F0000182, a Bela krajina house with outbuildings, Griblje",
        sourceType: "fotografija",
        license: "avtorske pravice SEM (ZASP) — uporaba dokumentarnega gradiva po dogovoru",
        url: "https://www.etno-muzej.si/sl/digitalne-zbirke/zbirka-starih-fotografij/f0000182",
        noteSi:
          "Klasifikacija Hiša / Gospodarska poslopja in ostale stavbe v okviru domačije; lokacija Griblje; avtor neznan; pravice SEM (kontakt miha.spicek@etno-muzej.si).",
        noteEn:
          "Classification House / Outbuildings and other structures within the farmstead; location Griblje; author unknown; rights SEM (contact miha.spicek@etno-muzej.si).",
      },
      {
        key: "sem-f0001407",
        nameSi: "Slovenski etnografski muzej — Zbirka starih fotografij: F0001407, Hiša, Griblje (Drago Vahtar, 1. 4. 1928)",
        nameEn: "Slovene Ethnographic Museum — Collection of old photographs: F0001407, a house, Griblje (Drago Vahtar, 1 Apr 1928)",
        sourceType: "fotografija",
        license: "avtorske pravice SEM (ZASP) — uporaba dokumentarnega gradiva po dogovoru",
        url: "https://www.etno-muzej.si/sl/digitalne-zbirke/zbirka-starih-fotografij/f0001407",
        noteSi:
          "Klasifikacija Hiša / Ograja; avtor Drago Vahtar; datum 1. 4. 1928; opis v zapisu SEM: »Hiša, Griblje.«",
        noteEn:
          "Classification House / Fence; author Drago Vahtar; date 1 Apr 1928; the SEM record's caption: \"A house, Griblje.\"",
      },
      {
        key: "sem-f0000183",
        nameSi: "Slovenski etnografski muzej — Zbirka starih fotografij: F0000183, Hiša, Griblje (kokoši na dvorišču)",
        nameEn: "Slovene Ethnographic Museum — Collection of old photographs: F0000183, a house, Griblje (chickens in the yard)",
        sourceType: "fotografija",
        license: "avtorske pravice SEM (ZASP) — uporaba dokumentarnega gradiva po dogovoru",
        url: "https://www.etno-muzej.si/sl/digitalne-zbirke/zbirka-starih-fotografij/f0000183",
        noteSi:
          "Klasifikacija Hiša / Perutninarstvo / Vsakdanja noša; opis SEM: »Hiša, Griblje.«; avtor neznan; tretja fotografija gribeljske hiše v SEM — lokacijska stran digitalnih zbirk za Griblje enumerira pet predmetov (F0000182, F0000183, F0000212, F0000838, F0001407), s tem je SEM-ov fond za vas popolnoma zabeležen; pravice SEM (kontakt miha.spicek@etno-muzej.si).",
        noteEn:
          "Classification House / Poultry / Everyday costume; the SEM caption: \"A house, Griblje.\"; author unknown; the third Griblje house photograph in the SEM — the location page of the digital collections enumerates five items for Griblje (F0000182, F0000183, F0000212, F0000838, F0001407), so the SEM's holdings for the village are now fully recorded; rights SEM (contact miha.spicek@etno-muzej.si).",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    imageCredit:
      "Fotografija 1908 · Wikimedia Commons · javna last — sprevod z zelenim Jurijem in belokranjsko svatbo (ilustrativno: šega, ne Griblje same)",
    featured: false,
    sources: [
  ...
  },
  {
    ...
    imageCredit: "Foto: Fran Vesel, 1920 · Wikimedia Commons · javna last — predenje v Beli krajini",
    yearFrom: 1800,
    yearTo: 1950,
    featured: false,
    sources: [
  ...
  },
  {
    ...
    imageCredit: "Foto: Fran Vesel · Wikimedia Commons · javna last — oranje z volovsko vprego",
    yearFrom: 1953,
    featured: false,
    sources: [
      {
  ...
  },
  {
    ...
    imageCredit: "Foto: fveronesi1 · Wikimedia Commons · CC BY-SA 4.0 — bela štorklja",
    featured: false,
    sources: [
  ...
  },
  {
    ...
    imageCredit: "Foto: Fran Vesel · Slovenski etnografski muzej · javna last — hiša med brezami",
    featured: false,
    sources: [
  ...
  },
  {
    ...
    imageCredit: "Foto: Arne Hodalič · Wikimedia Commons · CC BY-SA 3.0 — črni močeril",
    yearFrom: 1986,
    featured: false,
    addedAt: "2026-09-16",
    sources: [
  ...
  },
  {
    ...
    storySi:
      "Leta 1869 je Dunaj izdal Reichsvolksschulgesetz — državni zakon, ki je šolanje naredil za dolžnost vsakega otroka od šestega do štirinajstega leta. Po deželah cesarstva so zrasle vaške šole: ena učilnica, en učitelj, vsi razredi hkrati. Za Griblje to vprašanje ima odgovor, ki ga je obnovila televizija: za novo šolsko poslopje je leta 1885 daroval sam cesar Franc Jožef, gradnja se je začela tri leta pozneje — zgrajeni zid se je kmalu podrl, zidarju so odvzeli delo — 5. novembra 1889 pa je bilo poslopje slovesno blagoslovljeno. Prvi učitelj, pripravnik Peter Kambič iz Krasinca, je nastopil 29. oktobra 1889 in že januarja umrl za jetiko: zidovje še ni bilo osušeno. Za isto boleznijo je leta 1913 umrl tudi učitelj Frančišek Kalan; njega je nasledil Ernest Šušteršič — mladi Niko Dragoš, ki se je prvega šolskega dne 1913 skril za svinjakom, je odšel prav k njemu. Med vojno je pouk na pol prevzela Amalija Uršič, begunka s Kobaridskega: dobro izobražena Primorka, ki je vasi poleg abecede prinesla še tamburo. Šola je bila enorazrednica z dvema prostoroma — učilnico in učiteljevim stanovanjem — in pouk je tekal po dveh težavnostih hkrati: medtem ko je ena skupina pisala, je druga poslušala.\n\nVaška šola je imela svoj vrstni red: tablica namesto zvezka, kreda namesto peresa, ustno štetje do sto in abecednik pod blazino. Vrstni red je prestavljal tudi kmetijsko leto — ob žetvi in senašbi so klopi stale prazne, saj so otroške roke na kmetiji štele toliko kot odrasle. Vsak izpeljan šolski dan je bila zato majhna zmaga.\n\nBralne navade vasi pozna tudi Mohorjeva družba: med naročniki Društva sv. Mohorja v župniji Podzemelj so bili leta 1916 tudi vaščani iz Gribelj — knjige so v vas prihajale po pošti iz Celja, šolska kronika pa je danes v Slovenskem šolskem muzeju.\n\nKdor je znal brati, je v vas zanesel svet: časopis, ki so si ga podajali od hiše do hiše, in pisma iz Amerike, ki so jih družine poslušale pri petrolijevi luči. Branje je bilo oblika vaške pošte, šola pa njen urad. Iz nje so zrasle poti, ki jih ta zbirka že pozna: Niko Županič, deček iz Gribelj, je postal univerzitetni profesor; Anton Filak, roka od pluga, svetovni prvak v oranju.\n\nBela krajina je šoli dodala še eno poglavje: med drugo svetovno vojno je bila eno najbolj svobodnih ozemelj okupirane Evrope — s šolami, tiskarnami in bolnišnicami. Po italijanski kapitulaciji septembra 1943 je v Črnomlju delovala partizanska gimnazija; stavba na fotografiji tega zapisa je ravno ona — danes glasbena šola. V letu, ko je bil pouk po Evropi prepovedan ali razseljen, je dežela ob Kolpi zmogla celo gimnazijo.\n\nPred podružnično šolo OŠ Loka v Gribljah danes stoji spomenik trinajstim padlim vaščanom — šola in spomin na istem pragu (zapis spomenik-padlim).\n\nZapis se je dolgo vprašal, kdaj je šola prišla v Griblje; o njeni sedanjosti pa ve natanko. Podružnična šola Griblje, del OŠ Loka Črnomelj, je v šolskem letu 2023/2024 štela enaindvajset učencev v dveh kombiniranih oddelkih: prvo- in drugošolce sta poučevala Branka Weiss in Ana Kočevar, tretje-, četrt- in petošolce Jana Štajdohar, angleščino pa David Štefanič; za malico in urejenost šole skrbi Nežka Filak. Septembra 2026 so prag prestopili štirje prvošolci — starejši učenci so jih pozdravili s pesmijo, besedo in torto. Iz tablic v svet, in spet nazaj.\n\nDolenjski list je šolo poimenoval »vas, ki ima svojo šolo«: po organizaciji avtobusnih prevozov — Cerkvišče sicer pripada KS Griblje, njegovi otroci pa vozijo v Črnomelj — šolo obiskujejo le otroci z naslovom Griblje, kar podružnico dela edino slovensko vas s svojo podružnico. Vodja podružnice Marjetka Žunič je v Gribljih začela poučevati leta 1992, po odmiku na matični šoli pa se vrnila; v šolskem letu 2025/2026 je sedemnajst učencev hodi v pete oddelke razširjenega programa, pouk od pol sedmih do pol štirih pa nosijo »podružničarke« — Marjetka Žunič, Branka Weiss, Ana Kočevar in Maruša Špehar, na skupinski fotografiji manjka še Helena Željko. Šola živi od bazarja: z zbranim denarjem so plačali drsanje, na katerega so jih povabili NK Črnomelj in občina, ki je pokrila prevoz. Kronika ima tudi svoj najtežji list — leto 2002, ko je učencev padlo na šest, nato štiri in se je pojavila grožnja zaprtja; vas, krajani in občina so stopili skupaj in šolo obdržali. Njen urnik je bil leta 1963/64 le preurejen: prenehala je biti samostojna šola in postala podružnica OŠ Mirana Jarca, od leta 1989 je podružnica OŠ Loka Črnomelj, leta 2029 pa bo praznovala 140-letnico neprekinjenega delovanja.\n\nLeta 2022 je šola dobila še svoj lasten muzej. Prostor na podstrešju, ki ga poročilo ob 130-letnici že leta 2019 omenja kot muzejsko učilnico, je 2. junija 2022 slovesno odprl literarni večer »V šoli so spravljene mnoge skrivnosti«: program pod mentorstvom učiteljice Jane Štajdohar je povezovala Špela Brinc, nekdaj učenka PŠ Griblje, nagovorila sta ravnateljica OŠ Loka Damjana Vraničar in predsednik KS Toni Brinc — s poudarkom na sodelovanju sovaščanov za ohranitev šole. Špela Brinc je prebrala zapis šolskega leta 1949/50, ko so pionirji zbrali četrt kilograma jabolčnih pečk in 215 kilogramov zdravilnih zelišč ter zaigrali igro Gumb za AFŽ; pel je pevski zbor pod vodstvom Helene Banovec. Večer se je zaključil s himno PŠ Griblje, »Naša šola Gribeljska« — besedilo Majde Lozar, uglasbila pa jo je Maja Kunič, ki je z Majo Špringer zbrala pesmi nekdanjih učencev za recitale učiteljev Antona Jakše, Helene Banovec in Sonje Malnarič; prizor iz starih šolskih klopi je pod vodstvom knjižničarke Urše Prus odigrala vaška mladina, učenci pa so predstavili še »Smetkoto«, skulpturo recikliranja. Učilnica s starim šolskim pohištvom in učnimi sredstvi je najbolj pošten spomenik vaški šoli: muzej znotraj šole, ki ga vsako leto obišče rally starodobnih koles z učno uro iz stare čitanke.\n\nObletnice, ki jih šola šteje, praznuje cela vas. Ob 130-letnici, 16. junija 2019, sta KS Griblje in turistično društvo sklicala srečanje vseh Gribeljcev, ki so našli drugi dom zunaj rojstne vasi; govorniki so bili ravnateljica Damjana Vraničar, predsednik KS Toni Brinc in župan Andrej Kavšek. Upokojeni učitelj Jože Zabukovšek je šoli podaril sliki Filakove in Željkove domačije, ki ju je naslikal po fotografijah iz leta 1928; v otvoritvenem krogu so se zavrtela starodobna kolesa, obiskovalci pa so si ogledali priložnostno razstavo slik. O dogodku je poročal tudi Vaš kanal. Na pročelju šole pa stoji zdaj še ena tabla: aprila 2026, ob praznovanju 91. rojstnega dne, je bila odkrita spominska plošča dr. Franca Brinca, ki je gribeljsko šolo obiskoval v vojnih letih in ji v zadnjih šestih letih namenil 30.000 evrov (zapis franc-brinc).\n\nVaška šola pa je tudi urnik, ki se piše vsako leto na novo. Decembra 2025 so učenci z dramsko igro, glasbo in plesom pripravili novoletno prireditev za starejše krajane — v sodelovanju s prostovoljkami Krajevne organizacije Rdečega križa, KS Griblje in občino; starostnikom so podarili šolski domači čaj in voščilnico, vodja podružnice Marjetka Žunič pa je prenesla voščilo krajana Franca Brinca, ki je šoli ob koncu leta znova podaril 5.000 evrov. Oktobra 2021 je šolo obiskal dr. Brinc — njen vojni učenec, ki je za starimi klopmi na podstrešju spet sedel kot šolar. 23. junija 2026 je sledila zaključna prireditev s slovom od petošolca Tonija, zvečer pa Noč knjige: prenočitev v šoli, kjer jim je učiteljica Ana Kočevar prebrala pravljico Palček Migetaliček Vesne Draginc, naslednji dan pa osvežitev na gribeljskem kopališču. Ob koncu istega šolskega leta je podružnica gostila eno od prvih zaključnih srečanj projekta Pravljični potujoči kovček (19. sezona), pomladi pa so ob Erasmus+ izmenjavi gostje iz Srbije zasadili na šoli dve sadni drevesi in tradicionalno gribeljsko čebulo — šola, ki je k rojstni hiši Županiča pripeljala etnologa sveta, zdaj k svoji gredici vabi svet.\n\nMuzej išče razredne fotografije, imena učiteljev in učne knjige z imeni gribeljskih otrok. Vaška šola je zapustila največ arhiva in najmanj spomina: kdo pa si danes še zapomni, kaj je bilo napisano na tablici?",
    storyEn:
      "In 1869 Vienna issued the Reichsvolksschulgesetz — an imperial law that made schooling the duty of every child from six to fourteen. Across the lands of the Empire village schools grew up: one classroom, one teacher, all the grades at once. For Griblje that question now has an answer television has brought back to light: for the new school building Emperor Franz Joseph himself donated in 1885; building began three years later — the freshly built wall soon collapsed, and the mason lost the job — and on 5 November 1889 the building was solemnly blessed. The first teacher, the trainee Peter Kambič of Krasinec, took up his post on 29 October 1889 and died of tuberculosis as early as January: the walls were not yet dry. Of the same illness died, in 1913, the teacher Frančišek Kalan; he was followed by Ernest Šušteršič — the young Niko Dragoš, who hid behind the pigsty on his first school morning in 1913, walked straight to him. During the war the teaching was half taken over by Amalija Uršič, a refugee from the Kobarid country: a well-schooled woman of the Littoral who brought the village the tambura beside the alphabet. The school was a one-room one with two spaces — the classroom and the teacher's flat — and lessons ran at two levels at once: while one group wrote, the other listened.\n\nThe village school kept its own order: a slate instead of an exercise book, chalk instead of a pen, counting aloud to a hundred and a primer under the pillow. The order shifted with the farming year as well — at harvest and haying the benches stood empty, for on a farm children's hands counted as much as grown ones. Every completed school day was therefore a small victory.\n\nThe village's reading habits are known to the Mohor society as well: among the subscribers of the Society of St. Mohor in the Podzemelj parish in 1916 were villagers of Griblje — books reached the village by post from Celje, and the school chronicle is kept today in the Slovene School Museum.\n\nWhoever could read carried the world into the village: the newspaper passed from house to house, and the letters from America that families listened to by the petroleum lamp. Reading was a form of the village post, and the school was its office. Out of it grew the roads this collection already knows: Niko Županič, the boy from Griblje, became a university professor; Anton Filak, a hand from the plough, a world champion of ploughing.\n\nBela krajina added another chapter to the school: during the Second World War it was one of the freest territories of occupied Europe — with schools, print shops and hospitals. After the Italian capitulation in September 1943 a Partisan gymnasium operated in Črnomelj; the building in this record's photograph is precisely that one — today a music school. In a year when lessons across Europe were forbidden or scattered, the land by the Kolpa sustained even a grammar school.\n\nBefore the branch school of OŠ Loka at Griblje stands the memorial to the thirteen fallen villagers — school and memory on the same threshold (see the record of the memorial).\n\nThe record long asked when the school came to Griblje; about its present it knows precisely. The branch school of Griblje, part of OŠ Loka Črnomelj, counted twenty-one pupils in two combined departments in the school year 2023/2024: the first and second grades were taught by Branka Weiss and Ana Kočevar, the third, fourth and fifth by Jana Štajdohar, English by David Štefanič; Nežka Filak cares for the morning snack and the school's order. In September 2026 four first-graders crossed the threshold — the older pupils welcomed them with a song, a word and a cake. From slates into the world, and back again.\n\nDolenjski list called the school »a village that has its own school«: because of the bus arrangements — Cerkvišče belongs to the local community of Griblje, but its children are driven to Črnomelj — only children with a Griblje address attend, which makes this branch the only one serving a single Slovene village. Head Marjetka Žunič began teaching in Griblje in 1992, left for the parent school, and returned; in the 2025/2026 school year seventeen pupils walked into five departments of the extended programme, with lessons running from half past six to half past three under the four »podružničarke« — Marjetka Žunič, Branka Weiss, Ana Kočevar and Maruša Špehar, with Helena Željko missing from the group photograph. The school lives from its bazaar: money raised there paid for the skating trip to which NK Črnomelj and the municipality invited them, with the municipality covering the transport. The chronicle has its heaviest leaf too — the year 2002, when pupils fell to six, then four, and the threat of closure became real; villagers, neighbours and the municipality stood together and kept the school. Its timetable was only re-arranged in 1963/64: it ceased to be an independent school and became a branch of OŠ Mirana Jarca, since 1989 it has been a branch of OŠ Loka Črnomelj, and in 2029 it will celebrate 140 years of unbroken operation.\n\nIn 2022 the school also received a museum of its own. The attic room, already mentioned as a museum classroom in the report on the school's 130th anniversary in 2019, was solemnly opened on 2 June 2022 by a literary evening, »V šoli so spravljene mnoge skrivnosti« (Many Secrets Are Kept in the School): the programme, mentored by teacher Jana Štajdohar, was hosted by Špela Brinc, once a pupil of the Griblje school; the principal of OŠ Loka, Damjana Vraničar, and the president of the local community, Toni Brinc, addressed the guests — the latter stressing the cooperation of fellow villagers needed to keep the school. Špela Brinc read a record from the school year 1949/50, when the pioneers collected a quarter of a kilogram of apple seeds and 215 kilograms of medicinal herbs and staged the play Gumb za AFŽ; the choir sang under the direction of Helena Banovec. The evening closed with the anthem of the Griblje school, »Naša šola Gribeljska« (Our Griblje School) — words by Majda Lozar, set to music by Maja Kunič, who with Maja Špringer collected the poems of former pupils for recitals by teachers Anton Jakša, Helena Banovec and Sonja Malnarič; the scene from the old school benches was staged under the guidance of librarian Urša Prus, and the pupils also presented »Smetkota«, a sculpture of recycling. A room with old school furniture and teaching aids is the most honest monument to a village school: a museum inside the school, which the vintage-bicycle rally visits every year for a lesson from an old reader.\n\nThe anniversaries the school counts, the whole village celebrates. At the 130th anniversary, on 16 June 2019, the local community and the Tourist Society called together all Griblje people who had found a second home away from the birth village; the speakers were principal Damjana Vraničar, community president Toni Brinc and mayor Andrej Kavšek. The retired teacher Jože Zabukovšek gave the school two paintings — of the Filak and Željko homesteads — which he had painted himself from photographs of 1928; vintage bicycles of the »Torpedovci« turned in the opening circle, and visitors saw a temporary exhibition of paintings. Vaš kanal television reported on the day as well. And the school's facade now carries one more plaque: in April 2026, at the celebration of his 91st birthday, a memorial plaque was unveiled to dr. Franc Brinc, who attended the Griblje school during the war years and has given it 30,000 euros in the last six years (see the record franc-brinc).\n\nThe village school is also a timetable written anew every year. In December 2025 the pupils prepared a New Year event for the village's elders with a drama play, music and dancing — together with the volunteers of the Red Cross local organisation, the Griblje local community and the municipality; the elders received the school's home-made tea and a greeting card, and branch head Marjetka Žunič conveyed the greetings of villager Franc Brinc, who once again gave the school 5,000 euros at the year's end. In October 2021 Dr Brinc visited the school — its wartime pupil, who sat once more like a schoolboy at the old desks in the attic. On 23 June 2026 came the closing event with a farewell to the fifth-grader Toni, and in the evening the Night of the Book: a night spent at school, where teacher Ana Kočevar read Vesna Draginc's tale Palček Migetaliček, followed the next day by a swim at the Griblje bathing place. At the end of the same school year the branch hosted one of the first closing meetings of the Travelling Storybook Suitcase project (its 19th season), and in spring, during an Erasmus+ exchange, guests from Serbia planted two fruit trees and the traditional Griblje onion at the school — the school that once carried the world's ethnologist from the birth house of Županič now invites the world to its garden bed.\n\nThe museum is looking for class photographs, teachers' names and schoolbooks bearing the names of Griblje's children. The village school left behind the greatest archive and the least memory: who today still remembers what was written on the slate?",
    evidenceStatus: "TRADITION",
    image: "/images/authentic/glasbena-crnomelj.jpg",
    imageCredit:
      "Foto: Bb63lj · Wikimedia Commons · CC BY 4.0 — stavba partizanske gimnazije v Črnomlju (1943), danes glasbena šola",
    yearFrom: 1869,
    featured: false,
    sources: [
      {
      ...
      },
      {
        ...
        sourceType: "fotografija",
        license: "CC BY 4.0",
        url: WM("Glasbena_%C5%A1ol_%C4%8Crnomelj,_med_drugo_svetovno_vojno_partizanska_gimnazija.jpg"),
        noteSi: "Glavna slika zapisa: stavba, v kateri je med vojno delovala partizanska gimnazija — najbolj drzna stran šolske zgodbe Bele krajine.",
        noteEn: "The record's main image: the building that housed the wartime partisan gymnasium — the boldest page of Bela krajina's school history.",
      },
      {
        ...
        noteSi: "Prejšnja slika zapisa: Trubarjev abecednik iz leta 1550 — simbol poti »iz tablic v svet«; zamenjala ga je stavba partizanske gimnazije, ki jo zgodba zapisa imenuje po imenu.",
        noteEn: "The record's earlier image: Trubar's primer of 1550 — the symbol of the road \"from slates into the world\"; it was replaced by the building of the partisan gymnasium, which the record's story names by name.",
      },
      {
      ...
      {
        key: "os-loka-130-let",
        nameSi: "OŠ Loka Črnomelj — Praznovanje 130 let gribeljske šole (19. 6. 2019)",
        nameEn: "OŠ Loka Črnomelj — Celebrating 130 years of the Griblje school (19 June 2019)",
        sourceType: "spletni-vir",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.os-loka-crnomelj.si/praznovanje-130-let-gribeljske-sole/",
        noteSi: "130 let obeležena 16. 6. 2019; srečanje vseh Gribeljcev (KS+TD); govorniki Vraničar, Toni Brinc, Kavšek; Zabukovškovi sliki domačij po fotografijah 1928; Torpedo v otvoritvenem krogu; razstava in muzejska učilnica na podstrešju; Vaš kanal 17. 6. 2019; misel Branke Weiss.",
        noteEn: "130 years marked on 16 June 2019; the reunion of all Griblje people (KS+TD); speakers Vraničar, Toni Brinc, Kavšek; Zabukovšek's two homestead paintings after 1928 photographs; Torpedo in the opening circle; exhibition and attic museum classroom; Vaš kanal 17 Jun 2019; Branka Weiss's motto.",
      },
      {
        key: "dl-muzejska-ucilnica",
        nameSi: "Dolenjski list — V šoli so spravljene mnoge skrivnosti: odprtje muzejske učilnice na PŠ Griblje (2. 6. 2022)",
        nameEn: "Dolenjski list — Many secrets are kept in the school: opening the museum classroom at PŠ Griblje (2 June 2022)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/kultura/v-soli-so-spravljene-mnoge-skrivnosti-odprtje-muzejske-ucilnice-na-ps-griblje-263268-1783688",
        noteSi: "Literarni večer 2. 6. 2022: mentorica Jana Štajdohar, povezovala Špela Brinc (nekdaj učenka); ravnateljica Damjana Vraničar; predsednik KS Toni Brinc; zapis 1949/50 (¼ kg pečk, 215 kg zelišč, igra Gumb za AFŽ); zbor Helene Banovec.",
        noteEn: "Literary evening 2 June 2022: mentor Jana Štajdohar, hosted by Špela Brinc (once a pupil); principal Damjana Vraničar; KS president Toni Brinc; the 1949/50 record (¼ kg of seeds, 215 kg of herbs, the play Gumb za AFŽ); choir of Helena Banovec.",
      },
      {
        key: "dl-vas-s-svojo-solo",
        nameSi: "Dolenjski list — Vas, ki ima svojo šolo: obiskoval jo je tudi najstarejši Slovenec (2026)",
        nameEn: "Dolenjski list — The village that has its own school: even the oldest Slovene attended it (2026)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/podruznicna-sola-griblje-1870858",
        noteSi: "17 učencev v petih oddelkih RaP (2025/26); podružničarke Žunič/Weiss/Kočevar/Špehar (+ Željko); Žuničeva v Gribljih od 1992; samostojna do 1963/64, potem OŠ Mirana Jarca, od 1989 OŠ Loka; kriza 2002 (6→4 učencev); 140-letnica 2029; edina vas s svojo podružnico; Niko Dragoš 111 let.",
        noteEn: "17 pupils in five departments of the extended programme (2025/26); the branch teachers Žunič/Weiss/Kočevar/Špehar (+ Željko); Žunič in Griblje since 1992; independent until 1963/64, then OŠ Mirana Jarca, from 1989 OŠ Loka; the 2002 crisis (6→4 pupils); the 140th anniversary in 2029; the only village with its own branch; Niko Dragoš, 111 years.",
      },
      {
        key: "odeon-v-soli-skrivnosti",
        nameSi: "Radio Odeon — V šoli so spravljene mnoge skrivnosti (3. 6. 2022; avtor PŠ Griblje)",
        nameEn: "Radio Odeon — Many secrets are kept in the school (3 June 2022; author PŠ Griblje)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://radio-odeon.com/novice/v-soli-so-spravljene-mnoge-skrivnosti",
        noteSi: "Regionalni zapis o odprtju učilnice; foto Anja Tomanič in Katarina Pavlakovič; vir OŠ Loka Črnomelj. Polno besedilo (10. val raziskave): himna PŠ Griblje »Naša šola Gribeljska« — besedilo Majda Lozar, uglasbila Maja Kunič; pesmi nekdanjih učencev zbrali Kunič in Maja Špringer; recitali učiteljev Antona Jakše, Helene Banovec in Sonje Malnarič; prizor iz klopi pod vodstvom knjižničarke Urše Prus; skulptura recikliranja Smetkota.",
        noteEn: "The regional account of the classroom opening; photos Anja Tomanič and Katarina Pavlakovič; source OŠ Loka Črnomelj. Full text (research wave 10): the anthem of the Griblje school »Naša šola Gribeljska« — words by Majda Lozar, set to music by Maja Kunič; poems of former pupils collected by Kunič and Maja Špringer; recitals by teachers Anton Jakša, Helena Banovec and Sonja Malnarič; the bench scene guided by librarian Urša Prus; the recycling sculpture Smetkota.",
      },
      {
        key: "osloka-brinc-2021",
        nameSi:
          "OŠ Loka Črnomelj (15. 10. 2021): Obiskal nas je dr. Franc Brinc — donator PŠ Griblje na šoli, ki jo je obiskoval med vojno",
        nameEn:
          "OŠ Loka Črnomelj (15 Oct 2021): Dr Franc Brinc visited us — the donor of the Griblje branch school, at the school he attended during the war",
        sourceType: "spletni-vir",
        license: "javna informacija / public information",
        url: "https://www.os-loka-crnomelj.si/obiskal-nas-je-dr-franc-brinc/",
        noteSi:
          "Obisk 8. 10. 2021: dobrodošlica ravnateljice Damjane Vraničar, ogled učil in »stare učilnice« na podstrešju (sede za starimi klopmi — pouk obiskoval v času 2. svetovne vojne); organizacija KS Griblje s predsednikom Tonijem Brincem, prisoten župan Andrej Kavšek; slavnostno odprtje cestne razsvetljave blizu šole.",
        noteEn:
          "A visit of 8 Oct 2021: the welcome by headmistress Damjana Vraničar, a tour of the teaching aids and the 'old classroom' in the attic (sat at the old desks — he attended lessons during WWII); organised by the Griblje local community with president Toni Brinc, mayor Andrej Kavšek present; the ceremonial opening of the street lighting near the school.",
      },
      {
        key: "odeon-novoletna-2025",
        nameSi:
          "Radio Odeon (19. 12. 2025): Novoletna prireditev za starostnike v gribeljski podružnici — Franc Brinc šoli znova podaril 5.000 evrov",
        nameEn:
          "Radio Odeon (19 Dec 2025): New Year event for the elderly at the Griblje branch school — Franc Brinc again donated 5,000 euros",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/novoletna-prireditev-za-starostnike-v-gribeljski-podruznici/",
        noteSi:
          "Prireditev za starejše krajane v sodelovanju prostovoljk Krajevne organizacije Rdečega križa, KS Griblje in Občine Črnomelj; vodja podružnice Marjetka Žunič je prenesla voščilo krajana Franca Brinca, ki je »ob koncu leta šoli ponovno podaril 5.000 evrov«; darila starostnikom: šolski domači čaj in voščilnica.",
        noteEn:
          "An event for elderly villagers with the volunteers of the Red Cross local organisation, the Griblje local community and the Municipality of Črnomelj; branch head Marjetka Žunič conveyed the greetings of villager Franc Brinc, who 'again donated 5,000 euros to the school at the end of the year'; gifts for the elderly: the school's home-made tea and a greeting card.",
      },
      {
        key: "odeon-zakljucek-solskega-leta-2026",
        nameSi:
          "Radio Odeon (4. 7. 2026): Septembra se ponovno srečamo v šolskih klopeh — zaključna prireditev, Noč knjige in kopališče",
        nameEn:
          "Radio Odeon (4 Jul 2026): We shall meet again in the school benches in September — the closing event, the Night of the Book and the bathing place",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/septembra-se-ponovno-srecamo-v-solskih-klopeh/",
        noteSi:
          "Zaključna prireditev 23. 6. 2026 (ples, petje, recitacije; slovo od petošolca Tonija); prenočitev v šoli v okviru Noči knjige — učiteljica Ana Kočevar je prebrala pravljico Palček Migetaliček Vesne Draginc, naslednji dan kopanje na kopališču v Gribljih.",
        noteEn:
          "The closing event of 23 June 2026 (dancing, singing, recitations; farewell to the fifth-grader Toni); a night spent at school within the Night of the Book — teacher Ana Kočevar read Vesna Draginc's tale Palček Migetaliček, followed the next day by a swim at the Griblje bathing place.",
      },
      {
        key: "odeon-pravljicni-kovcek-2026",
        nameSi:
          "Radio Odeon (1. 6. 2026): Veseli zaključki projekta Pravljični potujoči kovček — zaključni srečanji na OŠ Vinica in PŠ Griblje",
        nameEn:
          "Radio Odeon (1 Jun 2026): Happy endings of the Travelling Storybook Suitcase project — the closing meetings at OŠ Vinica and the Griblje branch school",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/veseli-zakljucki-projekta-pravljicni-potujoci-kovcek/",
        noteSi:
          "Ob koncu šolskega leta 2025/26 sta prvi zaključni srečanji projekta potekali na OŠ Vinica in PŠ Griblje — zaznamovala sta jih ustvarjalnost, veselje in bogat kulturni program.",
        noteEn:
          "At the end of the 2025/26 school year the first closing meetings of the project were held at OŠ Vinica and the Griblje branch school — marked by creativity, joy and a rich cultural programme.",
      },
      {
        key: "odeon-kovcek-sezona-19-2026",
        nameSi:
          "Radio Odeon (14. 6. 2026): Zaključek 19. sezone Pravljičnega potujočega kovčka — med obiskanimi tudi PŠ Griblje",
        nameEn:
          "Radio Odeon (14 Jun 2026): The end of the 19th season of the Travelling Storybook Suitcase — the Griblje branch school among the visited",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/zakljucek-19-sezone-pravljicnega-potujocega-kovcka/",
        noteSi:
          "V juniju je kovček obiskal Vrtec Dragatuš, OŠ Loka, Vrtec Loka, Vrtec Semič, OŠ Mirana Jarca in PŠ Griblje — šola v Gribljih v popisu projekta, ki potuje po obeh straneh Gorjancev.",
        noteEn:
          "In June the suitcase visited the Dragatuš kindergarten, OŠ Loka, the Loka kindergarten, the Semič kindergarten, OŠ Miran Jarca and the Griblje branch school — the school in Griblje in the register of a project that travels on both sides of the Gorjanci hills.",
      },
      {
        key: "odeon-zbul-erasmus-2026",
        nameSi:
          "Radio Odeon (6. 4. 2026): Gostovanje učencev iz Srbije — na PŠ Griblje zasadili dve sadni drevesi in tradicionalno gribeljsko čebulo",
        nameEn:
          "Radio Odeon (6 Apr 2026): The visit of pupils from Serbia — two fruit trees and the traditional Griblje onion planted at the Griblje branch school",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/gostovanje-ucencev-iz-srbije/",
        noteSi:
          "Erasmus+ izmenjava OŠ Loka Črnomelj z OŠ Desanke Maksimović iz Gornjega Milanovca (14 učencev): v tednu gostovanja tudi obisk podružnične šole Griblje, kjer so učenci zasadili »še dve sadni drevesi in tradicionalno gribeljsko čebulo«.",
        noteEn:
          "An Erasmus+ exchange of OŠ Loka Črnomelj with the Desanka Maksimović school from Gornji Milanovac (14 pupils): the week of the visit also included a stop at the Griblje branch school, where the pupils planted 'two more fruit trees and the traditional Griblje onion'.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "inz-okupacijske-meje-postojanka",
        nameSi: "Razstava Okupacijske meje 1941–1945 (INZ): Italijanske in MVAC postojanke v Beli krajini — utrditev gribeljske postojanke 8. 4. 1942 in partizanska skica",
        nameEn: "The Occupation Borders 1941–1945 exhibition (INZ): the Italian and MVAC posts in Bela krajina — the fortification of the Griblje post on 8 April 1942 and the Partisan sketch",
        sourceType: "spletni-vir",
        license: "navedba vira (Arhiv RS)",
        url: "https://okupacijskemeje.si/exh04-ch02.html",
        noteSi:
          "Inštitut za novejšo zgodovino: »V Gribljah so 8. aprila 1942 fašisti zasedli šolo, financarji pa civilno hišo. Gribeljsko postojanko so obdali z bodečo žico in jo utrdili s petimi betonskimi bunkerji in tremi bunkerji vkopanimi v zemljo ter kamnitim in betonskim zidom. Skopali so tudi povezovalne jarke.« Partizanska skica postojanke — konec 1942 ali prva polovica 1943 — Arhiv RS.",
        noteEn:
          "The Institute of Contemporary History: \"On 8 April 1942, Fascists occupied the school in Griblje, while the Financial Guard occupied a civilian house. The post in Griblje was enclosed by barbed wire and fortified with five concrete bunkers and three bunkers dug into the ground, as well as with a stone and concrete wall. They also dug connecting trenches.\" The Partisan sketch of the post — late 1942 or the first half of 1943 — Archives of the RS.",
      },    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "gac-freyer-izrez",
        nameSi: "Google Arts & Culture: Henrik Freyer — Zemljevid vojvodine Kranjske (1843), posnetek Narodne in univerzitetne knjižnice (povečevalni pregledovalnik)",
        nameEn: "Google Arts & Culture: Henrik Freyer — Map of the Duchy of Carniola (1843), National and University Library scan (zoom viewer)",
        sourceType: "spletni-vir",
      ...
      },
      {
        ...
        nameSi: "Wikimedia Commons: Special-Karte des Herzogthums Krain 1843 (Henrik Freyer) — drugi posnetek istega lista (dLib), ves list na en pogled",
        nameEn: "Wikimedia Commons: Special-Karte des Herzogthums Krain 1843 (Henrik Freyer) — another scan of the same sheet (dLib), the whole sheet at a glance",
        sourceType: "fotografija",
        license: "javna last / public domain",
      ...
      },
      {
        ...
        noteSi:
          "Prva slika tega zapisa (september 2026): Zemlja iz orbite, središče nad vaškim okoljem; zamenjala jo je Freyerjeva karta, ker številkam in zapisi imena vasi bolj prislužne listine in karte kot razsežnost, ki jo vidi samo astronaut.",
        noteEn:
          "The record's first image (September 2026): Earth from orbit, the frame centred on the village's countryside; it was replaced by Freyer's map, for a record about names and numbers is better served by charters and maps than by a dimension only an astronaut can see.",
      },
    ],
  },
  {
    ...
    titleEn: "The Municipality of Griblje — the eighty years the village governed itself",
    periodSi: "1854–1933 občina · 1936 k občini Gradac · danes krajevna skupnost",
    periodEn: "1854–1933 a municipality · 1936 to the Gradac municipality · today a local community",
    summarySi:
      "Griblje niso bile vedno le vas: po reformi sredi 19. stoletja so bile ena od občin okraja Črnomelj — z županom, svetom in 435 prebivalci ob popisu 1921. Komasacija leta 1933 jih je razpustila, leta 1936 sta kraja Griblje in Dragoši prešli h občini Gradac; samostojnost je vasi ostala v novi obliki — krajevna skupnost.",
    summaryEn:
      "Griblje was not always only a village: after the mid-19th-century reform it was one of the municipalities of the Črnomelj district — with a mayor, a council and 435 inhabitants at the 1921 census. The 1933 amalgamation dissolved it; in 1936 the places of Griblje and Dragoši passed to the Gradac municipality; the village's selfhood survived in a new form — the local community.",
    storySi:
      "Občinska doba vasi se začne s preureditvijo, ki jo je prineslo nemirno leto 1848: marčna ustava je občino razglasila za temelj lokalne oblasti, dežela Kranjska pa jih je leta 1854 štela kar 501. V okraju Črnomelj jih je bilo štiriindvajset — med njimi Griblje, na istem seznamu kot Črnomelj, Vinica in Podzemelj. Taka občina je bila majhna, a popolna: župan, občinski odbor, skromni davki in pečat — vas, ki je sama sebi pisala odloke.\n\nUreditev je zdržala do prve svetovne vojne. Ko je nova država leta 1921 preštevala prebivalstvo, je občina Griblje dobila svojo številko: 435 prebivalcev. Nato se je upravna karta preokrenila dvakrat: leta 1929 je Bela krajina pripadla Savski banovini s sedežem v Zagrebu, leta 1931 pa je srez Črnomelj prešel v Dravsko banovino.\n\nPotem je prišel 11. september 1933. Komasacija — zložitev občin — je iz 1069 dravskih občin naredila 377 velikih enot; »skoro vse male občine so bile ukinjene«, zapiše priročnik Županske zveze iz leta 1937. Med njimi tudi Griblje: razpuščena in priključena novi občini Adlešiči, skupaj s Tribuči in Zuniči. A zgodba se ni končala tam. 21. septembra 1936 je kraljevi ukaz (Službeni list št. 78/36) iz občine Adlešiči izločil kraja Dragoši in Griblje ter ju priključil občini Gradac ob Lahinji. Do vojne je bila vas torej pod tujo občinsko streho — a izpisana z datumom, številko lista in odlokom: tako natančno, kakor se pišejo samo uradne usode.\n\nPo vojni se je zemljevid menjal hitreje, kot so se menjavala imena oblasti: italijanska okupacija je vas potegnila v Ljubljansko pokrajino, 15. maja 1944 pa je predsedstvo SNOS Belo krajino razdelilo na štiri okrožja in 139 krajevnih enot. Leta 1955 je dokončno zrasla občina Črnomelj, v kateri Griblje ostajajo še danes; ustava iz leta 1974 je vasi vrnila del stare samostojnosti v novi obliki — krajevna skupnost Griblje, ki danes sanira vasi ceste in enkrat na leto praznuje svoj praznik.\n\nZa muzej je občinska doba hkrati najbolj in najmanj dokumentirana: datumi in odloki ležijo v arhivih, župani občine Griblje pa niso poimensko znani. Seznam županov, občinski pečat, volilni imenik, ena sama listina z županovim podpisom — vsak od teh predmetov bi bil v tej zbirki toplo dobrodošel dokaz osemdesetih let, ko so Griblje same sebi županile.",
    storyEn:
      "The village's municipal era begins with the reordering that the restless year of 1848 brought: the March constitution declared the municipality the foundation of local authority, and by 1854 the land of Carniola counted as many as 501 of them. The Črnomelj district held twenty-four — Griblje among them, on the same list as Črnomelj, Vinica and Podzemelj. Such a municipality was small but complete: a mayor, a municipal board, modest taxes and a seal — a village that wrote its own decrees.\n\nThe arrangement lasted until the First World War. When the new state counted its people in 1921, the Municipality of Griblje received its number: 435 inhabitants. Then the administrative map turned twice: in 1929 Bela krajina belonged to the Sava Banovina seated in Zagreb, and in 1931 the Črnomelj srez passed to the Drava Banovina.\n\nThen came 11 September 1933. The komasacija — the amalgamation of municipalities — turned 1,069 Drava Banovina municipalities into 377 large units; \"almost all the small municipalities were abolished\", writes the Association of Municipalities' handbook of 1937. Among them Griblje: dissolved and joined to the new Municipality of Adlešiči, together with Tribuče and Zuniči. But the story did not end there. On 21 September 1936 a royal decree (Official Gazette no. 78/36) separated the places of Dragoši and Griblje from the Adlešiči municipality and joined them to the Municipality of Gradac on the Lahinja. Until the war, then, the village lived under another municipality's roof — but written down with a date, a gazette number and a decree: as precisely as only official fates are written.\n\nAfter the war the map changed faster than the names of the regimes: the Italian occupation drew the village into the Province of Ljubljana, and on 15 May 1944 the presidency of SNOS divided Bela krajina into four districts and 139 local units. In 1955 the Municipality of Črnomelj finally took shape, within which Griblje remains to this day; the 1974 constitution returned the village part of its old selfhood in a new form — the Local Community of Griblje, which today repairs the village's roads and, once a year, celebrates its festival.\n\nFor the museum, the municipal era is at once the best and the least documented: the dates and decrees lie in archives, but the mayors of the Municipality of Griblje are not known by name. A list of mayors, a municipal seal, an electoral register, a single document bearing a mayor's signature — each of these objects would be a warmly welcome proof in this collection of the eighty years when Griblje governed itself.",
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/obcina-griblje-1937.jpg",
    imageCredit:
      "Vir: Županska zveza v Ljubljani — Občine dravske banovine v letih 1933–1937 (Ljubljana 1937) · Wikimedia Commons · javna last — izrez tabele Okraj Črnomelj: vrstici Adlešiči in Gradac z usodo občine Griblje",
    yearFrom: 1854,
    yearTo: 1933,
    lat: 45.5728,
    lng: 15.2926,
    ...
    sources: [
      {
        key: "wiki-obcina-crnomelj",
        nameSi: "Wikipedija: Občina Črnomelj — zgodovina upravne členitve (1854, 1921, banovine, povojne reforme)",
        nameEn: "Wikipedia: Municipality of Črnomelj — the history of the administrative division (1854, 1921, the banovinas, the post-war reforms)",
        sourceType: "spletni-vir",
        license: "CC BY-SA 4.0",
        url: "https://sl.wikipedia.org/wiki/Ob%C4%8Dina_%C4%8Crnomelj",
        noteSi: "1854: Griblje med štiriindvajsetimi občinami okraja Črnomelj; 1921: občina Griblje 435 prebivalcev; 1929 Savska → 1931 Dravska banovina; SNOS 1944, reforme 1945/1952/1955.",
        noteEn: "1854: Griblje among the twenty-four municipalities of the Črnomelj district; 1921: the Municipality of Griblje at 435 inhabitants; 1929 Sava → 1931 Drava Banovina; SNOS 1944, the reforms of 1945/1952/1955.",
      },
      {
        key: "commons-obcine-1937",
        nameSi: "Županska zveza v Ljubljani (1937): Občine dravske banovine v letih 1933–1937 — priročnik o komasaciji (sken: Wikimedia Commons)",
        nameEn: "Association of Municipalities of Ljubljana (1937): The Municipalities of the Drava Banovina 1933–1937 — the amalgamation handbook (scan: Wikimedia Commons)",
        sourceType: "objava",
        license: "javna last / public domain",
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "odeon-rally-2026-torpedo",
        nameSi: "Radio Odeon (6. 7. 2026): Po Gribljah s starodobnimi kolesi — Rally Griblje 2026",
        nameEn: "Radio Odeon (6 Jul 2026): Through Griblje on vintage bicycles — the Rally Griblje 2026",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://radio-odeon.com/novice/po-gribljah-s-starodobnimi-kolesi/",
        noteSi: "Program 2026 (vir: TD Griblje): okrog 50 kolesarjev iz osmih slovenskih in hrvaških društev, zajtrk, ogled cerkve sv. Vida in stare šole z učno uro »Bistre buče«, Country Roses, igre na kopališču.",
        noteEn: "The 2026 programme (source: TD Griblje): some 50 riders from eight Slovene and Croatian societies, breakfast, the visit to the church of St. Vitus and the old school with the lesson »Bistre buče«, the Country Roses, games at the bathing ground.",
      },
      {
      ...
      {
        key: "odeon-torpedo-semska-ohcet-2026",
        nameSi:
          "Radio Odeon (30. 8. 2026): Posebni gostje blagoslova motoristov in kolesarjev na Sem'ški ohceti — ljubitelji starih koles Torpedo – Griblje",
        nameEn:
          "Radio Odeon (30 Aug 2026): Special guests at the blessing of motorcyclists and cyclists at the Sem'ška ohcet — the Torpedo – Griblje vintage bicycle lovers",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/na-semski-ohceti-v-znamenju-tradicije-mladih-talentov-in-ljubezni/",
        noteSi:
          "Festival Sem'ška ohcet 2026 v Semiču (avgust): tradicionalni blagoslov motoristov in kolesarjev pred kulturnim centrom, posebni gostje — ljubitelji starih koles Torpedo – Griblje.",
        noteEn:
          "The Sem'ška ohcet 2026 festival in Semič (August): the traditional blessing of motorcyclists and cyclists in front of the cultural centre, special guests — the Torpedo – Griblje vintage bicycle lovers.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    storySi:
      "Vsaka vas ima dvoje spomina: živega, ki ga nosijo ljudje, in papirnatega, ki ga nosi župnija. Za Griblje papirnati spomin hranita hrib sv. Vida in župnijski urad v Podzemlju: cerkev v Gribljah je od nekdaj podružnica (Filialkirche) župnije Podzemelj, zavetnika sv. Martina — in kar se je v vasi rodilo, poročilo ali umrlo, se je zapisalo v podzemeljske matične knjige.\n\nTe knjige so med najstarejšim neprekinjenim zapisom te dežele: segajo v leto 1669, ko se je po tridesetletni vojni svet komaj uredil, in se končajo leta 1947, ko so državni registri prevzeli nalogo. Dvaindvajset knjig — krstnih, poročnih in mrliških — je digitaliziranih in jih Nadškofijski arhiv Ljubljana objavlja prosto dostopno na portalu Matricula Online. Za Gribeljce v Clevelandu, Buenos Airesu ali Združenih državah to pomeni nekaj, česar stoletja ni bilo: rodovnik domače hiše lahko listajo brez potovanja.\n\nMatične knjige niso samo imena in datumi. Botri, ki se zapisujejo ob vsakem krstu, so karta vaške družbene mreže: kdo je komu stal ob krstu, pri poroki, ob postelji. Iz vpisov se izlušči, kdaj se je katera družina priselila ali izselila, kdaj je morila nesreča, kdaj so bila leta obilja. Zgodovinarji v takih knjigah berejo demografijo cele pokrajine; za domačine pa so kraj, kjer babica še enkrat postane dekle.\n\nMed dvaindvajsetimi knjigami se skriva ena z nenavadno oznako: mrliški zvezek 1728–1803 v arhivskem katalogu nosi ime Nemškega viteškega reda. Vitezovi tega reda so v Belo krajino prišli leta 1236, ko so nadomestili templjarje, leta 1268 pa so od kranjskega vojvode Ulrika III. prejeli župnijo Črnomelj z vsemi podružnicami in posestmi; njihova komenda je od okrog leta 1310 upravno stala v Metliki, duhovni sedež pa je ostal v Črnomlju. Red je bil v deželi med najbogatejšimi — z zagrebškim kapitljom je stoletja vodil znano »desetinsko vojno« o cerkvene dajatve. Zakaj je podzemeljski župnik osemnajsto stoletje vodil vzporedni mrliški zvezek z imenom reda, običajnemu ob strani — ali so bile to pravice do dohodkov, ali štetje redovnih podložnikov — arhiv ne pove. Dve knjigi smrti sta se odpirali skupaj: ena v imenu župnije, ena v imenu reda, ki je bil na tem tleh doma že pol tisočletja.\n\nMuzej hrani ta zapis kot vabilo: kdor raziskuje gribeljske korenine — Totterje, Županiče, Štrucelje, Piškuriče — začne tu. Slika zapisa je prva razprostrta stran te iste knjige: krstna knjiga 1675–1703, objavljena v prostem dostopu — matice, v katerih Griblje išče svoje rodbine, niso več le vrata, ampak tudi pogled.",
    storyEn:
      "Every village keeps two memories: the living one carried by people, and the paper one carried by the parish. For Griblje the paper memory is held by the hill of St. Vitus and the parish office at Podzemelj: the church in Griblje has always been a filial (Filialkirche) of the Podzemelj parish, whose patron is St. Martin — and whatever was born, married or died in the village was written into the Podzemelj registers.\n\nThese books are among the oldest continuous records of this land: they reach to the year 1669, when the world was only just settling after the Thirty Years' War, and they close in 1947, when state registries took over the task. Twenty-two books — of baptisms, marriages and burials — have been digitised, and the Archdiocesan Archives of Ljubljana publish them in free access on the Matricula Online portal. For Griblje people in Cleveland, Buenos Aires or the United States this means something no century could offer: the family tree of the home house can be leafed through without a journey.\n\nParish registers are more than names and dates. The godparents entered at every baptism are a map of the village's social web: who stood by whom at the font, at the wedding, at the bedside. From the entries one can glean when a family moved in or emigrated, when misfortune mowed, when the years were plentiful. Historians read in such books the demography of a whole region; for local people they are the place where a grandmother becomes a girl once more.\n\nAmong the twenty-two books one hides an unusual label: the burial register of 1728–1803 carries the name of the Teutonic Order in the archival catalogue. The knights of that order came into Bela krajina in 1236, replacing the Templars; in 1268 they received from Duke Ulrik III of Carniola the parish of Črnomelj with all its filials and estates — from about 1310 their komenda stood administratively at Metlika, while the spiritual seat remained in Črnomelj. The order was among the richest of the land — for centuries it fought the famed »tithe war« with the Zagreb chapter over church dues. Why the Podzemelj priest kept a parallel burial register under the order's name through the eighteenth century, beside the ordinary one — whether rights to incomes, or a counting of the order's subjects — the archive does not say. Two books of death opened together: one in the parish's name, one in the name of an order that had been at home in this ground for half a millennium.\n\nThe museum keeps this record as an invitation: whoever traces Griblje roots — the Totters, the Županičes, the Štruceljs, the Piškuričes — begins here. The record's image is the first opened page of this very book: the baptismal register of 1675–1703, published in free access — the registers in which Griblje seeks its families are no longer only a gate, but also a view.",
    evidenceStatus: "DOCUMENTED",
    yearFrom: 1669,
    yearTo: 1947,
    image: "/images/authentic/matica-podzemelj-1669.jpg",
    imageCredit:
      "Krstna knjiga župnije Podzemelj, 1675–1703 (prve strani) · Nadškofijski arhiv Ljubljana · Matricula Online — knjiga, v katero so se zapisovali tudi Gribeljci",

    addedAt: "2026-09-16",
    sources: [
      {
        key: "matricula-vitesi-mrlisce",
        nameSi: "Matricula Online — mrliška knjiga župnije Podzemelj 1728–1803 (signatura 01733; v katalogu označena kot Nemški viteški red)",
        nameEn: "Matricula Online — the burial register of the Podzemelj parish 1728–1803 (shelfmark 01733; catalogued under the Teutonic Order)",
        sourceType: "fotografija",
        license: "Nadškofijski arhiv Ljubljana · prosti dostop",
        url: "https://data.matricula-online.eu/en/slovenia/ljubljana/podzemelj/01733/",
        noteSi: "Vzporedni mrliški zvezek, ki ga arhiv vodi pod imenom Nemškega viteškega reda: najtišji pisni sled redovniških pravic v župniji, iz katere so se pisale tudi gribeljske smrti.",
        noteEn: "A parallel burial volume the archive files under the Teutonic Order's name: the faintest written trace of order rights in the parish into which Griblje's deaths were also written.",
      },
      {
        key: "wiki-tevtonski-red",
        nameSi: "Wikipedija: Tevtonski viteški red (Bela krajina — 1236, Župnija Črnomelj 1268, komenda Metlika ~1310, desetinska vojna)",
        nameEn: "Wikipedia: Teutonic Order (Bela krajina — 1236, the parish of Črnomelj 1268, the Metlika komenda ~1310, the tithe war)",
        sourceType: "spletni-vir",
        license: "CC BY-SA 4.0",
        url: "https://sl.wikipedia.org/wiki/Tevtonski_vite%C5%A1ki_red",
        noteSi: "Zgodovina reda v Beli krajini: nadomestitev templjarjev 1236, darovnica vojvode Ulrika III. 1268, komenda v Metliki, desetinska vojna z zagrebškim kapitljem.",
        noteEn: "The order's history in Bela krajina: replacing the Templars in 1236, Duke Ulrik III's grant of 1268, the Metlika komenda, the tithe war with the Zagreb chapter.",
      },
      {
        key: "matricula-podzemelj-knjiga",
        nameSi: "Matricula Online — krstna knjiga župnije Podzemelj 1675–1703 (prve strani; glavna slika zapisa)",
        nameEn: "Matricula Online — the baptismal register of the Podzemelj parish 1675–1703 (first pages; the record's main image)",
        sourceType: "fotografija",
        license: "Nadškofijski arhiv Ljubljana · prosti dostop",
        url: "https://data.matricula-online.eu/en/slovenia/ljubljana/podzemelj/01723/",
        noteSi: "Najstarejša knjiga zapisa: posnetek prvih strani krstne knjige, v katero so se zapisovali rojstvi vasi — namesto prejšnje ilustrativne knjige druge župnije.",
        noteEn: "The record's oldest book: a scan of the first pages of the baptismal register into which the village's births were written — replacing the earlier illustrative book of another parish.",
      },
      {
        key: "commons-matice-knjiga-prej",
        nameSi: "Wikimedia Commons: krstna knjiga župnije Mošnje 1610–1730 (prejšnja ilustrativna slika zapisa)",
        nameEn: "Wikimedia Commons: the baptismal register of the parish of Mošnje 1610–1730 (the record's earlier illustrative image)",
        sourceType: "fotografija",
        license: "Public domain",
        url: WM("Krstna_knjiga_%C5%BEupnije_Mo%C5%A1nje_1610-1730.jpg"),
        noteSi: "Primer rokopisne slovenske matične knjige iz istega stoletja; z odprtjem Matricule jo je zamenjal posnetek prave podzemeljske knjige.",
        noteEn: "An example of a manuscript Slovene parish register of the same century; with Matricula opened, it was replaced by a scan of the actual Podzemelj book.",
      },
      {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "odeon-pasuljada-2026",
        nameSi: "Radio Odeon — Dan, ko je ob Kolpi zadišalo po pasulju (23. avgust 2026)",
        nameEn: "Radio Odeon — The day the Kolpa smelled of bean stew (23 August 2026)",
        sourceType: "objava",
        license: "navedi vir / cite the source",
        url: "https://www.radio-odeon.com/novice/dan-ko-je-ob-kolpi-zadisalo-po-pasulju/",
        noteSi:
          "Izvedba 2026: 13 ekip, zmagovalci Torpedovci, 2. Jo&Jo, 3. Folex, 4. Pasuljčice (– 0,5 točke do odra); komisija Vlašič/Štefanič/Grdešič, vodil Povše; sponzorji Status, Kapušin, Krone Kolpa Heaven.",
        noteEn:
          "The 2026 edition: 13 teams, winners the Torpedovci, 2nd Jo&Jo, 3rd Folex, 4th the Pasuljčice (0.5 points short of the stage); jury Vlašič/Štefanič/Grdešič, hosted by Povše; sponsors Status, Kapušin, Krone Kolpa Heaven.",
      },
      {
        key: "dl-pasuljada-21",
        nameSi: "Dolenjski list — Dober pasulj ni »preprost kot pasulj«, iz kotlička boljši kot iz plastike (avgust 2026)",
        nameEn: "Dolenjski list — A good pasulj is not 'simple as pasulj', from the cauldron it beats plastic (August 2026)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/21-kuharsko-tekmovanje-preprosto-kot-pasulj-pasuljada-tg-griblje-rudi-vlasic-1923027",
        noteSi: "21. tekmovanje po redu; predzadnja avgustovska sobota na kopališču ob Kolpi; 13 ekip, zmagali domačini (Torpedovci); podnaslovi TD Griblje in zmagovalne ekipe.",
        noteEn: "The 21st contest in a row; the second-to-last August Saturday at the bathing place on the Kolpa; 13 teams, the locals won (Torpedovci); captions of TD Griblje and the winning teams.",
      },
      {
        key: "odeon-pasuljada",
      ...
      {
        key: "vk-pasulj-2019",
        nameSi: "Vaš Kanal (YouTube) — V Gribljah kuhali pasulj (video, 5. 8. 2019)",
        nameEn: "Vaš Kanal (YouTube) — They cooked pasulj in Griblje (video, 5 Aug 2019)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.youtube.com/watch?v=28NGiJsNzkk",
        noteSi:
  ...
  },
  {
    ...
    storySi:
      "Dr. Franc Brinc je gribeljsko šolo obiskoval med letoma 1941 in 1945 — vojna mu je otroštvo postavila v tuj prostor, saj so italijanski vojaki zasedli šolsko poslopje in je pouk bežal v gasilski dom. Iz vasi ga je pot odnesla v pravo: postal je izredni profesor, njegovi področji pa penologija in kriminologija — znanosti o kazni in o tem, zakaj ljudje padajo. Vrnil se je z nenavadnim orodjem pravnika: z darilom.\n\nZadnja leta so njegova darovanja postala gospodarska zgodba vasi. Prostovoljnemu gasilskemu društvu je namenil 35.000 evrov — od tega 30.000 v zadnjih štirih letih: uredili so operativno sobo, v celoti zamenjali streho in izolacijo gasilskega doma, ki ga je pred leti poškodovala toča. Poveljnik Matija Štrucelj je zapisal: »Brez tega ne bi zmogli. Dal nam je zagon in s tem prebudil društvo, ki je bilo v nekem trenutku v rahlem zatonu.« Podružnični šoli je namenil prav toliko — digitalna oprema, igrala, ekovrt in izleti, na katerih so gribeljski otroci prvič videli smučarske skoke v Planici; enak znesek je po besedah Dolenjskega lista prejel še vaški športni klub, največji posamezni delež — kar sto tisoč evrov — pa je bil namenjen delovanju krajevne skupnosti Griblje. Skupaj z darovi občini in cerkvi se vsota ustavi pri več kot 200.000 evrih.\n\nVas mu je vrnila s spominom, ne z denarjem. Ob prazniku krajevne skupnosti 15. septembra 2024 je 89-letni Brinc domačine nagovoril z življenjskimi spomini — in isti večer so v gasilskem domu odprli spominsko sobo dr. Franca Brinca. Desetega aprila 2026 — ob praznovanju 91. rojstnega dne, na katerega so se zbrali krajani, šolarji, gasilci in občinarji — so na pročelju šole odkrili spominsko ploščo z njegovim imenom; rojakom je poudaril, da svoje uspehe pripisuje trdemu delu, učenju in življenjski disciplini. Ob 500-letnici cerkve sv. Vida junija 2026 pa je njegova podpora skupaj z občino Črnomelj omogočila ureditev novega parkirišča ob cerkvi in poslovilne vežice.\n\nZgodba ima zabeležen začetek: za elektrifikacijo cerkvenih zvonov je daroval že v devetdesetih — Dolenjski list navaja leto 1998 in znesek, »takrat še v tolarjih«; starejši viri navajajo 18.900 evrov ob letu 1988, kar pa s sredstvom, imenovanim v evrih, ne more stati, saj je bila tedanja valuta dinar. Verjetnejše je torej leto 1998; dar pa ostaja prvi znani, s katerega se ceh začne šteti. Že kot gimnazijec v Črnomlju je hlastal domov: namesto z avtobusom je tekel od Črnomlja do Gribelj, samo da je bil prej doma. Občina bi mu za dobra dela rada podelila priznanja — a jih odklanja; zadnja zahvala vasi je bila 12. aprila 2025, ko so mu v družbi prebivalcev priredili 90. rojstni dan. Poleg dobrotnika pa zapis zasači še človeka: Marija, ljubezen iz študijskih dni, ga po besedah Dolenjskega lista spremlja že 65 let.\n\nMuzej zapis postavlja v vrsto z Županičem, Dragošem in Totterjevo: vsi so odnesli gribeljsko kri v svet — Brinc pa je prinesel svet nazaj v Griblje, v evrih, ki so postali streha, učilnica in spomin. Dobra duša vasi ni tista, ki največ ima, ampak tista, ki največ vrne. Ta zapis je muzejev način, da se tudi sam zahvali.\n\nPoklon je od zdaj zapisan tudi v gibljivi podobi: Vaš Kanal, »V Gribljah so se poklonili Francu Brincu« (v eter 17. aprila 2026) — vas je rodjaka na 91. rojstnem dnevu javno počastila, on pa se je ob svojem rojstnem dnevu znova izkazal z donacijo. Videodokument je drugi poročevalec istega dogodka, ki ga Dolenjski list zapiše s ploščo na pročelju šole; skupaj tvorita dvojni dokument najnovejšega priznanja vasi svojemu dobrotniku.\n\nObisk in vsakoletni dar pa sta zdaj dokumentirana tudi s strani šole: 8. oktobra 2021 je dr. Brinc stopil na prag podružnične šole — šole, ki jo je kot deček obiskoval v času 2. svetovne vojne. Ravnateljica Damjana Vraničar mu je v zahvalo izročila spominsko darilo; s soprogo si je ogledal učila in se za nekdanjimi šolskimi klopmi »stare učilnice« na podstrešju poskušal spomniti šole nekoč; obisk sta omogočila KS Griblje s predsednikom Tonijem Brincem in župan Andrej Kavšek, istega dne pa je trio — Toni Brinc, dr. Brinc in župan — s rezanjem traku odprl cestno razsvetljavo blizu šole. Decembra 2025 pa je ob novoletni prireditvi za starostnike, ki so jo pripravili učenci skupaj s prostovoljkami Rdečega križa, KS Griblje in občino, šoli »ob koncu leta znova podaril 5.000 evrov« — vodja podružnice Marjetka Žunič je zbranim starostnikom prenesla njegovo voščilo. Beseda »znova« je tu najpomembnejša: donacija ni enkratno dejanje, ampak letni koledar.",
    storyEn:
      "Dr. Franc Brinc attended the Griblje school between 1941 and 1945 — a wartime childhood in borrowed rooms, for Italian soldiers occupied the schoolhouse and lessons fled to the fire station. From the village the road carried him into law: he became an associate professor, his fields penology and criminology — the sciences of punishment and of why people fall. He returned with a lawyer's unusual instrument: a gift.\n\nIn recent years his donations have become the village's economic story. To the volunteer fire brigade he gave 35,000 euros — 30,000 of them in the last four years: the operational room was fitted out, the roof and insulation of the fire station — hail-damaged years before — wholly replaced. Commander Matija Štrucelj wrote: »Without this we could not have managed. He gave us momentum, and with it woke a society that was at one moment in a slight decline.« To the branch school he gave just as much — digital equipment, play equipment, a school garden and the excursions on which the Griblje children first saw the ski jumps at Planica; the village's sports club received an equal sum, according to Dolenjski list, and the largest single share — one hundred thousand euros — went to the operation of the Griblje local community. Together with the gifts to the municipality and the church, the sum stops at more than 200,000 euros.\n\nThe village repaid him with memory, not money. At the local community's celebration on 15 September 2024 the 89-year-old Brinc addressed his neighbours with the memories of a lifetime — and the same evening the memorial room of dr. Franc Brinc opened in the fire station. On 10 April 2026 — at the celebration of his 91st birthday, to which villagers, schoolchildren, firefighters and municipal officials gathered — a plaque bearing his name was unveiled on the school's facade; he told his fellow villagers that his successes rest on hard work, learning and life discipline. At the 500th anniversary of the church of St. Vitus in June 2026, his support together with the Municipality of Črnomelj made possible the new parking place by the church and the funeral vestibule.\n\nThe story has a recorded beginning: he gave for the electrification of the church bells already in the 1990s — Dolenjski list cites the year 1998 and the sum, »in tolars at the time«; older sources quote 18,900 euros at the year 1988, which cannot stand together with a sum named in euros, since the currency then was still the dinar. The likelier date is thus 1998; the gift remains the first known one from which the ledger starts counting. As a grammar-school boy in Črnomelj he raced home: instead of the bus he ran from Črnomelj to Griblje, only to be home sooner. The municipality would gladly have awarded him honours for his good deeds — he declines them; the village's last thank-you came on 12 April 2025, when his neighbours threw him his ninetieth birthday. Beside the benefactor, the record also catches the man: Marija, the love of his student days, has been at his side — by Dolenjski list's account — for 65 years.\n\nThe museum sets this record beside Županič, Dragoš and Totter: all carried Griblje blood out into the world — Brinc brought the world back to Griblje, in euros that became a roof, a classroom and a memory. A village's good soul is not the one who has the most, but the one who returns the most. This record is the museum's own way of saying thank you.\n\nThe tribute is now also recorded in moving images: Vaš Kanal, \"V Gribljah so se poklonili Francu Brincu\" (broadcast 17 April 2026) — the village publicly honoured its native son on his 91st birthday, and he once again distinguished himself with a donation on his birthday. The video is the second reporter of the same event that Dolenjski list records with the plaque on the school facade; together they form a double document of the village's newest tribute to its benefactor.\n\nThe visit and the yearly gift are now documented from the school's side too: on 8 October 2021 Dr Brinc stepped onto the doorstep of the branch school — the school he had attended as a boy during the Second World War. Headmistress Damjana Vraničar handed him a keepsake in gratitude; with his wife he looked at the teaching aids and sat at the former desks of the 'old classroom' in the attic, trying to recall the school of long ago; the visit was made possible by the Griblje local community with president Toni Brinc and mayor Andrej Kavšek, and the same day the trio — Toni Brinc, Dr Brinc and the mayor — opened the street lighting near the school by cutting the ribbon. And in December 2025, at the New Year event for the elderly prepared by the pupils together with the Red Cross volunteers, the local community and the municipality, he 'again donated 5,000 euros to the school at the end of the year' — branch head Marjetka Žunič conveyed his greetings to the gathered elders. The word 'again' is the most important one here: the donation is not a one-off act but a yearly calendar.",
    evidenceStatus: "DOCUMENTED",
    yearFrom: 1941,
    addedAt: "2026-09-16",
    ...
    sources: [
      ...
      {
        key: "dl-brinc-91",
        nameSi: "Dolenjski list — Griblje slavile 91 let dobrotnika dr. Brinca, kraju podaril 200.000 evrov (maj 2026)",
        nameEn: "Dolenjski list — Griblje honoured their 91-year-old benefactor dr. Brinc, who gave the village 200,000 euros (May 2026)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/spominska-plosca-griblje-doktor-franc-brinc-1894366",
        noteSi: "91. rojstni dan + plošča na šoli; razčlenitev darov: šola 30.000, športno društvo 30.000, PGD 35.000, KS 100.000; elektrifikacija zvonov 1998 (v tolarjih — korekcija letnice 1988, ki z evri ne more stati); obnova cerkvene strehe; Marjetka Žunič nagovorila; Marija, ljubezen iz študijskih dni, že 65 let.",
        noteEn: "The 91st birthday + the plaque on the school; the breakdown: school 30,000, sports club 30,000, fire brigade 35,000, KS 100,000; the bells electrified in 1998 (in tolars — correcting the 1988 date, impossible with euros); the church roof; Marjetka Žunič addressed the guests; Marija, his love from student days, beside him for 65 years.",
      },
      {
        key: "vk-brinc-poklon-2026",
        nameSi: "Vaš Kanal (YouTube) — V Gribljah so se poklonili Francu Brincu (video, v eter 17. 4. 2026)",
        nameEn: "Vaš Kanal (YouTube) — Griblje paid tribute to Franc Brinc (video, broadcast 17 Apr 2026)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.youtube.com/watch?v=mtkw2lEQVrc",
        noteSi:
          "Videodokument poklona ob 91. rojstnem dnevu — drugi poročevalec istega dogodka kot dl-brinc-91 (91. rojstni dan + plošča na šoli + nova donacija); datum etera po programski napovedi radio.brezice.eu (17. 4. 2026); vsebina po naslovu in iskalnem opisu kanala.",
        noteEn:
          "A video document of the tribute on the 91st birthday — the second reporter of the same event as dl-brinc-91 (the 91st birthday + the plaque on the school + a new donation); the broadcast date per the radio.brezice.eu programme listing (17 Apr 2026); the content per the channel's title and search description.",
      },
      {
        key: "osloka-brinc-2021",
        nameSi:
        ...
        url: "https://www.os-loka-crnomelj.si/obiskal-nas-je-dr-franc-brinc/",
        noteSi:
          "Obisk 8. 10. 2021: dobrodošlica ravnateljice Damjane Vraničar, ogled učil in »stare učilnice« na podstrešju (sede za starimi klopmi — pouk obiskoval v času 2. svetovne vojne); organizacija KS Griblje s predsednikom Tonijem Brincem, prisoten župan Andrej Kavšek; slavnostno odprtje cestne razsvetljave blizu šole (trak: Toni Brinc, dr. Brinc, župan).",
        noteEn:
          "A visit of 8 Oct 2021: the welcome by headmistress Damjana Vraničar, a tour of the teaching aids and the 'old classroom' in the attic (sat at the old desks — he attended lessons during WWII); organised by the Griblje local community with president Toni Brinc, mayor Andrej Kavšek present; the ceremonial opening of the street lighting near the school (ribbon: Toni Brinc, Dr Brinc, the mayor).",
      },
      {
        key: "odeon-novoletna-2025",
        nameSi:
        ...
        url: "https://www.radio-odeon.com/novice/novoletna-prireditev-za-starostnike-v-gribeljski-podruznici/",
        noteSi:
          "Prireditev za starejše krajane v sodelovanju prostovoljk Krajevne organizacije Rdečega križa, KS Griblje in Občine Črnomelj: dramska igra, glasba, petje, ples; vodja podružnice Marjetka Žunič je prenesla voščilo krajana Franca Brinca, ki je »ob koncu leta šoli ponovno podaril 5.000 evrov«; darila starostnikom: šolski domači čaj in voščilnica.",
        noteEn:
          "An event for elderly villagers with the volunteers of the Red Cross local organisation, the Griblje local community and the Municipality of Črnomelj: a drama play, music, singing, dancing; branch head Marjetka Žunič conveyed the greetings of villager Franc Brinc, who 'again donated 5,000 euros to the school at the end of the year'; gifts for the elderly: the school's home-made tea and a greeting card.",
      },
    ],
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        license: "navedi vir / cite the source",
        noteSi:
          "Primarni objavljeni vir; polno besedilo z uvodom je zdaj dostopno v prepisu na predstavitveni strani vasi (vir sopek-uvod-polno-besedilo). Muzej še išče izvod zvezka za natančne navedbe strani.",
        noteEn:
          "The primary published source; the full text with its foreword is now available in transcription on the village's presentation site (source sopek-uvod-polno-besedilo). The museum still seeks a copy of the volume for exact page references.",
      },
      {
        key: "sopek-uvod-polno-besedilo",
        nameSi: "Vas Griblje — predstavitvena stran: Šopek poljskih cvetlic iz Gribelj (polno prepisano besedilo: uvod, pesmi, belokranjski slovar)",
        nameEn: "The village of Griblje — presentation site: A Bouquet of Meadow Flowers from Griblje (full transcribed text: foreword, songs, the Bela krajina glossary)",
        sourceType: "spletni-vir",
        license: "navedi vir / cite the source",
        url: "https://griblje.netlify.app",
        noteSi: "Polno prepisano besedilo Šopeka: opis vasi (»velika vas ob Kolpi, ki šteje 110 domov«, Poljci, adlešička župnija), spomin na 1524 (»ni ostal niti eden plug«), prišverki rodbin, vsebina zbirke (60 pesmi, 161 pregovorov, 64 vraž in šeg) ter belokranjski slovar.",
        noteEn: "The full transcribed text of the Bouquet: the village description (\"a great village on the Kolpa counting 110 houses\", the Poljci, the Adlešiči parish), the memory of 1524 (\"not a single plough remained\"), the family house names, the collection's contents (60 songs, 161 proverbs, 64 beliefs and customs) and the Bela krajina glossary.",
      },
      {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "ssm-letno-porocilo-ucilnica",
        nameSi: "Slovenski šolski muzej — Letno poročilo Javnega zavoda: odprtje muzejske učilnice na POŠ Griblje",
        nameEn: "Slovenian School Museum — Annual report of the public institute: the opening of the museum classroom at the Griblje branch school",
        sourceType: "objava",
        license: "javno poročilo zavoda",
        url: "https://muzejsporta.si/",
        noteSi:
          "Poročilo SŠM o odprtju muzejske učilnice na POŠ Griblje z nagovorom mag. Marjetke Balkovec Debevec; poročilo navaja datum 2. junij 2022, Svet24 in ta zapis 26. junij 2022 — točen datum čaka potrditev (muzej išče uradni dokument).",
        noteEn:
          "The School Museum's report on the opening of the museum classroom at the Griblje branch school, with the address by mag. Marjetka Balkovec Debevec; the report dates it 2 June 2022, Svet24 and this record 26 June 2022 — the exact date awaits confirmation (the museum seeks the official document).",
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        key: "odeon-kavbojski-zur-2026",
        nameSi:
          "Radio Odeon (6. 7. 2026): Bilo je kot na Divjem zahodu — kavbojski žur v Gribljih tretjič",
        nameEn:
          "Radio Odeon (6 Jul 2026): It was like the Wild West — the cowboy ball in Griblje for the third time",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/bilo-je-kot-na-divjem-zahodu/",
        noteSi:
          "Tretja izvedba (julij 2026): odprtje najmlajših kavbojcev in kavbojk, plesne skupine, jahanje mehanskega bika, začasni tatuoji; pozdrav predsednice KS Griblje Romane Husič, priznanji predsednice TD Griblje Mateje Pezdirc za Katjo Lavrič (organizacija) in Bojano Brodarič (prvi plesni koraki najmlajših); povezovala Katarina Podržaj, glasba Rene Fajt Muzik in DJ Sherif; vir: TD Griblje, foto: Nikola Rahija.",
        noteEn:
          "The third edition (July 2026): the opening by the youngest cowboys and cowgirls, dance groups, mechanical bull riding, temporary tattoos; a greeting by Griblje community president Romana Husič, awards by tourist-society president Mateja Pezdirc to Katja Lavrič (organisation) and Bojana Brodarič (the youngest dancers' first steps); hosted by Katarina Podržaj, music by Rene Fajt Muzik and DJ Sherif; source: TD Griblje, photo: Nikola Rahija.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "dl-strucelj-80",
        nameSi: "Dolenjski list — S pesmijo je delo lažje steklo, včasih do mraka, a vedno skupaj: Alojz Štrucelj, 80 let (2026)",
        nameEn: "Dolenjski list — With a song the work went easier, sometimes till dusk, but always together: Alojz Štrucelj at 80 (2026)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/alojz-strucelj-80-let-kmetija-podezelje-griblje-vrednote-delo-1920964",
        noteSi: "Izvirni intervju (Radio Odeon objavil po DL): kmetijo prevzel od očeta, pred ~20 leti jo predal sinu; košnja s koso, obračanje sena z vilami, ročna molža; »nekaj hektarjev in šest krav«; ostaja dejaven in pomaga pri vsakdanjih opravilih.",
        noteEn: "The original interview (Radio Odeon republished after DL): he took the farm from his father and handed it to his son ~20 years ago; mowing with a scythe, turning hay with forks, hand milking; 'a few hectares and six cows'; still active and helping with everyday chores.",
      },
      {
        key: "commons-kosec",
  ...
  },
  {
    ...
    sources: [
      {
        key: "odeon-kolpa-monitoring",
        nameSi: "Radio Odeon — Kolpa pod drobnogledom: čista reka je skupna odgovornost (1. julij 2026)",
        nameEn: "Radio Odeon — The Kolpa under the magnifying glass: a clean river is a shared responsibility (1 July 2026)",
        sourceType: "objava",
        license: "navedi vir / cite the source",
        url: "https://radio-odeon.com/nasveti/odkrijte-krajinski-park-kolpa-zaklad-narave-in-kulturne-dediscine/kolpa-pod-drobnogledom-cista-reka-je-skupna-odgovornost/",
        noteSi:
          "Državni monitoring kopalnih voda: sezona 15. 6.–31. 8., vzorčenje na 14 dni (ARSO + NLZOH Novo mesto), kazalnika E. coli in intestinalni enterokoki; merilno mesto »Kolpa, Dragoši – Griblje, rečni odbijač«.",
        noteEn:
          "The national bathing-water monitoring: season 15 June–31 Aug, sampling every 14 days (ARSO + NLZOH Novo mesto), indicators E. coli and intestinal enterococci; measuring point »Kolpa, Dragoši – Griblje, river deflector«.",
      },
      {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "dl-totter-2025",
        nameSi: "Dolenjski list (8. 2. 2025): Ljudje ob Kolpi — Matija Totter",
        nameEn: "Dolenjski list (8 Feb 2025): People by the Kolpa — Matija Totter",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/iskanje?q=Gribelj",
        noteSi: "Življenjepis Jandreč Matička v dolenjsko-listovni seriji (iskalni arhiv; polni tekst čaka na pridobitev).",
        noteEn: "The biography of Jandreč Matiček in the DL series (search archive; full text awaits retrieval).",
      },
      {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "commons-barle-portret",
        nameSi: "Wikimedia Commons: Janko Barle 1932 (portret)",
        nameEn: "Wikimedia Commons: Janko Barle 1932 (portrait)",
        sourceType: "fotografija",
        license: "javna last / public domain",
        url: WM("Janko_Barle_1932.jpg"),
        noteSi: "Glavna slika zapisa: Barlov portret iz leta 1932 — obraz, ki je Beli krajini zapisal rastline, pesmi in šege.",
        noteEn: "The record's main image: Barle's portrait of 1932 — the face that wrote down Bela krajina's plants, songs and customs.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "eheritage-kucar",
        nameSi: "eHeritage — register nepremične kulturne dediščine: Podzemelj, arheološko najdišče Kučar (EŠD 11118)",
        nameEn: "eHeritage — the register of immovable cultural heritage: Podzemelj, the Kučar archaeological site (EŠD 11118)",
        sourceType: "spletni-vir",
        license: "javna informacija / public information",
        url: "http://www.eheritage.si/",
        noteSi: "Uradni register nepremične kulturne dediščine: železnodobno gradišče z gomilnimi grobišči (sv. Helena, Brodaričeva loza, Steljniki) in planimi grobišči — EŠD 11118.",
        noteEn: "The official register of immovable cultural heritage: the Iron Age hillfort with barrow cemeteries (sv. Helena, Brodaričeva loza, Steljniki) and flat graves — EŠD 11118.",
      },
      {
  ...
  },
  {
    ...
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/joze-dular-portret.jpg",
    imageCredit:
      "Jože Dular · fotografija: Miran Vesel · Wikimedia Commons · javna last — portret muzealca, pesnika in varuha belokranjskega spomina",
    yearFrom: 1915,
    yearTo: 2000,
    featured: false,
    sources: [
      ...
      {
        key: "commons-dular-portret",
        nameSi: "Wikimedia Commons: Jože Dular (portret, fotograf: Miran Vesel)",
        nameEn: "Wikimedia Commons: Jože Dular (portrait, photographer: Miran Vesel)",
        sourceType: "fotografija",
        license: "javna last / public domain",
        url: WM("Jo%C5%BEe_Dular_(1).jpg"),
        noteSi: "Glavna slika zapisa: Dularjev portret — obraz muzealca, ki je trideset let hranil belokranjski spomin.",
        noteEn: "The record's main image: Dular's portrait — the face of the museum man who kept the Bela krajina memory for thirty years.",
      },
      {
        ...
        noteSi: "Muzej, ki ga je Dular vodil od 1951 — prostor, kjer belokranjski spomin živi.",
        noteEn: "The museum Dular led from 1951 — the room where the Bela krajina memory lives.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    periodSi: "16. junij 2019",
    periodEn: "16 June 2019",
    summarySi:
  ...
  },
  {
    ...
    storySi:
      "Petnajstega septembra 2024 se je v gasilskem domu zbrala vas — na praznik krajevne skupnosti Griblje, prvem po desetletjih. Uvodoma je krajane nagovorila predsednica KS Romana Husič: spomin na zgodovinske dogodke je na kratko strnila, zahvalila se bivšim predsednikom krajevne skupnosti in krajantom ter izpostavila načrte za prihodnost. Praznik spominja na dogodke septembra 1941, ko je na cesti od Gribelj proti Črnomlju prišlo do napada na italijanske mejne policiste — na tem mestu stoji obeležje, delo kiparja Jakoba Savinška (zapis zaseda-1941), vas pa se je takrat znašla v vrtincu okupacije in odporništva.\n\nPraznik je izrazil hvaležnost svojemu dobrotniku. Nagovor dr. Franca Brinca — 89-letnega nekdanjega šolarja gribeljske šole, pravnika, penologa in dobrotnika vasi, ki je iskrivo povedal življenjske spomine — je obdala vrsta zahvalnih nagovorov: večkratne finančne podpore so mu zahvalili predsednik gasilskega društva Dario Piškurič, v imenu športnega društva Rok Pezdirc in vodja podružnične šole Branka Weiss; zbrane je nagovoril še župan Andrej Kavšek, ki je izpostavil veličino in dobrodelnost Franca Brinca. Program je povezoval Niko Štrucelj; obogatili so ga nepogrešljivi učenci podružnične šole Griblje, kitaristka in pevka Nina Novak pa je spremljala prebrane spomine iz Brinčevega življenja. Kdor je poslušal moža, ki se je kot otrok igral po dvoriščih te vasi in kot znanstvenik razmišljal o kaznovanju po svetu, je slišal stoletje v enem glasu.\n\nOb prazniku je bila tudi slovesno odprta spominska soba dr. Franca Brinca v prostorih gasilskega doma — z njeno ureditvijo se mu je Krajevna skupnost zahvalila; prostor hrani zgodbo moža, ki je vasi namenil okoli 200.000 evrov darov: operativno sobo in streho gasilcev, digitalno opremo in igrala šoli, parkirišče ob cerkvi sv. Vida ob 500-letnici. Praznik, ki se je rodil iz spomina na vojno, je tako zaživel tudi kot praznik dobrote.\n\nZa muzej je ta zapis pomemben dvojno: kot dokaz, da si vas svojega praznika zna znova izmisliti, in kot zapis trenutka, ko se je rodila tradicija, ki se bo — upajmo — štela naprej. Štela se je: septembra 2025 je praznik KS doživel drugo izdajo, ob kateri so krajevne skupnostnice in skupnostniki predstavili tudi bilanco — v obdobju 2024/2025 so v sanacije cest na šestih lokacijah vlagali 39.000 evrov. Muzej išče fotografije s praznikov 2024 in 2025 ter popis vsebine spominske sobe: vsak predmet v njej je zapis, ki čaka.",
    storyEn:
      "On the fifteenth of September 2024 the village gathered in the fire station hall — for the festival of the Griblje local community, the first in decades. The villagers were welcomed by the KS president Romana Husič: she briefly recalled the historical events, thanked the community's former presidents and the villagers, and set out the plans for the future. The festival remembers the events of September 1941, when an attack on the Italian border police took place on the road from Griblje towards Črnomelj — the spot is marked by a memorial, the work of the sculptor Jakob Savinšek (see the record zaseda-1941), when the village found itself in the whirl of occupation and resistance.\n\nThe festival also expressed its gratitude to its benefactor. The address of dr. Franc Brinc — the 89-year-old former pupil of the Griblje school, lawyer, penologist and benefactor of the village, who told his life memories with evident warmth — was framed by a series of thanking speeches: his repeated financial support was acknowledged by the fire brigade president Dario Piškurič, by Rok Pezdirc on behalf of the sports club, and by Branka Weiss, head of the branch school; mayor Andrej Kavšek also addressed the gathering, highlighting the greatness and generosity of Franc Brinc. The programme was hosted by Niko Štrucelj; it was enriched by the indispensable pupils of the Griblje branch school, while the guitarist and singer Nina Novak accompanied the readings from Brinc's life memories. Whoever listened to a man who had played as a child in this village's yards and pondered punishment as a scholar across the world, heard a century in one voice.\n\nThe festival also saw the ceremonial opening of the dr. Franc Brinc memorial room in the fire station hall — the local community's way of thanking him; the space keeps the story of the man who gave the village some 200,000 euros in gifts: the fire brigade's operations room and roof, the school's digital equipment and playground, the car park by the church of St. Vitus at the 500th anniversary. A festival born of the memory of war thus came alive as a festival of generosity too.\n\nFor the museum this record matters doubly: as proof that a village knows how to invent its festival again, and as a record of the moment a tradition was born that will — we hope — keep counting. And count it did: in September 2025 the KS festival saw its second edition, at which the local community also presented its balance sheet — in 2024/2025 it invested €39,000 in the thorough repair of roads at six locations. The museum seeks photographs of the 2024 and 2025 festivals and an inventory of the memorial room: every object in it is a record waiting.",
    evidenceStatus: "DOCUMENTED",
    ...
    sources: [
      ...
      {
        key: "crnomelj-ks-griblje-svet",
        nameSi: "Občina Črnomelj — Krajevna skupnost Griblje (uradna stran: svet KS)",
        nameEn: "Municipality of Črnomelj — the Griblje Local Community (official page)",
        sourceType: "spletni-vir",
        license: "uradna objava",
        url: "https://www.crnomelj.si/sl/o-obcini/krajevne-skupnosti/2021122908394017/griblje/",
        noteSi: "Uradno stanje sveta KS: predsednica Romana Husič; člani Toni Brinc, Katja Jakofčič, Dario Piškurič, Boris Brodarič; naselja Cerkvišče in Griblje; na strani tudi objava o asfaltiranju (21. 8. 2025).",
        noteEn: "The official state of the KS council: president Romana Husič; members Toni Brinc, Katja Jakofčič, Dario Piškurič and Boris Brodarič; the settlements of Cerkvišče and Griblje; the page also carries the road-asphalt post (21 Aug 2025).",
      },
    ],
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        url: "https://www.radio-odeon.com/novice/ljudje-ob-kolpi-franc-derganc-2/",
        noteSi:
          "Epizoda o kirurgu in literatu iz Semiča; za gribeljski zapis ključna stranko ugotovitev: »leta 1901 sta skupaj z Nikom Zupaničem iz belokranjskih Gribelj izdajala kulturno-politično revijo Jug« — pričevanje serije o lastni vlogi v zgodbi vasi.",
        noteEn:
          "An episode on the surgeon and man of letters from Semič; for the Griblje record the side remark is key: 'in 1901, together with Niko Zupanič from the Bela krajina Griblje, he published the cultural-political journal Jug' — the series' own testimony of its role in the village's story.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "sem-f0000838",
        nameSi: "Slovenski etnografski muzej — Zbirka starih fotografij: F0000838, ženska vsakdanja kmečka noša iz Gribelj (~1920)",
        nameEn: "Slovene Ethnographic Museum — Collection of old photographs: F0000838, the women's everyday farm costume of Griblje (c. 1920)",
        sourceType: "fotografija",
        license: "avtorske pravice SEM (ZASP) — uporaba dokumentarnega gradiva po dogovoru",
        url: "https://www.etno-muzej.si/sl/digitalne-zbirke/zbirka-starih-fotografij/f0000838",
        noteSi:
          "Opis SEM: »Ženska vsakdanja kmečka noša, kakršno so nosile v Gribljih in okolici za vsak dan, ob hladnejših dneh še na prehodu v 20. stoletje. Verjetno fotografiral Niko Županič.«; klasifikacija: Ovčereja / Vsakdanja noša; datum SEM 1. 1. 1920 (okvirno); avtorstvo Županiču SEM pripisuje z »verjetno« — atribucija ni dokončna; pravice SEM (kontakt miha.spicek@etno-muzej.si).",
        noteEn:
          "The SEM caption: \"The women's everyday farm costume, worn in Griblje and its surroundings for every day, in colder days still at the turn of the 20th century. Probably photographed by Niko Županič.\"; classification: Sheep herding / Everyday costume; the SEM date 1 Jan 1920 (approximate); the SEM attributes authorship to Županič with \"probably\" — the attribution is not final; rights SEM (contact miha.spicek@etno-muzej.si).",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "odeon-zbul-preobleka-2026",
        nameSi:
          "Radio Odeon (21. 9. 2026): Gribeljski žbul v novi preobleki: od mafinov do sladoleda",
        nameEn:
          "Radio Odeon (21 Sep 2026): The Griblje žbul in a new dress: from muffins to ice cream",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/gribeljski-zbul-v-novi-preobleki-od-mafinov-do-sladoleda/",
        noteSi:
          "Dnevi zeliščarstva v Beli krajini (vir: LU Črnomelj): žbul je po poročilu vpisan v sortno listo kot avtohtona tradicionalna sorta — »gribeljski žbul ali belokranjka«, slamnata barva, podolgovate čebulice, oster okus, odporen na plesni in čebulno muho, trpežen v skladiščenju, redko uhaja v cvet; podmladek DKŽ Griblje: žbulovi mafini, grisine, mini pogačice, kruhki z namazom, slane košarice z žbulovo kremo in sladoled iz gribeljskega žbula; sodelovanje z Ljudsko univerzo Črnomelj.",
        noteEn:
          "The Days of Herbalism in Bela krajina (source: LU Črnomelj): according to the report the žbul is entered in the variety list as an autochthonous traditional variety — 'the Griblje žbul or belokranjka', straw-coloured, with elongated bulbs, a sharp taste, resistant to mould and onion fly, hardy in storage and rarely bolting; the young branch of the Griblje Farm Women's Society offered žbul muffins, grissini, mini flatbreads, bread rolls with spread, savoury baskets with žbul cream and even ice cream made of the Griblje žbul; cooperation with the Ljudska univerza Črnomelj.",
      },
      {
        key: "odeon-srecanje-dkz-2026",
        nameSi:
          "Radio Odeon (20. 6. 2026): Srečanje društev kmečkih žena Bele krajine, Kočevja in Lukovdola — članice iz Gribelj so govorile o žbulu",
        nameEn:
          "Radio Odeon (20 Jun 2026): The meeting of the farm women's societies of Bela krajina, Kočevje and Lukovdol — the Griblje members spoke about the žbul",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/srecanje-drustev-kmeckih-zena-bele-krajine-kocevja-in-lukovdola/",
        noteSi:
          "Že tradicionalno srečanje treh regij; poročilo z poti v Kočevje: rudniško jezero, baročna cerkev sv. Jerneja (župnik »naš rojak« Branko Jurejevčič), gostišče Tušek; »članice iz Gribelj so govorile o žbulu«.",
        noteEn:
          "The already traditional meeting of the three regions; a report from the trip to Kočevje: the mining lake, the baroque church of St Bartholomew (the parish priest, 'our fellow villager' Branko Jurejevčič), the Tušek inn; 'the members from Griblje spoke about the žbul'.",
      },
      {
        key: "odeon-zbul-erasmus-2026",
        nameSi:
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "dular-2001-vs39",
        nameSi: "Dular, A. (2001): Griblje in problem nižinskih arheoloških kompleksov v Sloveniji — Varstvo spomenikov 39, Ljubljana, str. 7–27",
        nameEn: "Dular, A. (2001): Griblje and the problem of lowland archaeological complexes in Slovenia — Varstvo spomenikov 39, Ljubljana, pp. 7–27",
        sourceType: "objava",
        license: "navedba vira",
        noteSi:
          "Temeljni strokovni članek o Gribljah kot problemu nižinskih arheoloških kompleksov; citiran v holocenskih vegetacijskih raziskavah Bele krajine.",
        noteEn:
      ...
      },
      {
        ...
        license: "navedba vira",
        noteSi:
          "Polenska zapisa Mlake in Gribelj: intenziven človeški vpliv na pokrajino okrog 4150 cal BC (krčenje gozda ob prihodu prvih kmetov).",
        noteEn:
          "The pollen records of Mlaka and Griblje: intensive human impact on the landscape around 4150 cal BC (forest clearance at the arrival of the first farmers).",
      },
      {
        key: "andric-2011-lateglacial",
        nameSi: "Andrič, M. (2011): Lateglacial vegetation at Lake Bled and Griblje marsh (Slovenia) — Opera Instituti Archaeologici Sloveniae 21, str. 235–249",
        nameEn: "Andrič, M. (2011): Lateglacial vegetation at Lake Bled and Griblje marsh (Slovenia) — Opera Instituti Archaeologici Sloveniae 21, pp. 235–249",
        sourceType: "objava",
        license: "navedba vira",
        noteSi:
          "Primerjava poznoglacialne vegetacije ledeniško zasličanega Blejskega jezera in Griblje marsh: Bela krajina v zadnji ledeni dobi ni bila poledenela.",
        noteEn:
          "A comparison of the Late Glacial vegetation of the glacier-fed Lake Bled and Griblje marsh: Bela krajina was not glaciated in the last Ice Age.",
      },
      {
        key: "arh-2012-tiran",
        nameSi: "ARHAT, Aleš Tiran s. p. (2012): Griblje – Ob Kolpi, dokumentiranje ob gradnji — zbornik Arheologija v letu 2012, vpis 109",
        nameEn: "ARHAT, Aleš Tiran s. p. (2012): Griblje – Ob Kolpi, documentation during construction — the yearbook Archaeology in 2012, entry 109",
        sourceType: "objava",
        license: "navedba vira",
        url: "https://arheologija.splet.arnes.si/arheologija-v-letu-2012/",
        noteSi:
          "Zbornik Arheologija v letu 2012 (vpis 109): »Griblje - Ob Kolpi dokumentiranje ob gradnji. ARHAT, arheološke raziskave, Aleš Tiran s.p.« — nadaljevanje dokumentacije najdišča EŠD 10094 ob gradnji (točno poročilo/stran TO_COLLECT).",
        noteEn:
          "The yearbook Archaeology in 2012 (entry 109): \"Griblje - Ob Kolpi, documentation during construction. ARHAT, archaeological research, Aleš Tiran s.p.\" — the continuation of documenting site EŠD 10094 during construction (exact report/page TO_COLLECT).",
      },
      {
        key: "zvkds-2023-cpa",
        nameSi: "ZVKDS, Center za preventivno arheologijo (2023): Griblje – Arheološko najdišče ob Kolpi (EŠD 10094), arheološke raziskave ob gradnji, št. projekta 23-0070 — zbornik Arheologija v letu 2023, str. 108",
        nameEn: "IPCHS Centre for Preventive Archaeology (2023): Griblje – the archaeological site by the Kolpa (EŠD 10094), investigations during construction, project no. 23-0070 — the yearbook Archaeology in 2023, p. 108",
        sourceType: "objava",
        license: "navedba vira",
        url: "https://www.arheologija.si/arheologija-v-letu-2023/",
        noteSi:
          "Zbornik Arheologija v letu 2023 (vpis, str. 108): najdišče 1-10094, »arheološke raziskave ob gradnji«, izvajalec ZVKDS Center za preventivno arheologijo, projekt 23-0070 — prva dokumentirana raziskava pri Gribljih po 2012 (podrobno poročilo TO_COLLECT).",
        noteEn:
          "The yearbook Archaeology in 2023 (entry, p. 108): site 1-10094, \"archaeological investigations during construction\", contractor IPCHS Centre for Preventive Archaeology, project 23-0070 — the first documented research near Griblje since 2012 (detailed report TO_COLLECT).",
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        key: "odeon-jurjevo-legenda-2017",
        nameSi:
          "Radio Odeon (24. 4. 2017): Došel je došel, Zeleni Jure! — legenda o brodarju na Kolpi",
        nameEn:
          "Radio Odeon (24 Apr 2017): Došel je došel, Zeleni Jure! — the legend of the ferryman on the Kolpa",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/dosel-je-dosel-zeleni-jure/",
        noteSi:
          "Legenda (vir: FS Zeleni Jurij): v Beli krajini jurjevo praznujemo 24. aprila, na Hrvaškem že dan prej — Zeleni Jurij je prijezdil do Kolpe, ker pa ni imel groša za plačilo brodarja, je moral dnino oddelati, zato je prišel »k nam šele dan pozneje«.",
        noteEn:
          "The legend (source: FS Zeleni Jurij): in Bela krajina Jurjevo is celebrated on 24 April, in Croatia a day earlier — Green George rode to the Kolpa, but having no coin to pay the ferryman he had to work off his debt, so he arrived 'a day late'.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    storySi:
      "Ko je jeseni 1890-tih Matija Totter-Jandreč zapisoval belokranjske šege, so ga pri Barletu in Županiču prosili prav za pastirje: kako praznujejo križevo. Zapisal je navade ob vnebohodu — prazniku, ki pade štirideset dni po veliki noči in po ljudskem koledarju odpre poletje: živina je šla na pašnike na vse leto, pastirji pa so ta dan praznovali kot svoj. Nekateri od teh običajev so v pozemeljski fari kmalu zatem ugasnili — ostali so le njegovi zapisi, ki jih hrani ta zbirka. Literatura zapis potrjuje: etnolog Andrej Dular, tedaj Belokranjski muzej v Metliki, je v Etnološki tribini (16/9, 1986) zapisal, da je Janko Barle pisal o ženitovanjskih običajih v Beli krajini, belokranjskih ljudskih pesmih in o pastirskem prazniku — križevem — v vasi Griblje.\n\nSto let pozneje se je praznik vrnil na obalo. TD Griblje in aktiv kmečkih žena so na vaškem kopališču obudili pastirske igre ob vnebohodu — s tekanjem, metom in smehom, ki so ga nekdaj poznali pastirji ob Kolpi. Vrnitev ima tudi svoj dokumentirani začetek: 28. maja 2017, na nedeljo po vnebohodu, je bilo ob 15. uri na kopališču Griblje praznovanje, ki ga je v koledarju prireditev napovedal Krajinski park Kolpa — pastirske igre, tekmovanje v košnji trave z ročno koso in pozno kosilo s »pohanimi šnicami«; skupaj so ga nosili turistično društvo, članice društva kmečkih žena in otroci podružnične šole, o obuditvi pa je poročal tudi vaški videoarhiv Vaš kanal. Z dogodkom se je obudila tudi stara vednost: jajca so, kakor v starih zapisih, spekli še pred sončnim vzhodom, ko coprnice, ki bi po verovanju molzle živino celo leto, še niso mogle; na ošiljeni brezi z izpihanimi lupinami na štrcljih je bilo »daleč naokoli videti«, koliko jajc je praznik prinesel. Po prepisu šeg, ki so jih obudili med praznikom, so sosednje vasi poznale tudi »kralja križev«, »lončeglojo« in »pepelmero« — prvega, predzadnjega in zadnjega pastirja, ki je tisto jutro prignal živino —, revnejšim družinam pa je po Šašlju (1906) za praznik včasih kupil vino in okrak kar celoten vaški sklad.\n\nIn leta 2026, štirideset dni po veliki noči, je Radio Odeon zapisal novo poglavje: pastirski dan ob Kolpi, ki sta ga priredili kolesarska sekcia Torpedo in Dragica Piškurič — s pečenimi jajci, igrami in vsemi generacijami na bregu.\n\nPastirsko leto ima svoj vrstni red, ki ga ta zbirka bere po koledarju: na jurjevo, 24. aprila, živina prvič gre na pašo in po vasi kroži Zeleni Jurij; na križevo pastirji slavijo svoj praznik; ob kresu počasti kres ogenj, ki varuje čredo. Med njimi tečejo reke, iz katerih se napajajo — in po katerih se, poleti, kopa cela vas.\n\nVrnitev iz leta 2017 ima dva poročevalca istega vikenda: dan po koledarskem zapisu Krajinskega parka je Dolenjski list (29. 5. 2017) opisal, kako se v Gribljah trudijo ohraniti tradicijo pastirskega praznika — med dvema ognjema in z nebesičenjem, z ročno košnjo, z izdelavo rogov iz lubja in lesenih piščali ter s pastirsko malico, pri kateri ni manjkalo cvrtje. Dva neodvisna zapisa istega vikenda so dala obuditvi krož: tradicija ni bila samo obnovljena — je bila opazovana.\n\nMuzej išče: fotografijo pastirskega dneva 2026, imena pastirjev, ki so nekdaj gnali čredo na obkolpske loke, in zapis Matičkovih beležk o križevem v izvirniku.\n\nPraznik ima tudi sodobni pričevalni vrst. Moja Dolenjska (30. 5. 2025) je vnebohodno križevo zapisala kot »najpomembnejši — ne pa edini pastirski praznik«, potrdila, da je šege že kot študent zapisal Janko Barle (1869–1941), in obudila domačo besedo za postarana neužitna jajca, ki jih z lubjem in drobtinicami kruha zakopljejo na tujo pašno pot: v Adlešičih jih imenujejo mučki. Dolenjski list pa dokazuje, da šega ni le papir: pastirski praznik je že 26. maja 2009 opisal na Starašiničevem pašniku pri Gribljih — med šegami, zapisanimi v 1890-tih, in križevim 2026 tako teče en sam, neprekinjen koledar.",
    storyEn:
      "When Matija Totter-Jandreč was writing down Bela krajina customs in the 1890s, Barle and Županič asked him above all about the shepherds: how they kept križevo. He recorded the ways of the Ascension — the feast that falls forty days after Easter and, by the folk calendar, opens the summer: the stock went to the pastures for the whole season, and the shepherds celebrated that day as their own. Some of these customs soon died out in the Podzemelj parish — only his notes remained, held in this collection. The literature corroborates the record: the ethnologist Andrej Dular, then of the Bela krajina Museum in Metlika, wrote in Etnološka tribina (16/9, 1986) that Janko Barle wrote about wedding customs in Bela krajina, about its folk songs, and about the shepherds' feast — the križevo — in the village of Griblje.\n\nA hundred years later the feast returned to the riverbank. The Griblje tourist society and the farm-women's group revived the shepherds' games at the village bathing place — with running, throwing and the laughter the shepherds once knew on the Kolpa. The return also has a documented beginning: on 28 May 2017, the Sunday after the Ascension, a feast was held at the Griblje pool at three in the afternoon, announced in the events calendar of the Kolpa Landscape Park — shepherds' games, a mowing contest with the hand scythe and a late meal of 'pohane šnite', fried bread slices; the tourist society, the farm women and the children of the branch school carried it together, and the village video archive Vaš kanal reported on the revival. With the day came back an old knowledge, too: the eggs were fried before sunrise, as in the old records — before the witches who would, by belief, milk the herds all year could touch them; on a sharpened birch with the blown shells hanging from its stubs one could see 'from far around' how many eggs the feast had brought. By the transcript of the customs retold at the feast, the neighbouring villages also knew the 'king of križevo', the 'lončegloja' and the 'pepelmera' — the first, the second-to-last and the last shepherd to lead the stock to pasture that morning — and by Šašelj (1906) it was sometimes the whole village fund that bought wine and a pork knuckle for the poorer families' shepherds.\n\nAnd in 2026, forty days after Easter, Radio Odeon recorded a new chapter: a shepherds' day by the Kolpa, organised by the Torpedo cycling section and Dragica Piškurič — with painted eggs, games, and every generation on the bank.\n\nThe shepherds' year has an order this collection reads by the calendar: at jurjevo, on 24 April, the stock first goes to graze and Green George walks the village; at križevo the shepherds keep their feast; at kres the fire that guards the flock is honoured. Between them run the rivers the flocks drink from — and in which, in summer, the whole village swims.\n\nThe 2017 revival has two reporters for the same weekend: a day after the National Park’s calendar entry, the Dolenjski list (29 May 2017) described how Griblje strives to keep the shepherds’ festival tradition alive — between two fires with ceremonial games, hand-mowing, the making of bark horns and wooden flutes, and a shepherd’s meal where fried food did not lack. Two independent accounts of one weekend closed the circle of the revival: the tradition was not only renewed — it was observed.\n\nThe museum seeks: a photograph of the 2026 shepherds' day, the names of the shepherds who once drove the flocks to the Kolpa meadows, and the original of Matiček's notes on križevo.\n\nThe festival has its modern line of witnesses, too. Moja Dolenjska (30 May 2025) recorded the Ascension križevo as »the most important — not the only shepherd festival«, confirmed that Janko Barle (1869–1941) first wrote the customs down as a student, and recalled the domestic word for the stale inedible eggs buried with bark and bread crumbs on the neighbours' droving path: in Adlešiči they call them mučki. And Dolenjski list proves the custom is no paper artefact: it described the shepherd festival on the Starašinič pasture by Griblje as early as 26 May 2009 — between the recorded customs of the 1890s and the križevo of 2026 runs one unbroken calendar.",
    evidenceStatus: "DOCUMENTED",
    ...
    sources: [
      ...
      {
        key: "md-krizevo-2025",
        nameSi: "Moja Dolenjska (30. 5. 2025): Križevo — najpomembnejši pastirski praznik",
        nameEn: "Moja Dolenjska (30 May 2025): Križevo — the most important shepherd festival",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://moja-dolenjska.si/krizevo-najpomembnejsi-pastirski-praznik/",
        noteSi: "Neodvisna potrditev ob Vnebohodu 2025: Barle kot študent-zapisovalec, Totter iz Gribelj kot njegov informator, adlešičski »mučki«; fotografije Boris Grabrijan.",
        noteEn: "An independent corroboration at Ascension 2025: Barle as the student-recorder, Totter of Griblje as his informant, the Adlešiči »mučki«; photographs by Boris Grabrijan.",
      },
      {
        key: "dl-pastirski-2009",
        nameSi: "Dolenjski list (26. 5. 2009): Pastirski praznik — Na Starašiničevem pašniku",
        nameEn: "Dolenjski list (26 May 2009): The shepherd festival — on the Starašinič pasture",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/iskanje?q=kri%C5%BEevo+Griblje",
        noteSi: "Dokumentirana izvedba pastirskega praznika pri Gribljih 2009 (iskalni arhiv DL; polni tekst čaka na pridobitev) — sredstvo med Barletovim zapisom in križevim danes.",
        noteEn: "A documented staging of the shepherd festival by Griblje in 2009 (DL search archive; full text awaits retrieval) — the link between Barle's record and today's križevo.",
      },
      {
        key: "dular-1986-etnoloska-tribina",
        nameSi: "Dular, A. (1986): Etnološka tribina 16(9) — o zapisih Janka Barleta (ženitovanjski običaji, ljudske pesmi, križevo v Gribljah)",
        nameEn: "Dular, A. (1986): Etnološka tribina 16(9) — on the records of Janko Barle (wedding customs, folk songs, the križevo in Griblje)",
        sourceType: "objava",
        license: "navedba vira (Hrčak)",
        url: "https://hrcak.srce.hr/etnoloska-tribina",
        noteSi:
          "Andrej Dular, tedaj Belokranjski muzej Metlika: Janko Barle je pisal o ženitovanjskih običajih v Beli krajini, belokranjskih ljudskih pesmih in o pastirskem prazniku (križih) v vasi Griblje.",
        noteEn:
          "Andrej Dular, then of the Bela krajina Museum in Metlika: Janko Barle wrote about wedding customs in Bela krajina, about its folk songs, and about the shepherds' feast (križevo) in the village of Griblje.",
      },
      {
        key: "np-kolpa-pastirski-2017",
        nameSi: "Krajinski park Kolpa · Naravni parki Slovenije (28. 5. 2017): Pastirski praznik v Gribljah — Kopališče Griblje, ob 15.00",
        nameEn: "Kolpa Landscape Park · Nature Parks of Slovenia (28 May 2017): The shepherds' feast at Griblje — the village pool, 3 pm",
        sourceType: "objava",
        license: "navedba vira (Naravni parki Slovenije)",
        url: "https://www.naravniparkislovenije.si/slo/prireditve/krajinski-park-kolpa/pastirski-praznik-v-gribljah-2017/68",
        noteSi: "Program: pastirske igre, tekmovanje v košnji trave z ročno koso, pozno kosilo — »pohane šnite«; TD Griblje »že nekaj let« ohranja tradicijo; sodelovanje članic DKZ Griblje in otrok podružnične šole; etnografija: biči in rogovi proti coprnicam (od Jurjevega), običaj najdlje ohranjen v Tribučah.",
        noteEn: "The programme: shepherds' games, a scythe-mowing contest, a late meal of 'pohane šnite'; the Griblje tourist society 'for some years' keeping the tradition; participation by the farm women of Griblje and the branch-school children; ethnography: whips and horns against witches (from St George's day), the custom surviving longest in Tribuče.",
      },
      {
        key: "odeon-krizevo-2019",
        nameSi: "Radio Odeon (31. 5. 2019): Križevo — star pastirski praznik (avtor: Boris Grabrijan, vir: KP Kolpa)",
        nameEn: "Radio Odeon (31 May 2019): Križevo — the old shepherds' feast (author: Boris Grabrijan, source: Kolpa Landscape Park)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/krizevo-star-pastirski-praznik/",
        noteSi: "Šege po Janku Barletu (»pred stotimi leti«): pred sončnim vzhodom izpihana in v masti spekta jajca; ošiljena breza z izpihanimi lupinami na štrcljih; Šašelj 1906 — revnejše družine kupile pastirju vino in okrak; Viničaki: »kralj križev«, »lončegloja«, »pepelmera«; namen — manj »zapaskov«; konec paše ob vseh svetih; pojedina ohranjena še v 70-ih letih 20. stoletja.",
        noteEn: "The customs by Janko Barle ('a hundred years ago'): eggs blown, beaten and fried in fat before sunrise; a sharpened birch with blown shells on its stubs; Šašelj 1906 — poorer families bought their shepherd wine and a pork knuckle; at Vinica the 'king of križevo', the 'lončegloja' and the 'pepelmera'; the purpose — fewer 'zapaski' (grazing damage); grazing ended at All Saints; the feast meal still kept in the 1970s.",
      },
      {
  ...
  },
  {
    ...
    summarySi:
      "Edini znani predmet, naslovljen na Griblje iz prvih let dvajsetega stoletja: razglednica, poslana 22. aprila 1903 iz Metlike gribeljski učiteljici, z duhovitim zavrtkom o železnici, ki se je gradila pol stoletja — in Gribljam obšla za šest kilometrov.",
    summaryEn:
  ...
  },
  {
    ...
    storySi:
      "Vsaka vas ima dva koledarja. Enega pišejo župani in društva z žigi; drugega ženske, ki speče kruh, naučijo pesem in spravita na oder vso energijo, ki je v vasi ostala po delu. V Gribljah ta drugi koledar nosi ime: Društvo kmečkih žena Griblje.\n\n\n\nDruštvo je v zapisih prvič zagrabljivo leta 1996, ko je skupaj z Zavodom za izobraževanje in kulturo Črnomelj izdalo knjižico o gribeljskem žbulu — pet gribeljskih žensk je zapisalo zgodovino pridelave čebule, po kateri je vas nekdaj slovela. Sledila je obnova: o žbulu so z odkrivanjem spomina naredile študijski krožek, iz katerega je leta 2012 zrasla nova knjižica — in gredica pred podružnično šolo, na katero učenci vsako pomlad posadijo pravi gribeljski žbul.\n\n\n\nNa Pleteršnikov dan pomladi se društvo pokaže v celoti. Na Pozdravu pomladi v gasilskem domu — prireditvi podružnične šole, krajevne skupnosti in društva — so ženske pripravile folklor, klarinet, pevski zbor in igrano predstavo, goste pa je pozdravil še ženski pevski zbor Viniške cür. Nato je prišel na vrsto kruh: tekmovalna peka domačega kruha, na kateri so razglasili najboljše tri.\n\n\n\nIste roke so obudile pastirske igre na vaškem kopališču in so vsako leto ob pasuljadi: Društvo kmečkih žena je na plakatu od prvega lonca.\n\n\n\nJavnega arhiva je društvo prvič dobilo leta 2016: 16. avgusta je Dolenjski list zapisal srečanje na vaškem igrišču ob dvajseti obletnici samostojnosti DKŽ Griblje — prvo javno potrditev letnice ustanovitve 1996. Na čelu društva je tedaj stala predsednica Anica Totter, program je vodila Ivanka Pezdirc (avtorica žbularske knjižice), med gosti so bile kmečke žene iz Adlešič, Črnomlja, Dragatuša in Metlike ter prijateljice iz Kočevja in Trebnjega, županja Mojca Čemas Stjepanovič pa je izrekla pozdrav v imenu občine. In, kakor je poročal list: »Seveda je bila v Gribljah glavna čebula oz. »žbul«« — koledar, ki ga pišejo roke, ima tudi svoj vrstni red čebul.\n\n\n\nJunija 2026 je žbul zdrsel čez meje regije: na že tradicionalnem srečanju društev kmečkih žena Bele krajine, Kočevja in Lukovdola so članice iz Gribelj govorile o žbulu — ista tema, ki je leta 2012 dobila knjižico, pa se je vrnila kot predavanje na medregijsko srečanje. Tisto poletje je zaživel še podmladek: mlajše članice so na Dnevih zeliščarstva v Beli krajini gribeljski žbul predstavile »v novi preobleki, od mafinov do sladoleda« — in pokazale, da društvo ne varuje samo receptov, ampak tudi voljo do izmišljanja naprej.\n\nMuzej išče: točen ustanovitveni dan, seznam predsednic pred in po letu 2016 (znana: Anica Totter) ter fotografije društva z njegovih začetkov — zgodovina, ki jo pišejo roke, si zasluži tudi svoj arhiv.",
    storyEn:
      "Every village has two calendars. One is written by mayors and stamped societies; the other by the women who bake the bread, teach the song, and bring to the stage all the energy the village has left after work. In Griblje this second calendar has a name: the Griblje Farm Women's Society.\n\nThe society first becomes graspable in the records in 1996, when together with the Črnomelj Institute for Education and Culture it published the booklet on the Griblje žbul — five Griblje women wrote the history of the onion-growing that once made the village famous. A revival followed: out of the memory of the žbul they made a study circle, from which a new booklet grew in 2012 — and the bed before the branch school, on which the pupils plant the true Griblje žbul every spring.\n\nOn the spring greeting day the society shows itself whole. At the Pozdrav pomladi in the fire station — a joint event of the branch school, the local community and the society — the women prepared folklore, a clarinet, a choir and a staged play, and the women's choir Viniške cür greeted the guests. Then came the bread: a competitive baking of home bread, with the best three announced.\n\nThe same hands revived the shepherds' games at the village pool and are present at every pasuljada: the Farm Women's Society has been on the poster from the first pot.\n\nThe society's first public archive arrived in 2016: on 16 August the Dolenjski list wrote up the gathering on the village playground at the twentieth anniversary of the society's independence — the first public confirmation of the 1996 founding year. The society was led by president Anica Totter, the programme was hosted by Ivanka Pezdirc (author of the žbul booklet), with farm-women guests from Adlešiči, Črnomelj, Dragatuš and Metlika as well as friends from Kočevje and Trebnje, while mayoress Mojca Čemas Stjepanovič greeted them on behalf of the municipality. And, as the paper reported, 'the main onion — the žbul — was of course the star': the calendar written by hands also keeps its own order of onions.\n\nIn June 2026 the žbul slipped across the region's borders: at the already traditional meeting of the farm women's societies of Bela krajina, Kočevje and Lukovdol, the members from Griblje spoke about the žbul — the same theme that got its booklet in 2012 returned as a talk at an inter-regional gathering. That summer the young branch came alive too: the society's younger members presented the Griblje žbul 'in a new dress, from muffins to ice cream' at the Days of Herbalism in Bela krajina — showing that the society guards not only recipes but also the will to imagine onward.\n\nThe museum seeks: the exact founding day, the list of presidents before and after 2016 (known: Anica Totter) and photographs of the society's beginnings — a history written by hands deserves its own archive too.",
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/dkz-griblje-2016-od-semena-do-zbula.jpg",
    imageCredit:
      "Foto: Dolenjski list (16. 8. 2016) — razstavni pult Društva kmečkih žena Griblje »Od semena do žbula« ob 20. obletnici društva na vaškem igrišču: košare žbula, stena fotografij društva, članice pri pultu",
    yearFrom: 1996,
    yearTo: 2026,
    featured: false,
    sources: [
      ...
      {
        key: "dl-kmecke-zene-2016",
        nameSi: "Dolenjski list (16. 8. 2016): Gribeljske kmečke žene praznovale 20 let",
        nameEn: "Dolenjski list (16 Aug 2016): The Griblje farm women celebrated 20 years",
        sourceType: "spletni-vir",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/kronika/gribeljske-kmecke-zene-praznovale-20-let-160507-1708713",
        noteSi: "Srečanje na vaškem igrišču ob 20. obletnici samostojnosti DKŽ Griblje; predsednica Anica Totter; program Ivanka Pezdirc; županja Mojca Čemas Stjepanovič; gostje iz Adlešič, Črnomlja, Dragatuša, Metlike, Kočevja in Trebnjega; glavna čebula oz. žbul.",
        noteEn: "A gathering on the village playground at the 20th anniversary of the society; president Anica Totter; programme by Ivanka Pezdirc; mayoress Mojca Čemas Stjepanovič; guests from Adlešiči, Črnomelj, Dragatuš, Metlika, Kočevje and Trebnje; the main onion, the žbul.",
      },
      {
        key: "odeon-zbul-preobleka-2026",
        nameSi:
          "Radio Odeon (21. 9. 2026): Gribeljski žbul v novi preobleki: od mafinov do sladoleda — podmladek DKŽ Griblje na Dnevih zeliščarstva",
        nameEn:
          "Radio Odeon (21 Sep 2026): The Griblje žbul in a new dress: from muffins to ice cream — the young branch of DKŽ Griblje at the Days of Herbalism",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/gribeljski-zbul-v-novi-preobleki-od-mafinov-do-sladoleda/",
        noteSi:
          "Dnevi zeliščarstva v Beli krajini (vir: LU Črnomelj): mlajše članice DKŽ Griblje so predstavile gribeljski žbul — vpisan v sortno listo kot avtohtona tradicionalna sorta — v novi preobleki: mafini, grisine, mini pogačice, kruhki z namazom, slane košarice z žbulovo kremo in sladoled iz gribeljskega žbula; stojnica z domačim žbulom, žbulčki za sajenje in pletenimi venci.",
        noteEn:
          "The Days of Herbalism in Bela krajina (source: LU Črnomelj): the younger members of DKŽ Griblje presented the Griblje žbul — entered in the variety list as an autochthonous traditional variety — in a new dress: muffins, grissini, mini flatbreads, bread rolls with spread, savoury baskets with žbul cream and ice cream made of the Griblje žbul; the stall with home-grown žbul, planting bulbs and woven wreaths.",
      },
      {
        key: "odeon-srecanje-dkz-2026",
        nameSi:
  ...
  },
  {
    ...
    sources: [
      ...
      {
        key: "bm-kulturna-zgodovina-1767",
        nameSi: "Belokranjski muzej Metlika — Kulturna zgodovina: Toaletna skledica s podobo Napoleona, začetek 19. st., Griblje (inv. št. 1767)",
        nameEn: "Bela krajina Museum Metlika — Cultural history: a toilet basin with the portrait of Napoleon, early 19th c., Griblje (inv. no. 1767)",
        sourceType: "spletni-vir",
        license: "javna predstavitev muzejske zbirke",
        url: "https://publishwall.si/belokranjski.muzej/post/292000/kulturna-zgodovina",
        noteSi:
          "Porcelanasta skledica s kolorirano podobo Napoleona I. v sredini; kontekst: francoska uprava Ilirskih provinc, višji davki, upor v Starem trgu in Črnomlju ter vojska iz Novega mesta.",
        noteEn:
          "A porcelain basin with a coloured portrait of Napoleon I at its centre; context: the French administration of the Illyrian Provinces, higher taxes, the revolt in Stari trg and Črnomelj and the army from Novo mesto.",
      },
    ],
  },
  {
    ...
    sources: [
      ...
      {
        key: "mojadolenjska-tone-kralj",
        nameSi: "Moja Dolenjska (7. 2. 2026): Griblje — Anton Kralj praznoval častitljivih 98 let",
        nameEn: "Moja Dolenjska (7 Feb 2026): Griblje — Anton Kralj celebrated a dignified 98",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://moja-dolenjska.si/griblje-anton-kralj-praznoval-castitljivih-98-let/",
        noteSi: "Neodvisna potrditev: 98. rojstni dan 11. januarja 2026; obisk župana Andreja Kavška, RK prostovoljk Mojce Črnič in Nade Štrucelj ter predsednice KS Romane Husič; iz svojega arhiva je pokazal članke — »kmet, organizator in povezovalec ljudi«.",
        noteEn: "An independent corroboration: the 98th birthday on 11 January 2026; the visit of mayor Andrej Kavšek, Red Cross volunteers Mojca Črnič and Nada Štrucelj and community president Romana Husič; from his archive he showed articles — 'a farmer, an organiser and a connector of people'.",
      },
      {
        key: "dl-kralj-90-2018",
        nameSi: "Dolenjski list (21. 2. 2018): 90 let Antona Kralja iz Gribelj — od kurirčka",
        nameEn: "Dolenjski list (21 Feb 2018): Anton Kralj of Griblje is 90 — from a little courier",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/iskanje?q=Gribelj",
        noteSi: "Najzgodnejši dokumentiran poklicni podatek o Kralju: kurir med vojno; 90. rojstni dan februarja 2018 (iskalni arhiv DL; polni tekst čaka na pridobitev).",
        noteEn: "The earliest documented calling for Kralj: a courier in the war; his 90th birthday in February 2018 (DL search archive; full text awaits retrieval).",
      },
    ],
  },
  {
  ...
  {
    slug: "precanje-pri-gribljih",
    museumNo: "MVG-096",
    addedAt: "2026-09-20",
    category: "vojna",
    titleSi: "Kolpa se zavije pri Gribljih — prikrito prečanje čez reko 1941–1943",
    titleEn: "The Kolpa bends at Griblje — the secret crossing of the river, 1941–1943",
    periodSi: "1941–1943 · italijanska okupacija",
    periodEn: "1941–1943 · the Italian occupation",
    summarySi:
      "Pri ovinku Kolpe pri Gribljih italijanska straža ni imela pregleda — in prav tam so hrvaški kajdarji prikrivajoče prevažali ljudi čez reko, med njimi begunce in Žide s hrvaške strani. Pričevanje soseda iz Krasinca o slepem mestu obmejnega pasu, ki je postalo prehod.",
    summaryEn:
      "At the bend of the Kolpa at Griblje the Italian sentries had no view — and right there Croatian boatmen secretly ferried people across the river, among them refugees and Jews from the Croatian side. The testimony of a neighbour from Krasinec about the blind spot of the border zone that became a passage.",
    storySi:
      "Meje niso vidne le na zemljevidu — vidne so tudi s stražarskega mesta. Jožef Klepec iz Krasinca je v intervjuju za razstavo Inštituta za novejšo zgodovino o okupacijskih mejah povedal, kako je izgledala reka s strani tistih, ki so jo stražili: »Italijani so tu imeli stražo. Gor in dol od nas kak kilometer je Kolpa ravna, pri Gribljah pa malo zavije, tam Italijani niso imeli pregleda.«\n\nOvinka, kjer se reka ukrivi in stran odteče od stražarjevega očesa, je postal prehod. »Nekateri hrvaški državljani so tam Žide vozili čez vodo,« je povedal Klepec. Med prečkanimi so bili begunci in Židi s hrvaške strani; »ljudje so pripovedovali, da so bili bogati« — in tudi pohlep je naredil svoj del: »Okradli so jih ti, ki so jih vozili čez Kolpo. Ko so prišli na drugo stran reke, so kričali, da so Italijani, bejžmo, bejžmo. Židi so poskakali ven, oni pa s čolnom, polnim robe, nazaj na hrvaško stran.« Reka je bila hkrati pot in past; pričevanje ne polepšava — pripoveduje oboje.\n\nKlepecov spomin shrani še drobec vaške vojne ekonomije: »Židi so nosili s seboj prtljago, drugače pa so imeli v glavnem denar — zlato, cekine. Spominjam se, ko sem še v šolo hodil, da sta šla oče in mati na Hrvaško kupit te cekine, da so jih nato nosili zobarom. To je bilo kvalitetno zlato … cela dolina si je s temi cekini zobe delala.« Zlatniki, preneseni čez reko pri Gribljih, so se v naslednjih letih pretakali po hišah doline — pričevanje o tem, kako vojna prestavi vrednote: kje je zlato, kadar svet gori.\n\nZa ta muzej je ovinka pri Gribljih zapis o vasi, ki v vojni ni bila le prizorišče postojanke in zasede (zapis zaseda-1941) — bila je tudi slepo mesto obmejnega pasu: detajl pokrajine, v katerem je umikala vrzel dovolj velika, da je čeznjo šlo človeško življenje. Muzej išče: imena kajdarjev, ki so prevažali, zgodbe družin, ki so prečale, in spomine obeh bregov — pričevanje je prvo stran te knjige, listov je še veliko.",
    storyEn:
      "Borders are visible not only on maps — they are visible from the sentry's post too. Jožef Klepec of Krasinec, interviewed for the Institute of Contemporary History's exhibition on the occupation borders, described how the river looked from the side of those who guarded it: \"The Italians had sentries here. About a kilometre up and down from our village the Kolpa River flows straight, but near Griblje it takes a turn and the Italians couldn't see there.\"\n\nThe bend where the river curves away from the watchman's eye became a passage. \"Certain Croatian citizens ferried Jews across the water there,\" Klepec recalled. Among those ferried were refugees and Jews from the Croatian side; \"the people said that the Jews were rich\" — and greed took its share too: \"They were robbed by the people ferrying them across the Kolpa River. When they reached the opposite bank, they started yelling that the Italians had come, run, run. The Jews jumped out and they took the boat, full of goods, back to the Croatian side.\" The river was at once a road and a trap; the testimony does not embellish — it tells both.\n\nKlepec's memory also preserves a fragment of the village's wartime economy: \"The Jews carried luggage with them, but they mostly had money — gold, gold coins. I remember when I was still in school that my father and mother went to Croatia to buy those coins, to take them afterwards to the barbers. It was good quality gold ... the whole valley was making its teeth shine with those coins.\" Gold coins carried across the river at Griblje flowed through the houses of the valley in the years that followed — a testimony of how war displaces value: where does gold live when the world burns.\n\nFor this museum the bend at Griblje is a record of a village that in the war was not only the site of a post and an ambush (see the ambush record) — it was also the blind spot of the border zone: a detail of the landscape in which a gap opened wide enough for a human life to cross it. The museum is looking for: the names of the boatmen who ferried, the stories of the families who crossed, and the memories of both banks — the testimony is the first page of that book; many pages remain.",
    evidenceStatus: "TESTIMONY",
    image: "/images/authentic/kolpa-dolina.jpg",
    imageCredit:
      "Foto: Uroš Novina · Wikimedia Commons · CC BY 2.0 — dolina Kolpe z lokami v Beli krajini (ilustrativna slika ovinkov, ki straži niso videli; lasten posnetek ovinka pri Gribljih TO_COLLECT)",
    yearFrom: 1941,
    yearTo: 1943,
    lat: 45.5663,
    lng: 15.2928,
    ...
    sources: [
      {
        key: "inz-okupacijske-meje-klepec",
        nameSi: "Intervju: Jožef Klepec iz Krasinca — razstava Okupacijske meje 1941–1945, poglavje Življenje ob meji (Inštitut za novejšo zgodovino)",
        nameEn: "Interview: Jožef Klepec of Krasinec — the Occupation Borders 1941–1945 exhibition, the chapter Life at the Border (Institute of Contemporary History)",
        sourceType: "pricevanje",
        license: "navedba vira (razstava INZ)",
        url: "https://okupacijskemeje.si/exh04-ch05.html",
        noteSi: "Pričevanje: »Gor in dol od nas kak kilometer je Kolpa ravna, pri Gribljah pa malo zavije, tam Italijani niso imeli pregleda /…/ Nekateri hrvaški državljani so tam Žide vozili čez vodo.« + o ropu kajdarjev, cekinih in zlatu doline. Objavljeno kot spomin udeleženca — status zapisa TESTIMONY; imena kajdarjev in preživelih TO_COLLECT.",
        noteEn: "The testimony: \"About a kilometre up and down from our village the Kolpa River flows straight, but near Griblje it takes a turn and the Italians couldn't see there /…/ Certain Croatian citizens ferried Jews across the water there.\" + on the boatmen's robbery, the gold coins and the valley's gold. Published as a participant's memory — the record's status is TESTIMONY; the names of the boatmen and of the survivors TO_COLLECT.",
      },
    ],
  },
  {
    slug: "javna-razsvetljava-2023",
    museumNo: "MVG-097",
    addedAt: "2026-09-20",
    category: "kraj",
    titleSi: "Javna razsvetljava 2023 — luč, pod katero je kopala arheologija",
    titleEn: "The 2023 public lighting — the light beneath which archaeology dug",
    periodSi: "julij – začetek oktobra 2023 · občina Črnomelj",
    periodEn: "July – early October 2023 · Municipality of Črnomelj",
    summarySi:
      "Zaključena izgradnja javne razsvetljave v Gribljih: okrog 70.000 evrov občine in okrog 7.000 evrov krajanov — z arheološkimi raziskavami ob gradnji, vrednimi okrog 12.500 evrov, ki so v vaško modernizacijo vpisale tudi preteklost. Dve leti pozneje po istem vzorcu asfaltiranih 190 metrov vaške poti.",
    summaryEn:
      "The completion of Griblje's public lighting: some €70,000 from the municipality and some €7,000 from the villagers — with archaeological surveys during the construction, worth about €12,500, writing the past into the village's modernisation. Two years later, by the same pattern, 190 metres of the village road were asphalted.",
    storySi:
      "Zima v Beli krajini teme nikoli ne odpusti, vas pa se je dolgo svetila po lastni presoji — luč pri hiši, fenjer pri cesti. Leta 2023 je ta red zamenjala javna razsvetljava: dela podjetja EVI iz Črnomlja so potekala od julija do konca avgusta, občina Črnomelj je vložila okrog 70.000 evrov, krajani pa s prostovoljnimi prispevki — že uveljavljeno vaško lastnostjo — dodali okrog 7.000 evrov. Svetlobo so uradno odprli ob koncu tedna v začetku oktobra, s kulturnim programom; nagovora župana Andreja Kavška in predsednice KS Romane Husič sta potrdila, kar je dokazalo že prejšnja leta: vaška infrastruktura je roman, ki ga pišeta občina in vas skupaj.\n\nV zapisu o svetlobi pa je najtežji podatek najtišji: ob izgradnji so bile izvedene arheološke raziskave, vredne okrog 12.500 evrov. Vas, pod katero ležijo keltsko zlato Pezdirčeve njive in najdišča ob Kolpi, danes ne kopa več po slepo — vsak jarok, ki vzame lopato, najprej vpraša arheologe. Rezultati teh raziskav javnosti še niso znani — muzej jih izrecno išče, kar pečat zaradi skromnega obsega gradnje še povečuje: redki so primeri, ko bi tako majhna vaška investicija sploh znesla arheološki nadzor.\n\nDva leta pozneje, avgusta 2025, je bil po enakem vzorcu sodelovanja na novo asfaltiran najbolj poškodovan odsek javne poti — 190 metrov, okrog 35.000 evrov: občina za asfalt, krajevna skupnost za zamenjavo podlage. Zaporedje — zvonovi, šola, razsvetljava, cesta — je koledar vasi, ki si svoj svet uredi sama: po vrstici in po letu.\n\nZaporedje ima predzgodovino, ki jo je Radio Odeon zapisal štiriindvajset mesecev prej: jeseni 2021 je ista kombinacija zažarala zaselek Brinsko selo. Dela je znova izvedel EVI iz Črnomlja, znova je sodelovala arheologija — tokrat Skupina STIK iz Ljubljane, strošek 11.931,60 evrov ob investiciji 46.987,81 evrov —, znova so sredstva zbrale obe strani (krajani in KS Griblje 10.000 evrov, ostalo občina), in znova je bila predaja namenu slovesnost treh imen: župan Andrej Kavšek, predsednik KS Toni Brinc — danes član sveta, takrat na čelu — in dobrotnik dr. Franc Brinc. Dva projekta, dve leti razlike, en vzorec: vas in občina svetita z istim potpisom.\n\nTok ima tudi svoje vsakdanje zapise, ki jih kronika redko hrani: decembra 2021 je Elektro Ljubljana (distribucijska enota Novo mesto, nadzorništvo Metlika) zaradi del na distribucijskem omrežju za dve uri izklopila transformatorsko postajo GOR. GRIBLJE — brez toka je ostalo dvajset naslovov, hišne številke 3–15 z razdelki A in B ter en naslov zapisan kar kot »BŠ«. Rutinsko obvestilo je v resnici redka dokumentirana mikro-geografija vaškega omrežja: pove, katera okna si delijo isti kabel — podatek, ki ga muzejska kronika sicer ne piše, arhivi elektrodistribucije pa ga hranijo le v tehniških skicah.\n\nInfrastrukturni koledar vasi ima starejšo stran: 5. septembra 2008 je Dolenjski list zapisal »Iz Gribelj nič več v Kolpo« — odprtje čistilne naprave ob Kolpi in nove kanalizacije za 200–300 populacijskih enot, naložbe iz dobrega milijona evrov, za katero je evropski protokol zahteval predstavitev prav v gasilskem domu; 70 % sredstev je prispelo iz EU, župan Andrej Fabjan pa je projekt pozdravil kot prispevek k čistejši Kolpi. Čistilna naprava 2008, javna razsvetljava 2023, asfalt 2025 — enak vzorec tri generacije zapored: vas, ki srečo gradi po koščkih.\n\nOd leta 2025 pa je zgodba dobila tudi natančno mapa omrežja, ki jo pišejo izklopi: oktobra 2025 je Elektro Ljubljana na en potez odrezala TP GOR. GRIBLJE — kar 38 naslovov, od GRIBLJE 1 A do 52 in BŠ; junija 2026 je sledil izklop izvoda 2, ki ga je Elektro poimenovala kar sama: »GOR.G.-VIKENDI« (naslovi 1 A, 4 A, 4 G, 25 D in BŠ) — vikend hiše ob Kolpi; avgusta 2026 pa je tok izginil še z izvoda Šola postaje TP GRIBLJE (30 A–48 in BŠ) — dokaz, da ima vas poleg GOR. GRIBLJE še drugo transformatorsko postajo, njen krak ob šoli pa lastno ime. Vsak izklop je nesramen, a nenadomestljiv popis: pove, katera okna si delijo isti kabel — zdaj vemo, da jih delijo po dveh postajah in vsaj treh poimenovanih krakih. Razsvetljava blizu šole pa ima svoj datum rojstva: trak sta ga 8. oktobra 2021 presekala dr. Franc Brinc in predsednik KS Toni Brinc ob županu Andreju Kavšku.\n\nMuzej išče: rezultate arheoloških raziskav ob izgradnji razsvetljave, fotografijo odprtja in popis prve javne svetilke v vasi — kje je gorela, preden je prišel tok.",
    storyEn:
      "Winter in Bela krajina never forgives the dark, and for long the village lit itself by its own judgement — a lamp by the house, a lantern by the road. In 2023 that order was replaced by public lighting: the works of the Črnomelj firm EVI ran from July to the end of August, the Municipality of Črnomelj invested around €70,000, and the villagers — with their established habit of voluntary contributions — added about €7,000. The light was officially opened on the weekend in early October, with a cultural programme; the addresses by mayor Andrej Kavšek and community president Romana Husič confirmed what earlier years had proven: village infrastructure is a novel written by the municipality and the village together.\n\nBut the weightiest fact of the record is the quietest: during the construction, archaeological surveys were carried out, worth about €12,500. A village beneath whose fields lie the Celtic gold of the Pezdir farm and the sites by the Kolpa no longer digs blindly — every trench that takes a spade first asks the archaeologists. The results of these surveys are not yet public — the museum explicitly seeks them, which the modest scale of the construction makes all the more remarkable: rarely does so small a village investment carry an archaeological survey at all.\n\nTwo years later, in August 2025, the most damaged stretch of the public path was repaved by the same pattern of cooperation — 190 metres, some €35,000: the municipality for the asphalt, the local community for replacing the bedding. The sequence — bells, school, lighting, road — is the calendar of a village that arranges its own world: line by line and year by year.\n\nThe sequence has a prehistory, recorded by Radio Odeon twenty-four months earlier: in the autumn of 2021 the same combination lit up the hamlet of Brinsko selo. The works were again carried out by EVI of Črnomelj, archaeology was again part of the deal — this time the STIK Group from Ljubljana, at a cost of €11,931.60 within an investment of €46,987.81 — the two sides again shared the funding (the villagers and the Griblje local community €10,000, the rest from the municipality), and the handover again carried three names: mayor Andrej Kavšek, KS president Toni Brinc — a council member today, at the helm then — and the benefactor dr. Franc Brinc. Two projects, two years apart, one pattern: the village and the municipality light it with the same signature.\n\nThe current also keeps everyday records that chronicles rarely store: in December 2021 Elektro Ljubljana (the Novo mesto distribution unit, Metlika supervision office) switched off the GOR. GRIBLJE transformer station for two hours because of works on the distribution network — twenty addresses lost power, house numbers 3–15 with their A and B divisions and one address recorded simply as »BŠ«. A routine notice is in truth a rare documented micro-geography of the village network: it tells which windows share the same cable — a fact the museum chronicle does not otherwise write, and the grid archives keep only in technical drawings.\n\nThe village’s infrastructure calendar has an older page: on 5 September 2008 the Dolenjski list wrote ‘From Griblje nothing more into the Kolpa’ — the opening of a treatment plant by the Kolpa and a new sewerage system for 200–300 population equivalents, an investment of over a million euros whose European protocol required a presentation in the fire station itself; seventy per cent of the funds came from the EU, and mayor Andrej Fabjan hailed the project as a contribution to a cleaner Kolpa. Treatment plant 2008, public lighting 2023, asphalt 2025 — the same pattern three generations running: a village building its fortune piece by piece.\n\nSince 2025 the story has also acquired a precise map of the grid, written by the cuts: in October 2025 Elektro Ljubljana cut TP GOR. GRIBLJE in one stroke — as many as 38 addresses, from GRIBLJE 1 A to 52 and BŠ; in June 2026 came the cut of outlet 2, named by Elektro itself: 'GOR.G.-VIKENDI' (addresses 1 A, 4 A, 4 G, 25 D and BŠ) — the weekend houses by the Kolpa; and in August 2026 the current vanished from the Šola outlet of the TP GRIBLJE station (30 A–48 and BŠ) — proof that besides GOR. GRIBLJE the village has a second transformer station, its branch by the school carrying a name of its own. Every cut is a blunt but irreplaceable census: it says which windows share the same cable — now we know they are divided across two stations and at least three named branches. And the lighting near the school has a birth date of its own: on 8 October 2021 the ribbon was cut by Dr Franc Brinc and local community president Toni Brinc with mayor Andrej Kavšek.\n\nThe museum seeks: the results of the lighting archaeology, a photograph of the opening, and a register of the village's first public lamp — where it burned before the current came.",
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/razsvetljava-led.jpg",
    imageCredit:
      "Foto: John Goldsmith · Wikimedia Commons · CC BY-SA 2.0 — LED javna svetilka (ilustrativna slika; gribeljska svetilka čaka na svojo)",
    yearFrom: 2023,
    yearTo: 2025,
    lat: 45.5728,
    lng: 15.2926,
    ...
    sources: [
      {
        key: "odeon-brinsko-selo-2021",
        nameSi: "Radio Odeon (18. 10. 2021): Zaselek Brinsko selo v Gribljah z novo javno razsvetljavo",
        nameEn: "Radio Odeon (18 Oct 2021): The hamlet of Brinsko selo in Griblje with new public lighting",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://radio-odeon.com/novice/zaselek-brinsko-selo-v-gribljah-z-novo-javno-razsvetljavo/",
        noteSi: "Predhodni projekt istega vzorca (vir: Občina Črnomelj): dela 46.987,81 EUR, arheološke raziskave Skupine STIK iz Ljubljane 11.931,60 EUR, krajani + KS 10.000 EUR, izvajalec EVI; predaja: župan Kavšek, predsednik KS Toni Brinc in dr. Franc Brinc.",
        noteEn: "The predecessor project of the same pattern (source: Municipality of Črnomelj): works €46,987.81, the archaeological survey by the STIK Group of Ljubljana €11,931.60, villagers + KS €10,000, contractor EVI; the handover by mayor Kavšek, KS president Toni Brinc and dr. Franc Brinc.",
      },
      {
        key: "mojadolenjska-razsvetljava-2023",
        nameSi: "Moja Dolenjska (9. 10. 2023): Griblje — svetlejše z novo razsvetljavo",
        nameEn: "Moja Dolenjska (9 Oct 2023): Griblje — brighter with the new lighting",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://moja-dolenjska.si/griblje-svetlejse-z-novo-razsvetljavo/",
        noteSi: "Investicija ~70.000 EUR občina + ~7.000 EUR krajani; arheološke raziskave ob gradnji ~12.500 EUR; izvajalec EVI Črnomelj; dela julij–konec avgusta; odprtje s kulturnim programom, nagovora župana Andreja Kavška in predsednice KS Romane Husič.",
        noteEn: "The investment ~€70,000 municipality + ~€7,000 villagers; archaeological surveys during construction ~€12,500; contractor EVI of Črnomelj; works July–end of August; the opening with a cultural programme, addressed by mayor Andrej Kavšek and community president Romana Husič.",
      },
      {
        key: "mojadolenjska-asfalt-2025",
        nameSi: "Moja Dolenjska (26. 8. 2025): Griblje z na novo asfaltiranim odsekom ceste",
        nameEn: "Moja Dolenjska (26 Aug 2025): Griblje with a newly asphalted road section",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://moja-dolenjska.si/griblje-z-na-novo-asfaltiranim-odsekom-ceste/",
        noteSi: "190 m javne poti; občina Črnomelj za asfaltiranje, KS Griblje za zamenjavo podlage; vrednost ~35.000 EUR (ne mešati z Brinčevo donacijo PGD 35.000 EUR — različna projekta).",
        noteEn: "190 m of the public path; the Municipality of Črnomelj asphalted it, the local community of Griblje replaced the bedding; value ~€35,000 (not to be confused with Brinc's €35,000 gift to the fire brigade — two different projects).",
      },
      {
        key: "odeon-elektrika-2021",
        nameSi: "Radio Odeon (1. 12. 2021): Del Gribelj bo brez elektrike",
        nameEn: "Radio Odeon (1 Dec 2021): Part of Griblje will be without electricity",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://radio-odeon.com/novice/del-gribelj-bo-brez-elektrike/",
        noteSi: "Obvestilo Elektro Ljubljana d.d. (DE Novo mesto, nadzorništvo Metlika): izklop TP GOR. GRIBLJE med 10. in 12. uro zaradi del na distribucijskem omrežju; 20 naslovov — hišne št. 3–15 z razdelki (3, 4, 5, 6, 6 A, 7, 8, 9, 9 A, 9 B, 10, 10 A, 11, 11 A, 12, 13, 13 A, 14, 15) in »GRIBLJE BŠ«; v primeru slabega vremena prestavitev. Polno besedilo (10. val raziskave).",
        noteEn: "Notice by Elektro Ljubljana (Novo mesto unit, Metlika supervision): the GOR. GRIBLJE transformer station switched off 10:00–12:00 for distribution network works; 20 addresses — house numbers 3–15 with divisions (3, 4, 5, 6, 6 A, 7, 8, 9, 9 A, 9 B, 10, 10 A, 11, 11 A, 12, 13, 13 A, 14, 15) and »GRIBLJE BŠ«; postponed in bad weather. Full text (research wave 10).",
      },
      {
        key: "dl-cn-2008",
      ...
      {
        key: "odeon-elektrika-2025",
        nameSi:
          "Radio Odeon (13. 10. 2025): Brez elektrike na območju Adlešičev, Gribelj in Dobravic — TP GOR. GRIBLJE, 38 naslovov",
        nameEn:
          "Radio Odeon (13 Oct 2025): Power cut in the area of Adlešiči, Griblje and Dobravič — TP GOR. GRIBLJE, 38 addresses",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/brez-elektrike-na-obmocju-adlesicev-gribelj-in-dobravic/",
        noteSi:
          "Obvestilo Elektro Ljubljana: izklop TP GOR. GRIBLJE — 38 naslovov GRIBLJE od 1 A do 52 in BŠ; redka dokumentacija celotnega obsega vaskega kraka omrežja.",
        noteEn:
          "A notice by Elektro Ljubljana: the cut of TP GOR. GRIBLJE — 38 GRIBLJE addresses from 1 A to 52 and BŠ; a rare documentation of the full extent of the village branch of the grid.",
      },
      {
        key: "odeon-elektrika-2026-vikendi",
        nameSi:
          "Radio Odeon (8. 6. 2026): Brez elektrike v delu Črnomlja, Dolenjcev in Gribelj — TP GOR. GRIBLJE, izvod 2 »GOR.G.-VIKENDI«",
        nameEn:
          "Radio Odeon (8 Jun 2026): Power cut in part of Črnomelj, Dolenjci and Griblje — TP GOR. GRIBLJE, outlet 2 'GOR.G.-VIKENDI'",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/brez-elektrike-v-delu-crnomlja-dolenjcev-in-gribelj/",
        noteSi:
          "Izklop izvoda 2 gribeljske postaje — poimenovanega »GOR.G.-VIKENDI« (vikend hiše ob Kolpi): GRIBLJE 1 A, 4 A, 4 G, 25 D in BŠ.",
        noteEn:
          "The cut of outlet 2 of the Griblje station — named 'GOR.G.-VIKENDI' (the weekend houses by the Kolpa): GRIBLJE 1 A, 4 A, 4 G, 25 D and BŠ.",
      },
      {
        key: "odeon-elektrika-2026-sola",
        nameSi:
          "Radio Odeon (30. 8. 2026): Brez elektrike v Gribljah — TP GRIBLJE, izvod Šola (naslovi 30 A–48 + BŠ)",
        nameEn:
          "Radio Odeon (30 Aug 2026): Power cut in Griblje — TP GRIBLJE, the Šola outlet (addresses 30 A–48 and BŠ)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/brez-elektrike-v-gribljah/",
        noteSi:
          "Izklop TP GRIBLJE, izvod Šola: GRIBLJE 30 A, 30 E, 31, 31 A, 31 B, 32, 32 A, 32 B, 32 C, 33, 34, 35, 35 B, 36, 37, 38, 42, 48 in BŠ — dokaz, da ima vas poleg TP GOR. GRIBLJE še drugo postajo s poimenovanim izvodom ob šoli; izvod Šola je brez toka bil tudi sredi septembra 2026.",
        noteEn:
          "The cut of TP GRIBLJE, the Šola outlet: GRIBLJE 30 A, 30 E, 31, 31 A, 31 B, 32, 32 A, 32 B, 32 C, 33, 34, 35, 35 B, 36, 37, 38, 42, 48 and BŠ — proof that besides TP GOR. GRIBLJE the village has a second station with a named outlet by the school; the Šola outlet was cut again in mid-September 2026.",
      },
    ],
  },
  {
    slug: "pogaca-vigred-2024",
    museumNo: "MVG-098",
    addedAt: "2026-09-20",
    category: "sege",
    titleSi: "Najboljša belokranjska pogača 44. Vinske vigredi — iz Gribelj",
    titleEn: "The best Bela krajina pogača of the 44th Vinska vigred — from Griblje",
    periodSi: "25. april 2024 · ocenjevanje v Metliki",
    periodEn: "25 April 2024 · the judging in Metlika",
    summarySi:
      "Na ocenjevanju belokranjske pogače pred 44. Vinsko vigredjo je zmagala Darinka Jerčinovič z »Kovačnice sreče« iz Gribelj, zbrala 79,38 točk — pogača, ki jo regija peče po receptih babic, je leta 2024 gribeljsko pečico pripeljala do najvišjega priznanja.",
    summaryEn:
      "At the judging of the Bela krajina pogača before the 44th Vinska vigred, Darinka Jerčinovič of the 'Kovačnica sreče' in Griblje won with 79.38 points — the flatbread the region bakes by its grandmothers' recipes carried a Griblje oven to the highest recognition in 2024.",
    storySi:
      "Belokranjska pogača ni le jed — je seznam pravil na papirju: evropsko priznanje »bela krajina pogača« nosi recept, ki se peče skoraj izključno doma, po metliških, črnomaljskih in semiških kuhinjah. Vsako leto pred Vinsko vigredjo se v Metliki sreča ocenjevanje, ki izmed pogač izbere najboljšo — in leta 2024 je bila najboljša pogača iz Gribelj.\n\nZmagovalka je Darinka Jerčinovič, hiša po imenu »Kovačnica sreče«: 79,38 točk, objavljeno 25. aprila 2024, na pragu 44. Vinske vigredi. Zapis ima v zbirki svojo težo: gribeljska kuhinja je v zbirki že stala ob zgibanki belokranjske kuhinje — zdaj ima dokaz tudi o peki, ki je merilo za celotno regijo. Pogača je poleg tega sestrska šega pisanicam: tudi ona je bela, tudi na njo se riše — po njej pa je prepoznavna vasa ob Kolpi postala prepoznavna na metliškem prazničnem trgu.\n\nNaslov pa je ostal doma tudi leta 2026: 21. aprila je v Hiši dobrot Bele krajine v Metliki komisija (pod RIC Bela krajina in Društvom kmečkih žena Metlika) ocenjevala pogače certificiranih proizvajalcev — in Darinka Jerčinovič je z 79 od 80 možnih točk spekla pogačo, ki je bila po zapisu »praktično brezhibna«: debelina testa, število zarezov, barva skorje, rahlost sredice, harmonija okusa. Po zmagi 2024 in medvladju Hiše dobrot (2025) je to drugi gribeljski naslov v treh letih — drugi poročevalec (Odeon ob Vinski vigredi) pa je dodal še presojo: vrhunska peka se »ne le ohranja, temveč pili do popolnosti«. Pogača, ki je v evropskem registru zaščitena do števila zarezov, ima v Gribljeh pečico, ki merilo regije zna držati.\n\nMuzej išče: fotografijo pogače ali peke, recept, in zgodbo o tem, kako je pogača potovala iz gribeljske pečice na metliško ocenjevalno mizo.",
    storyEn:
      "The Bela krajina pogača is not merely a dish — it is a list of rules on paper: the European recognition 'bela krajina pogača' carries a recipe baked almost exclusively at home, in the kitchens of Metlika, Črnomelj and Semič. Every year before the Vinska vigred festival Metlika hosts the judging that picks the best loaf among them — and in 2024 the best loaf came from Griblje.\n\nThe winner was Darinka Jerčinovič, a house called the 'Kovačnica sreče' — the forge of happiness: 79.38 points, announced on 25 April 2024, on the threshold of the 44th Vinska vigred. The record carries weight in this collection: Griblje's cooking already stood beside the Bela krajina cuisine spread — now it has proof of a bake that was the measure of the whole region. The pogača is, moreover, the sister custom of the pisanice: it, too, is white, and it, too, is drawn upon — and by it the village by the Kolpa became recognisable on Metlika's festive square.\n\nThe title stayed at home in 2026 as well: on 21 April, at the Hiša dobrot Bele krajine in Metlika, a jury (under RIC Bela krajina and the Metlika Farm Women's Society) judged the loaves of certified producers — and Darinka Jerčinovič, with 79 of the possible 80 points, baked a pogača recorded as 'practically flawless': the dough's thickness, the number of cuts, the crust's colour, the crumb's lightness, the harmony of taste. After the 2024 win and the interregnum of Hiša dobrot (2025), this is Griblje's second title in three years — and the second reporter (Odeon, at the Vinska vigred) added a verdict of its own: fine baking 'is not only preserved but honed to perfection'. The pogača, protected in the European register down to the number of cuts, has in Griblje an oven that knows how to hold the region's yardstick.\n\nThe museum seeks: a photograph of the loaf or of the baking, the recipe, and the story of how the pogača travelled from a Griblje oven to the Metlika judging table.",
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/pogaca.jpg",
    imageCredit: "Foto: Rude · Wikimedia Commons · CC BY-SA 3.0 — belokranjska pogača (isti motivni krog kot zapis Belokranjska kuhinja)",
    yearFrom: 2024,
    lat: 45.5728,
    lng: 15.2926,
    coordsApprox: true,
    ...
    sources: [
      {
        key: "vigred-pogaca-2024",
        nameSi: "Vinska vigred (25. 4. 2024): Najboljša belokranjska pogača 44. Vinske vigredi v Beli krajini prihaja iz Gribelj",
        nameEn: "Vinska vigred (25 Apr 2024): The best Bela krajina pogača of the 44th Vinska vigred comes from Griblje",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.vinska-vigred.si/sl/novice/najboljsa-belokranjska-pogaca-44-vinske-vigredi-v-beli-krajini-prihaja-iz-gribelj/",
        noteSi: "Zmagovalka Darinka Jerčinovič (Kovačnica sreče), 79,38 točk. Naslov potrjen na živi domači strani festivala; podrobnosti (točke, zmagovalka) iz iskalno indeksiranega odlomka — telo članka je bilo pri pisanju zapisov nedostopno (anti-bot 429).",
        noteEn: "Winner Darinka Jerčinovič (Kovačnica sreče), 79.38 points. The headline verified on the festival's live homepage; details (points, winner) from the search-indexed excerpt — the article body was unreachable at writing (anti-bot 429).",
      },
      {
        key: "odeon-darinka-pogaca-2026",
        nameSi:
          "Radio Odeon (22. 4. 2026): Darinka spekla popolno belokranjsko pogačo — Kovačnica sreče z 79/80 točkami",
        nameEn:
          "Radio Odeon (22 Apr 2026): Darinka baked the perfect Bela krajina pogača — the Kovačnica sreče with 79/80 points",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/darinka-spekla-popolno-belokranjsko-pogaco/",
        noteSi:
          "Ocenjevanje 21. 4. 2026 v Hiši dobrot Bele krajine v Metliki: Darinka Jerčinovič (Kovačnica sreče, Griblje) 79 od 80 točk — »praktično brezhibna«; komisija pod RIC Bela krajina in DKŽ Metlika (Jamšek, Mihelčič, Gregorič, Pezdirc, Škof, Škof); merila ZTP: debelina testa, število zarezov, barva skorje, rahlost sredice, harmonija okusa; zmagovalka nasledila lansko zmagovalko Hišo dobrot.",
        noteEn:
          "Judging on 21 April 2026 at the Hiša dobrot Bele krajine in Metlika: Darinka Jerčinovič (Kovačnica sreče, Griblje) 79 out of 80 points — 'practically flawless'; a jury under RIC Bela krajina and the Metlika Farm Women's Society (Jamšek, Mihelčič, Gregorič, Pezdirc, Škof, Škof); the ZTP criteria: dough thickness, number of cuts, crust colour, crumb lightness, harmony of taste; the winner succeeded last year's winner, Hiša dobrot.",
      },
      {
        key: "odeon-vigred-pogaca-2026",
        nameSi:
          "Radio Odeon (16. 5. 2026): Vinska vigred povezuje tudi pod dežniki — najboljšo belokranjsko pogačo spet spekla Darinka Jerčinovič iz Gribelj",
        nameEn:
          "Radio Odeon (16 May 2026): Vinska vigred connects even under umbrellas — the best Bela krajina pogača was baked again by Darinka Jerčinovič from Griblje",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.radio-odeon.com/novice/vinska-vigred-povezuje-tudi-pod-dezniki/",
        noteSi:
          "Drugi poročevalec zmage 2026 (prekrivanje z odeon-darinka-pogaca-2026 izrecno): »Najboljšo belokranjsko pogačo je letos spekla Darinka Jerčinovič iz Gribelj, ki je dokazala, da se vrhunska peka pogače v Beli krajini ne le ohranja, temveč pili do popolnosti.«",
        noteEn:
          "The second reporter of the 2026 win (overlap with odeon-darinka-pogaca-2026 stated explicitly): 'This year's best Bela krajina pogača was baked by Darinka Jerčinovič from Griblje, who proved that the fine baking of pogača in Bela krajina is not only preserved but honed to perfection.'",
      },
    ],
  },
  {
    ...
    addedAt: "2026-09-21",
    category: "kraj",
    titleSi: "Dragojila Milek — Gregorčičeva »planinska roža« z očetovo domovijo v Gribljih",
    titleEn: "Dragojila Milek — Gregorčič's 'mountain flower', whose father's home was Griblje",
    periodSi: "1850 – 1890 · Zalog, Kobarid, Podzemelj, Ljubljana",
    periodEn: "1850 – 1890 · Zalog, Kobarid, Podzemelj, Ljubljana",
    summarySi:
      "Učiteljica in pesnica, rojena kot Karolina Milek, znana kot velika ljubezen pesnika Simona Gregorčiča — in hči očeta, ki je bil doma iz sosednjih Gribelj. Zadnjo službo je dobila 1888 v Podzemlju, župniji, ki ji pripada tudi gribeljska cerkev; tam je učila le nekaj mesecev, preden jo je odnesla bolezen.",
    summaryEn:
      "A teacher and poet, born Karolina Milek, known as the great love of the poet Simon Gregorčič — and the daughter of a father whose home was neighbouring Griblje. She received her last post in 1888 in Podzemelj, the parish to which the Griblje church also belongs; she taught there only a few months before illness carried her off.",
    storySi:
      "Ta zapis se začne ne v Gribljih, ampak se tam vseskozi vrača. Dragojila Milek — rojena kot Karolina, 11. novembra 1850 v Zalogu pri Ljubljani, na Martinovo, v družini nižjega mestnega stražnika Petra Mileka in Katarine rojene Leban — je ena izmed najbolj znanih slovenskih učiteljic 19. stoletja in pesnica, ki jo je zgodovina najraje zapisovala ob drugem imenu: Simon Gregorčič, goriški slavček. In v njenem življenjepisu stoji stavek, ki povezuje to zgodbo z vasjo ob Kolpi: njen oče, ki si je kasneje v Ljubljani ustvaril svojo družino, je bil doma iz sosednjih Gribelj.\n\nŠolala se je pri ljubljanskih uršulinkah, učiteljski izpit pa je opravila pri zasebni učiteljici Juliji Moosovi, saj učiteljišča za dekleta takrat še ni bilo. Govorila je nemško, francosko in italijansko, brala pa tudi v ruščini. Leta 1872 je kot prva učiteljica prišla v Kobarid, kjer je uvedla pouk ženskih ročnih del, vodila cerkveni pevski zbor, režirala na domačem odru in za prirodoslovca Frana Erjavca zbirala ljudske pesmi ter ljudska rastlinska imena. Tam je kot tajnica čitalnice spoznala kaplana Simona Gregorčiča. Sorodni duši sta se zbližali; ljubezen med njima je trajala dlje kot njuna bližina — Gregorčiča je kmalu zamenjala služba, župnik pa je premeščitev sam predlagal škofu. Junija 1873 mu je Milekova posvetila pesem Sloves; Gregorčič ji je odgovoril z pesmijo Ohrani Bog te v cveti, podpisano s psevdonimom Bojan, in ko jo je uglasbil Gustav Ipavec, je nastalo ime, ki danes poznajo vsi, ki poznajo Gregorčiča: Planinska roža.\n\nSama je objavljala pod psevdonimi: v Vrtcu kot Petrovna, v Ljubljanskem zvonu 1887 pa pesem Zgodnja cvetlica kot Črnogorka. Pisma je pisala pesniku Josipu Cimpermanu — del tega arhiva hrani Narodna in univerzitetna knjižnica. Poroka med duhovnikom in učiteljico ni bila možna: duhovnika je vezal celibat, učiteljice pa je poroka takrat odnesla pravico do poučevanja. Ko je leta 1888 podzemeljski ravnatelj Ivan Barle — učitelj, ki ga ta zbirka pozna tudi kot osebo, pri kateri so se pred 1889 šolali gribeljski otroci — enorazredno šolo v Podzemlju spremenil v dvorazrednico, se je Dragojila na lastno željo premeščila na Belo krajino. V podzemeljski šoli je stanovala in učila le nekaj mesecev: zbolela je za hudo tuberkulozo, bila upokojena in naslednje leto umrla v Ljubljani pri starših. Dolenjski list jo je tako v seriji Ljudje ob Kolpi 22. julija 2022 poslal domov za vedno — z opombo, da so njena pisma v veliki meri uničili domači, ker se je zgražalo nad ljubeznijo, ki ni smela biti.\n\nOb smrti so se je spomnili največji slovenski listi tistega časa; Dolenjski list pa ji je 1969 ob obnovljenem zanimanju za Gregorčiča posvetil kar dve objavi. Gribeljska nit zgodbe je tanka, a je dokumentirana s štirimi neodvisnimi viri: očetova domovija, podzemeljska služba v župniji gribeljske cerkve, ravnatelj Barle iz našega registra in narava, ki je po tej zbirki v Gribljih vedno nosila ime rože — planinske. Muzej išče: odlomek obeh Bačerjevih člankov iz Dolenjskega lista 1969, fotografijo podzemeljske šole tistega časa in zvezek pesmi, ki ga hrani NUK.",
    storyEn:
      "This record does not begin in Griblje — it keeps returning there. Dragojila Milek — born Karolina on 11 November 1850 at Zalog near Ljubljana, on St Martin's day, into the family of a minor town constable, Peter Milek, and Katarina née Leban — is one of the best-known Slovene teachers of the 19th century and a poet whom history preferred to write down beside another name: Simon Gregorčič, the nightingale of Gorizia. And her biography contains the sentence that ties this story to the village on the Kolpa: her father, who later made his family in Ljubljana, was from neighbouring Griblje.\n\nShe was schooled with the Ursulines of Ljubljana and qualified for teaching with the private teacher Julija Moos, for there was no teacher-training college for girls in those days. She spoke German, French and Italian, and read Russian too. In 1872 she came to Kobarid as its first teacher, introducing classes in women's handwork, leading the church choir, directing on the local stage, and gathering folk songs and folk plant names for the naturalist Fran Erjavec. There, as secretary of the reading room, she met the curate Simon Gregorčič. Two kindred souls drew close; the love between them outlasted their proximity — a new post soon took Gregorčič away, and it was the parish priest himself who proposed the transfer to the bishop. In June 1873 Milek devoted to him the poem Sloves — The Farewell; Gregorčič answered with the poem Ohrani Bog te v cveti — God keep you in bloom — signed with the pseudonym Bojan, and when Gustav Ipavec set it to music it received the name everyone who knows Gregorčič knows today: Planinska roža — the mountain flower.\n\nShe herself published under pseudonyms: as Petrovna in Vrtec, and in the Ljubljanski zvon of 1887 the poem Zgodnja cvetlica — The early flower — as Črnogorka. She wrote letters to the poet Josip Cimperman — part of that archive is kept by the National and University Library. Marriage between a priest and a teacher was impossible: the priest was bound by celibacy, and in those days a teacher lost her right to teach by marrying. When in 1888 the Podzemelj head teacher Ivan Barle — the teacher whom this collection knows also as the man by whom Griblje's children learned before 1889 — raised the one-class school of Podzemelj to a two-class one, Dragojila transferred at her own request to Bela krajina. She lived in the Podzemelj school and taught only a few months: she fell gravely ill with tuberculosis, was pensioned off, and died the following year in Ljubljana at her parents' home. On 22 July 2022 the Dolenjski list, in its People by the Kolpa series, thus sent her home for good — with the note that her letters were largely destroyed by her family, which frowned upon a love that was not allowed to be.\n\nAt her death the leading Slovene papers of the day remembered her; the Dolenjski list devoted two items to her in 1969, when interest in Gregorčič was renewed. The Griblje thread of the story is thin, but it is documented by four independent witnesses: the father's home village, the Podzemelj post within the parish of the Griblje church, the head teacher Barle from our register, and the fact that in this region nature has always carried the name of a flower — a mountain one. The museum seeks: the text of both Bačer items in the Dolenjski list of 1969, a photograph of the Podzemelj school of that time, and the notebook of poems kept by the NUK.",
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/dragojila-milek.jpg",
    imageCredit:
      "Foto: Narodna in univerzitetna knjižnica — portret Dragojile Milek (19. stoletje; prek Obrazov slovenskih pokrajin)",
    yearFrom: 1850,
    yearTo: 1890,
    featured: false,
    sources: [
      {
        key: "osp-dragojila-milek",
        nameSi: "Obrazi slovenskih pokrajin — Dragojila Milek (avtorica gesla Mateja Kambič, Knjižnica Mirana Jarca Novo mesto; vnos 15. 12. 2019, sprememba 30. 12. 2025)",
        nameEn: "Faces of the Slovene Regions — Dragojila Milek (entry author Mateja Kambič, Miran Jarc Library Novo mesto; entered 15 Dec 2019, updated 30 Dec 2025)",
        sourceType: "spletni-vir",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://www.obrazislovenskihpokrajin.si/oseba/dragojila-milek/",
        noteSi: "Polni življenjepis: roj. 11. 11. 1850 Zalog, umrla 22. 7. 1890 Ljubljana (Žabjek); starši Peter in Katarina r. Leban; prva učiteljica v Kobaridu 1872; pisma Cimpermanu (NUK); 1889 služba v Podzemlju; »Njen oče … je bil doma iz sosednjih Gribelj«. Viri gesla: Bačer, DL 2. 10. 1969 in 9. 10. 1969; Sivec, Planinska roža (2016); SB 2, str. 125; Wikipedia. Portret: NUK.",
        noteEn: "Full biography: born 11 Nov 1850 Zalog, died 22 Jul 1890 Ljubljana (Žabjek); parents Peter and Katarina née Leban; first teacher in Kobarid 1872; letters to Cimperman (NUK); 1889 post in Podzemelj; 'Her father … was from neighbouring Griblje.' Entry sources: Bačer, DL 2 Oct 1969 and 9 Oct 1969; Sivec, Planinska roža (2016); SB 2, p. 125; Wikipedia. Portrait: NUK.",
      },
      {
        key: "dl-dragojila-milek-2022",
        nameSi: "Dolenjski list (22. 7. 2022): Ljudje ob Kolpi — Dragojila Milek (avtor Boris Grabrijan)",
        nameEn: "Dolenjski list (22 Jul 2022): People by the Kolpa — Dragojila Milek (author Boris Grabrijan)",
        sourceType: "spletni-vir",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/novice/kultura/ljudje-ob-kolpi-dragojila-milek-264208-1783261",
        noteSi: "Polno vidno besedilo (12. val raziskave): na Martinovo 1850; uršulinke + Julija Moosova; župnik Andrej Jekše predlagal Gregorčičevo premestitev; Sloves 8. 6. 1873 po izletu do izvira Nadiže; odgovor Ohrani Bog te v cveti (Zvon, psevdonim Bojan); uglasbil Gustav Ipavec → »Planinska roža«; 1888 premeščena na lastno željo v Podzemelj, ker je ravnatelj Ivan Barle enorazrednico spremenil v dvorazrednico; tuberkuloza (umrli tudi trije bratje); sestra Viktorija uničila pisma; zvezek pesmi in zapiskov hrani NUK; »njen oče doma iz Gribelj«. Članek navaja smrt že 22. 7. 1889 — urejeni življenjepisi (SB, OSP) imata 1890; datum 22. julij se ujema.",
        noteEn: "Full visible text (research wave 12): born on St Martin's day 1850; Ursulines + Julija Moos; parish priest Andrej Jekše proposed Gregorčič's transfer; Sloves of 8 Jun 1873 written after the outing to the source of the Nadiža; the answer Ohrani Bog te v cveti (Zvon, pseudonym Bojan); set to music by Gustav Ipavec → 'Planinska roža'; in 1888 transferred at her own request to Podzemelj, because head teacher Ivan Barle had raised the one-class school to a two-class one; tuberculosis (three brothers died of it too); her sister Viktorija destroyed the letters; a notebook of poems kept by the NUK; 'her father from Griblje'. The article gives the death as early as 22 Jul 1889 — the standard biographies (SB, OSP) have 1890; the date 22 July agrees.",
      },
    ],
  },
  {
    ...
    addedAt: "2026-09-21",
    category: "kraj",
    titleSi: "Prof. dr. John Randolph Totter — biokemik, najmlajši sin Matička iz Gribelj",
    titleEn: "Prof. dr. John Randolph Totter — the biochemist, youngest son of Matiček of Griblje",
    periodSi: "7. januar 1914 – 1. februar 2001 · Saragosa, Balmorhea, Oak Ridge",
    periodEn: "7 January 1914 – 1 February 2001 · Saragosa, Balmorhea, Oak Ridge",
    summarySi:
      "Najmlajši od šestih otrok Jandrečega Matička (Matija Totter iz Gribelj) in Angležinje Agnes Smith: od otroškega kompleta za razcvetno analizo, podarjenega od duhovnika, do doktorata kemije in svetovno znanega biokemika v Nacionalnem laboratoriju Oak Ridge — vrednostni pečat Jandrečevega pravila, da so Tottrovi raje imeli knjigo kot plug.",
    summaryEn:
      "The youngest of the six children of Jandreč Matiček (Matija Totter of Griblje) and the Englishwoman Agnes Smith: from a child's blowpipe analysis kit, a gift from a priest, to a chemistry doctorate and a world-known biochemist at the Oak Ridge National Laboratory — the seal of the Jandreč rule that the Totters preferred the book to the plough.",
    storySi:
      "Zbirka že hrani zapis o Jandreču Matičku, gribeljskem popisovalcu šeg, ki je končal v Teksasu, in o njegovi nečakinji Audrey, zvezdnici Hollywooda. Ta zapis dopolnjuje rodovnik z najmlajšo vejo: prof. dr. John Randolph Totter, najmlajši od šestih otrok Matije Tottre in Angležinje Agnes Smith iz Manchestra, se je rodil 7. januarja 1914 v Saragosi v Reeves County na Teksasu. Njegova starša sta se spoznala in poročila 1902 v Jolietu v Illinoisu — istem mestu z močno slovensko skupnostjo, kjer je živel tudi Janez Totter, oče Audrey. Družina je na Teksas prišla 1908, ko se je Matiček — ki je doma odšel prav zato, da ne bi bil kmet — združil prihranke z bratom Janezem in kupil farmo na zahodu Teksasa pri podjetju Balcomb, Moore and Rhea; iz teh treh imen je nastalo ime mestece Balmorhea, ki je postalo dom Tottrovih.\n\nOtroštvo je oblikovala dva: sestra Mabel, učiteljica, ki je petletnega Johna vzela s sabo v šolo in mu pozneje omogočila študij v Laramieju, ter duhovnik Brocardus Eiken, ki je dečku podaril komplet za razcvetno analizo mineralov in ga vzel s sabo na potovanja za zanimivimi kamni. Sedem razredov je opravil v Saragosi, eno leto v Balmorhei, 1929 pa je maturiral pri 15 letih. Ker si ni mogel privoščiti risalne opreme za rudarsko inženirstvo, je izbral kemijo — in odkril dar za pametenje organskih formul, ki ga je poneslo v biokemijo. Bachelor 1934 in master 1935 na Univerzi v Wyomingu, doktorat kemije pa 1938 na Univerzi v Iowi; dan po promociji, 6. avgusta 1938, se je poročil z učiteljico Elizo »Betty« Van Sant.\n\nNjegovo polje je bila biokemija, ustanova pa Nacionalni laboratorij Oak Ridge. Gribeljski viri v zbirki — rodopis o Matičku in Dolenjski list 2021 — mu pripisujeta še vodstvo raziskave Atomic Energy Commission o posledicah atomskih bomb nad Hirošimo in Nagasakijem ter sodelovanje z Institutom »Jožef Stefan«; o ustnem zgodovinskem zapisu, ki ga je 23. januarja 1995 posnel Oddelek za energijo ZDA, pa ETHW zgradi njegov življenjepis. Umrl je 1. februarja 2001. Po Županičevi opazki — »Jandrečim ne dišita plug in motika, pač pa imajo raje knjigo in gosli« — je bil John najčistejši dokaz: fant iz tekške ravnine, vendar z gribeljskim pravilom v hrbtenici. Muzej išče: osebne predmete in pisma iz arhiva Tottrovih, posnetek ustne zgodovine iz 1995 in fotografije, ki pokažejo, kako je teksaška domačija ohranila gribeljske navade.",
    storyEn:
      "The collection already keeps the record of Jandreč Matiček, the recorder of customs from Griblje who ended in Texas, and of his niece Audrey, the star of Hollywood. This record adds the family tree's youngest branch: prof. dr. John Randolph Totter, the youngest of the six children of Matija Totter and the Englishwoman Agnes Smith of Manchester, was born on 7 January 1914 in Saragosa, in Reeves County, Texas. His parents met and married in 1902 in Joliet, Illinois — the same town with a strong Slovene community where Janez Totter, Audrey's father, lived. The family reached Texas in 1908, when Matiček — who had left home precisely to escape farming — pooled his savings with his brother Janez and bought a farm in West Texas through the firm of Balcomb, Moore and Rhea; from those three names grew the name of the little town of Balmorhea, which became the Totters' home.\n\nTwo figures shaped his childhood: his sister Mabel, a teacher, who took the five-year-old John along to school and later made his study in Laramie possible, and the priest Brocardus Eiken, who gave the boy a blowpipe analysis kit for minerals and took him along on his travels in search of interesting stones. He completed seven grades in Saragosa, one year in Balmorhea, and graduated in 1929 at the age of 15. Unable to afford the drafting equipment for mining engineering, he chose chemistry — and discovered a gift for remembering organic formulas, which carried him into biochemistry. A bachelor's in 1934 and a master's in 1935 at the University of Wyoming, and a chemistry doctorate in 1938 at the University of Iowa; the day after his defence, on 6 August 1938, he married the schoolteacher Eliza 'Betty' Van Sant.\n\nHis field was biochemistry, his institution the Oak Ridge National Laboratory. The Griblje sources in this collection — the family record of Matiček and the Dolenjski list of 2021 — add to it the leadership of the Atomic Energy Commission's study of the consequences of the atomic bombs over Hiroshima and Nagasaki, and the collaboration with the Jožef Stefan Institute; and it is from the oral-history interview recorded on 23 January 1995 by the United States Department of Energy that ETHW builds his biography. He died on 1 February 2001. By Županič's observation — 'the Jandreči have no taste for plough and hoe; they prefer the book and the fiddle' — John was the purest proof: a boy of the Texas plain, yet with the Griblje rule in his spine. The museum seeks: personal objects and letters from the Totter archive, the 1995 oral-history recording, and photographs showing how the Texas homestead kept the habits of Griblje.",
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/totter-john.jpg",
    imageCredit:
      "Foto: Engineering and Technology History Wiki (ETHW/IEEE) — portret prof. dr. Johna Randolpha Totterja (prek arhiva ustne zgodovine DOE)",
    yearFrom: 1914,
    yearTo: 2001,
    featured: false,
    sources: [
      {
        key: "ethw-john-totter",
        nameSi: "Engineering and Technology History Wiki (ETHW/IEEE): John Totter — življenjepis po ustnem zgodovinskem zapisu DOE",
        nameEn: "Engineering and Technology History Wiki (ETHW/IEEE): John Totter — biography after the DOE oral history",
        sourceType: "spletni-vir",
        license: "CC BY-SA (navedba vira)",
        url: "https://ethw.org/John_Totter",
        noteSi: "Rojen 7. 1. 1914 Saragosa, Reeves County, Texas; umrl 1. 2. 2001. Sin Matthiasa (Matije) Tottre iz Griblja in Agnes Smith iz Manchestra; poroka staršev Joliet 1902; Balmorhea (Balcomb, Moore and Rhea); sestra Mabel; duhovnik Brocardus Eiken (razcvetna analiza); BS 1934 + MS 1935 Wyoming, PhD 1938 Iowa; poroka z Elizo »Betty« Van Sant 6. 8. 1938; organizacija: Oak Ridge National Laboratory; področje: kemijsko inženirstvo/biokemija. Življenjepis temelji na ustnem zgodovinskem zapisu DOE od 23. 1. 1995.",
        noteEn: "Born 7 Jan 1914 Saragosa, Reeves County, Texas; died 1 Feb 2001. Son of Matthias (Matija) Totter of Griblje and Agnes Smith of Manchester; parents' marriage Joliet 1902; Balmorhea (Balcomb, Moore and Rhea); sister Mabel; the priest Brocardus Eiken (blowpipe analysis); BS 1934 + MS 1935 Wyoming, PhD 1938 Iowa; marriage to Eliza 'Betty' Van Sant on 6 Aug 1938; organisation: Oak Ridge National Laboratory; field: chemical engineering/biochemistry. The biography is built on the DOE oral history of 23 Jan 1995.",
      },
      {
        key: "dl-jandreci-2021",
        nameSi: "Dolenjski list (8. 1. 2021): Jandreči iz Gornjih Gribelj — John Randolph Totter (vodilni članka, telo žar-mar)",
        nameEn: "Dolenjski list (8 Jan 2021): The Jandreči of Gornje Griblje — John Randolph Totter (article lead, body paywalled)",
        sourceType: "spletni-vir",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/iskanje?q=Totter",
        noteSi: "Vodilni članka (11. val raziskave): najmlajši od 6 otrok Jandrečega Matička, bratranec Audrey; mineralogija po vaškem duhovniku, sestra Mabel učiteljica. ETHW duhovnika poimenuje: Brocardus Eiken. Vir je iskalni indeks serije Ljudje ob Kolpi; točen URL članka je zapisan v research-griblje/24.",
        noteEn: "The article lead (research wave 11): the youngest of the six children of Jandreč Matiček, Audrey's cousin; mineralogy through the village priest, sister Mabel a teacher. ETHW names the priest: Brocardus Eiken. The source is the search index of the People by the Kolpa series; the article's exact URL is recorded in research-griblje/24.",
      },
    ],
  },
  {
    slug: "valentina-strucelj",
    museumNo: "MVG-101",
    addedAt: "2026-09-21",
    category: "kraj",
    titleSi: "Valentina Štrucelj — klarinetistka iz Gribelj, ki je ljubljansko zavrnitev pretvorila v odliko v Gradcu",
    titleEn: "Valentina Štrucelj — the clarinettist from Griblje who turned a Ljubljana rejection into a distinction in Graz",
    periodSi: "od 2010 po svetu · od 2007 v Švici · Glasbena šola konservatorij Bern",
    periodEn: "across the world since 2010 · in Switzerland since 2007 · Music school conservatory Bern",
    summarySi:
      "Gribeljčanka, ki se je note učila od sosednje deklice iz glasbene šole in po zavrnitvi Akademije za glasbo v Ljubljani z odliko diplomirala v Gradcu; danes je učiteljica klarineta na glasbeni šoli konservatorij v Bernu, prva klarinetistka Projekt simfoničnega orkestra in avtorica eksperimenta Current Density.",
    summaryEn:
      "A woman of Griblje who learned her notes from a neighbouring girl already at music school and, after being refused by the Academy of Music in Ljubljana, graduated with distinction in Graz; today she teaches clarinet at the music school conservatory in Bern, is the first clarinet of the Projekt symphonic orchestra, and the author of the experiment Current Density.",
    storySi:
      "Zgodba, ki jo ta zapis hrani, se začne z otroško igračo: nekdo v Gribljih je Valentini Štrucelj za peti ali šesti rojstni dan podaril otroški sintetizator — in igračka je odločila poklic. Po posluhu je igrala nanj, ob nedeljah pa hodila k sosednji deklici, ki je že obiskovala glasbeno šolo, in se pri njej učila note. Ko je njeno igranje slišal družinski prijatelj, klarinetist, je svetoval glasbeno šolo; ravnatelj Glasbene šole Črnomelj Silvester Mihelčič ji je — ker oboo v Črnomlju nihče ni učil — predlagal klarinet. Od 5. razreda osnovne šole je hodila na glasbeno, po začetnih težavah pa se je v 7. razredu odločila: postala bo glasbenica. Glasbena nadarjenost v družini ni sama: sestrična Kristina Oberžan je uspešna pevka.\n\nSrednjo glasbeno šolo je obiskovala v Ljubljani; že v 2. letniku se je odločila za študij v tujini. Edina od sošolcev je naredila sprejemne izpite na univerzo za glasbo v avstrijskem Gradcu — in po 4 letih študija diplomirala z odliko. Nasprotje zgodbe je grenko in poučno: na Akademijo za glasbo v Ljubljani so jo zavrnili z obrazložitvijo, da ji primanjkuje umetniškega talenta. Njena odgovor je kariera, ki se piše z odlikami: v Gradcu se je ob rednem študiju posvetila sodobni glasbi pri švicarskem profesorju, po srečanju s klarinetistom Ernestom Molinarjem pa nadaljevala v Bernu, kjer je zaključila pedagoški magisterij in — po Odeonu kot edina Slovenka — magistrski študij bas klarineta. Od leta 2007 živi v Švici; pred tem 4 leta v Avstriji.\n\nDanes poučuje klarinet na Glasbeni šoli konservatorij v Bernu, igra komorno in eksperimentira: v baslu je sodelovala z ansamblom sodobne glasbe, ki ga je ustanovila Slovenka, z ansamblom Neufonia pa v netipični zasedbi tuba, klarinet in klavir igra klezmer, švicarsko narodno glasbo in svobodno improvizacijo. Eno leto je igrala v bernskem simfoničnem orkestru in ugotovila, da veliki orkestri, kjer ni eksperimentiranja, niso zanjo; v Projekt simfoničnem orkestru — kjer igra prvi klarinet — pa nastopa dvakrat letno z Beethovnom, Čajkovskim in Mozartom. Lani je v Ljubljani izšel album Current Density, ki ga je s kontrabasistom Sebastianom Rotzlerjem iz Biela posnela v Galeriji Škuc v okviru KUD Mreža — abstraktna, popolnoma odprta izvedba, ki je ne opiše nič drugega kot komunikacija dveh glasbenikov brez vnaprejšnjega dogovarjanja.\n\nOb 21. avgustu 2010, ko je Dolenjski list objavil njen intervju, je študij v Bernu šele končevala; 4. oktobra 2025 pa je Radio Odeon v seriji Belokranjci po svetu zapisal, da njena pot — in njena hčerka, ki ji doma posluša Pastirče mlado — rastejo naprej. Gribeljski sintetizator je zrasel v glasbenico, ki bernske učence uči po poti, ki je za vsakega najlažja: »Vsak človek je unikaten. Pri vsakem posebej moram iskati pot, ki je zanj najlažja, da se nauči igrati.« Muzej išče: fotografijo domačega nastopa, program metliških Večerov na gradu 2010 in posnetek koncerta v Galeriji Škuc.",
    storyEn:
      "The story this record keeps begins with a toy: someone in Griblje gave Valentina Štrucelj a child's synthesizer for her fifth or sixth birthday — and the toy decided the vocation. She played it by ear, and on Sundays she went to a neighbouring girl who already attended the music school, learning her notes from her. When a family friend, a clarinettist, heard her play, he advised music school; the head of the Črnomelj music school, Silvester Mihelčič — since nobody in Črnomelj taught the oboe — proposed the clarinet. From the 5th grade of primary school she attended the music school, and after initial struggles in the 7th grade she decided: she would become a musician. Musical talent is not alone in the family: her cousin Kristina Oberžan is a successful singer.\n\nShe attended secondary music school in Ljubljana; already in her 2nd year she decided on study abroad. Alone among her classmates she passed the entrance exams at the university of music in Graz, Austria — and after 4 years of study graduated with distinction. The counterpoint of the story is bitter and instructive: the Academy of Music in Ljubljana rejected her with the explanation that she lacked artistic talent. Her answer is a career written in distinctions: in Graz she devoted herself, beside her regular studies, to contemporary music with a Swiss professor, and after meeting the clarinettist Ernesto Molinari she continued in Bern, where she completed a pedagogical master's and — by Radio Odeon, as the only Slovene — a master's in bass clarinet. She has lived in Switzerland since 2007; 4 years in Austria before that.\n\nToday she teaches clarinet at the music school conservatory in Bern, plays chamber music and experiments: in Basel she worked with a contemporary-music ensemble founded by a Slovene woman, and with the Neufonia ensemble — in the unusual scoring of tuba, clarinet and piano — she plays klezmer, Swiss folk music and free improvisation. For one year she played in the Bern symphonic orchestra and concluded that large orchestras, where there is no experimenting, are not for her; in the Projekt symphonic orchestra — where she plays first clarinet — she performs twice a year with Beethoven, Tchaikovsky and Mozart. Recently the album Current Density appeared, recorded in the Škuc Gallery within the KUD Mreža with the double-bassist Sebastian Rotzler of Biel — an abstract, entirely open performance that nothing describes better than two musicians communicating without any prior agreement.\n\nOn 21 August 2010, when the Dolenjski list published her interview, she was only finishing her studies in Bern; on 4 October 2025 Radio Odeon, in its Bela krajina people around the world series, recorded that her path — and her little daughter, who at home listens to Pastirče mlado — keep growing. The Griblje synthesizer grew into a musician who teaches Bern's pupils by the path easiest for each: 'Every human being is unique. For each one I must seek the path that makes learning to play easiest.' The museum seeks: a photograph of a home performance, the programme of the Metlika Evenings at the castle of 2010, and a recording of the Škuc Gallery concert.",
    evidenceStatus: "DOCUMENTED",
    image: "/images/authentic/valentina-strucelj.jpg",
    imageCredit:
      "Foto: Radio Odeon (4. 10. 2025) — serija Belokranjci po svetu, prispevek o Valentina Štrucelj",
    yearFrom: 2010,
    yearTo: 2025,
    featured: false,
    sources: [
      {
        key: "dl-strucelj-2010",
        nameSi: "Dolenjski list (12. 8. 2010, e-izdaja 21. 8. 2010): Valentina Štrucelj — za Ljubljano premalo talenta, dovolj za Švico (avtorica M. Bezek-Jakše)",
        nameEn: "Dolenjski list (12 Aug 2010, e-edition 21 Aug 2010): Valentina Štrucelj — too little talent for Ljubljana, enough for Switzerland (author M. Bezek-Jakše)",
        sourceType: "spletni-vir",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://dolenjskilist.svet24.si/estrada/film-in-tv/valentina-strucelj-za-ljubljano-premalo-talenta-dovolj-za-svico-56852-1536749",
        noteSi: "Polno vidno besedilo (12. val raziskave): sintetizator za 5. ali 6. rojstni dan; počitnice v domačih Gribljih + nastop na metliških prireditvah Pridi zvečer na grad (podnaslov fotografije); sestrična Kristina Oberžan; ravnatelj Silvester Mihelčič; glasbena šola od 5. razreda, odločitev v 7.; edina od sošolcev sprejemni izpiti v Gradcu, diploma z odliko po 4 letih; zavrnitev Akademije v Ljubljani (»premalo umetniškega talenta«); Zoisova štipendija; zaposlitev v Švici; eno leto bernski simfonični orkester; duo s flavtistko Agnes Vass; naslov članka je ironija zavrnitve.",
        noteEn: "Full visible text (research wave 12): a synthesizer for her 5th or 6th birthday; holidays at home in Griblje + performance at the Metlika events Pridi zvečer na grad (photo caption); cousin Kristina Oberžan; head Silvester Mihelčič; music school from the 5th grade, the decision in the 7th; alone among her classmates she passed the Graz entrance exams, a distinction diploma after 4 years; refusal by the Ljubljana Academy ('too little artistic talent'); a Zois scholarship; employment in Switzerland; one year in the Bern symphonic orchestra; a duo with the flutist Agnes Vass; the headline is the irony of that refusal.",
      },
      {
        key: "odeon-belokranjci-strucelj-2025",
        nameSi: "Radio Odeon (4. 10. 2025): Valentina Štrucelj — Bern, Švica (serija Belokranjci po svetu, prispevek 13)",
        nameEn: "Radio Odeon (4 Oct 2025): Valentina Štrucelj — Bern, Switzerland (the Bela krajina people around the world series, instalment 13)",
        sourceType: "objava",
        license: "avtorsko delo / copyrighted (navedba)",
        url: "https://radio-odeon.com/fsega/belokranjci-po-svetu/valentina-strucelj-bern-svica-13/",
        noteSi: "Polno besedilo (12. val raziskave): odločitev že v črnomaljski nižji glasbeni šoli; diploma z odliko v Gradcu; v Bernu pedagoški magisterij + kot edina Slovenka magisterij bas klarineta (mentor Ernesto Molinari); zaposlena na Glasbeni šoli konservatorij Bern; prvi klarinet Projekt simfoničnega orkestra (nastopa 2× letno); ansambla Neufonia + baselski (ustanovila Slovenka); trio tuba-klarinet-klavir (klezmer, švicarska glasba, improvizacija); album Current Density s Sebastianom Rotzlerjem iz Biela (posnel KUD Mreža v Galeriji Škuc, ocena Jan Kopač); v Švici od 2007, prej 4 leta Graz; partner Thomas, hči (~2 leti), doma poslušajo Pastirče mlado.",
        noteEn: "Full text (research wave 12): the decision already at the Črnomelj lower music school; a distinction diploma in Graz; in Bern a pedagogical master's +, as the only Slovene, a master's in bass clarinet (mentor Ernesto Molinari); employed at the Music school conservatory Bern; first clarinet of the Projekt symphonic orchestra (2 performances a year); the Neufonia ensemble + the Basel one (founded by a Slovene woman); the tuba-clarinet-piano trio (klezmer, Swiss music, improvisation); the album Current Density with Sebastian Rotzler of Biel (recorded by KUD Mreža at the Škuc Gallery, reviewed by Jan Kopač); in Switzerland since 2007, 4 years in Graz before; partner Thomas, a daughter (~2 years), at home they listen to Pastirče mlado.",
      },
      {
        key: "inexhaustible-current-density",
        nameSi: "Inexhaustible Editions: Valentina Štrucelj / Sebastian Rotzler — Current Density (album)",
        nameEn: "Inexhaustible Editions: Valentina Štrucelj / Sebastian Rotzler — Current Density (album)",
        sourceType: "spletni-vir",
        license: "avtorsko delo / copyrighted (navedba)",
