...
SRC_DOCS = [
    ...
    {"source_id": "SRC-PZ", "label": "PZ — Konskripcija 1830", "uodid": 373419, "docid": 41784, "pages": 71,
     "coverage": "TRANSCRIBED_PARTIAL (val 75+77): struktura 71/71 + ključna branja §1/§2/§3/§4/§7/§8 + Endresultat p67 (prebivalstvo 1830: 441/222/219, 70 hiš, 102 družin; površina 1220 J 1493 K rdeči popravek; val 77 popravek aktivnih vrednosti: Weiden m.H. 558 J 558 K, Bauarea 1 J 1199 K) + §8 rdeči stolpec 'Zusammen' = post-revizijske površine (sidro Total = §1 EXACT; števke REVIEW razen Weingärten 6 J 1059 K); celotni vrstični prepis NE",
...
def main():
    ...
    out = {
        "val": 77,
        "issue": "#43 §1 KG + §2/§6 Evidence Explorer + §3 claim-first + §8 story atoms + §9 research gaps + #42 §7 PASS 4/4b + §21 PASS 6 + §10 GEOREF v2 + §4 PV agregat + PZ Konskripcija (prebivalstvo 1830, §20 prvi korak) + val 77 Summa kontrola + §8 revizija 1830",
        ...
        "findings": [
            ...
            },
            {
                "finding_id": "KG-F09",
                "val": 77,
                "statement": "PZ [373419] Konskripcija: TRANSCRIBED_PARTIAL — prebivalstvo 1830 (441 duš = 222 M + 219 Ž, aritmetična vrata EXACT; 70 hiš; 102 družin) = prvi podatkovni korak #42 §20; skupna površina rdeči popravek 1220 J 1493 K (PV 1221 J 1573 K, Δ 0,086 % = prečna validacija); Endresultat: 'Weiden mit Holznutzen' 558 J 558 K (val 77 popravek: klafter 558 aktiven nad prečrtanim 846) ≈ 3,214 km² → F-PV-02 (gozd) razrešena na ravni kategorij (silvopastoralna raba; per-parcelni PS izrazi nespremenjeni §5). F-PZ-04 EXPLAINED-V77: p67 Summa (1132 J 495 K) = zastala vmesna stopnja — ne ustreza niti prvotnim niti popravljenim vrsticam (Δ 42.900 QKlft nad aktivnimi 1159 J 195 K); p30/p63/p65 preverjeni (pridelki/rente/Culturfonds — brez površin); avtoritativna post-revizijska resnica = §8 rdeči stolpec 'Zusammen' s sidrom Total = §1 EXACT (rdeča veriga Δ 707 QKlft = 0,036 % OPEN-MICRO; števke REVIEW razen Weingärten 6 J 1059 K). Nodes/edges/claims/ID-ji NESPREMENJENI; kg_sha256 se spremeni (§22 pogodba: podatek spremenjen = story_id spremenjen).",
                "status": "RESOLVED-V77 (odprta: celotni PZ prepis; §8 rdeče števke re-digitation; PS p56–143 za F-PV-03)",
                "provenance": "research-griblje/atlas-1825/pz-konskripcija-1830.json + build-pz-1825.py (val 75+77); pz-n83/ (PDF + 71 nativnih skenov + dokazni izrezki + crops-v77/)",
            },
        ],
        "provenance": {
