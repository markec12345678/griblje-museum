 ...
 *                        93/93 zapisov, 415 vrstic virov, 317 identitet,
...
if (srcN === 415) ok("412 vrstic virov"); else err(`vrstic virov: ${srcN}`);
if (identities === 317) ok("315 identitet virov (A1/A2)"); else err(`identitet: ${identities}`);
