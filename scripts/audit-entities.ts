...
if (srcN === 459) ok("459 vrstic virov"); else err(`vrstic virov: ${srcN}`);
if (identities === 356) ok("356 identitet virov (10. val: +1 — odeon-elektrika-2021)"); else err(`identitet: ${identities}`);
