...
if (srcN === 482) ok("482 vrstic virov"); else err(`vrstic virov: ${srcN}`);
if (identities === 379) ok("379 identitet virov (12. val: +7 — trije novi zapisi oseb)"); else err(`identitet: ${identities}`);
