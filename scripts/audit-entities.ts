...
if (srcN === 514) ok("514 vrstic virov"); else err(`vrstic virov: ${srcN}`);
if (identities === 404) ok("404 identitet virov (16. val: +2 — spomenik 2013 + ribnik)"); else err(`identitet: ${identities}`);
