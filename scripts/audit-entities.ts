 ...
 *                        93/93 zapisov, 423 vrstic virov, 325 identitet,
...
if (srcN === 423) ok("423 vrstic virov"); else err(`vrstic virov: ${srcN}`);
if (identities === 325) ok("325 identitet virov (A1/A2)"); else err(`identitet: ${identities}`);
