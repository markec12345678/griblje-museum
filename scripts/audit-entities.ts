...
if (srcN === 470) ok("470 vrstic virov"); else err(`vrstic virov: ${srcN}`);
if (identities === 367) ok("367 identitet virov (10. val: +1 — odeon-elektrika-2021)"); else err(`identitet: ${identities}`);
