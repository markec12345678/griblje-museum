...
if (srcN === 477) ok("477 vrstic virov"); else err(`vrstic virov: ${srcN}`);
if (identities === 374) ok("374 identitet virov (12. val: +7 — trije novi zapisi oseb)"); else err(`identitet: ${identities}`);
