...
if (srcN === 578) ok("578 vrstic virov (39. val: +3 — odeon-donatorstvo-2020, arso-kv2021-dragosi-griblje, miklavcic-1965-steljniki)"); else err(`vrstic virov: ${srcN}`);
if (identities === 459) ok("459 identitet virov (39. val: +3)"); else err(`identitet: ${identities}`);
