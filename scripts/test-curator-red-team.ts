...

{
  ...
  check(sourceRows === 434, "R0.3 zbirka: 434 vrstic virov", String(sourceRows));
...

{
  ...
  check(context.collection?.exhibitCount === 96, "R12.2 pregled nosi dejanske števce (96)");
...

{
  ...
  const sourceRows = seedExhibits.reduce((n, e) => n + e.sources.length, 0);
  check(sourceRows === 434, "R16.2 434 vrstic virov");
